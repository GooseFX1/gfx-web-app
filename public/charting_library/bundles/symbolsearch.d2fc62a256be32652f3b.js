  ...
  ['symbolsearch'],
  {
          ...
          L = (function () {
            ...
            ;(m.registerAutoFocus = function (t) {
              ...
              (m.prototype._groupContracts = function (t) {
                for (var e = ChartApiInstance.futuresRegex(), i = {}, n = [], s = 0; s < t.length; ++s) {
                  var o = t[s]
            ...
            return (
              ...
              (m.bindToInput = function (t, i) {
                ...
                T &&
                  T.size() &&
                  y() &&
                  (i.ignoreInterval || ((I = m.getInputValueGetter(t.get(0))), (x = m.getInputValueSetter(t.get(0)))),
                  (s = SymbolSearchInputParserMixin.addSpreadActions(T, t.get(0), I, x)))
                var C = new m({
                    input: t,
              ...
              (P.prototype.append = function (t) {
                ...
                if (P.isRoot(t)) {
                  ...
                  ;(e = m.createSuggestListRow(t, this._tickerRegExp, this._translationCache, {
                    ...
                    typeContent: C(this._translationCache, t.type) + (t.exchange && ' - ' + T(t)),
    ...
    w3Pp: function (t, e, i) {
      ...
      function r(t, e) {
        ...
        var a = e ? window.t('{market_type} cfd', s).format({ market_type: t }) : o[t]
        return n.set(i, a), a
      }
    }
  }
