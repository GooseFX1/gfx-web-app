;(window.webpackJsonp = window.webpackJsonp || []).push([
  [50],
  {
    ...
    PjdP: function (e, t, n) {
      ...
      function T(e, t, n) {
        for (
          var r, o = [], a = n, u = 0, i = 0, s = e.length, l = a.length, c = -1, p = 0, d = [], f = s - 1, m = [];
          u < s && i < l;
          ...
          b
            ? (v.match(b.pattern)
                ? (o.push(v),
                  b.recursive && (-1 === c ? (c = u) : u === f && u !== c && (u = c - 1), f === c && (u -= 1)),
                  (u += 1))
                : v === r
                ? (p--, (r = void 0))
                : b.optional
              ...
              (i += 1))
            : (t || o.push(h), v === h ? (d.push(i), (i += 1)) : ((r = h), d.push(i + p), p++), (u += 1))
        }
        var y = e.charAt(f)
        s !== l + 1 || R[y] || o.push(y)
        var g = o.join('')
            ...
            return (
              Object(o.useLayoutEffect)(function () {
                ...
                return (
                  ...
                  function () {
                    e.removeEventListener('focusin', r), e.removeEventListener('focusout', r)
                  }
                )
              }, []),
              [t, n]
        ...
        return a.a.createElement(
          ...
          a.a.createElement(F, {
            ...
            onKeyDown: function (e) {
              if (e.defaultPrevented) return
              var t = Object(G.hashFromEvent)(e.nativeEvent)
              13 === t && (e.preventDefault(), T(g), Object(C.ensureNotNull)(u.current).blur())
              27 === t && (e.preventDefault(), Object(C.ensureNotNull)(u.current).blur())
            }
          }),
          a.a.createElement(
            H.a,
            {
              ...
              onClose: function () {},
              position: function () {
                var e = Object(C.ensureNotNull)(n.current).getBoundingClientRect(),
      ...
      function W(e) {
        var t = e.split(':'),
          n = t[0],
          r = t[1],
          o = [Object(B.clamp)(parseInt(n), 0, 23), Object(B.clamp)(parseInt(r), 0, 59)],
          a = o[1],
      ...
      var Z = (function (e) {
                  ...
                  .forEach(function (e) {
                    ...
                    if (1 === i.length) u[n + '$0'] = t
                      ...
                      var s = i.reduce(function (e, o, u) {
                        ...
                        try {
                          s = Object(C.ensureDefined)(Object(C.ensureDefined)(a)[o.id]).title
                        } catch (l) {
                          s = o.id
                        }
        ...
        fe = de.map(function (e) {
          return {
            value: e,
            content: '' === e ? Object(ee.t)('Same as symbol') : Object(ce.getTranslatedResolutionModel)(e).hint
          }
        }),
        me = (function (e) {
          function t() {
            ...
            return (
              ...
              (t.prototype.render = function () {
                var e,
                  ...
                  l = null
                return (
                  this.props.label && (l = a.createElement('span', { className: o }, this.props.label)),
                  a.createElement(
                    'label',
                    { className: r },
                    a.createElement(
      ...
      var _ = (function (e) {
        ...
        return (
          ...
          (t.prototype.componentDidMount = function () {
            ...
            Object(l.symbolSearchUIService)().bindToInput(Object(s.ensureNotNull)(this._input), {
        ...
        c = (function () {
          ...
          return (
            (e.prototype.format = function (e) {
              ...
              return Object(s.isRtl)() && l.isChrome ? Object(s.startWithLTR)(t) : t
            }),
              ...
              (n._onValueByStepChange = function (e) {
                ...
                if (s.res) {
                  var c = new d.Big(s.value),
                    ...
                    f = c.mod(p),
                    m = c.plus(e * u)
                  !f.eq(0) && o && (m = m.plus((e > 0 ? 0 : 1) * u).minus(f)), (l = Number(m))
                }
                n._checkValueBoundaries(l).value &&
                  (n.setState({ displayValue: _(n.props, l) }), n.props.onValueChange(l, 'step')),
                  n.props.errorHandler && n.props.errorHandler(!1)
              })
            var r = t.value
            return (
