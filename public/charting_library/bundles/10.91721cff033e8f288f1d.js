              ...
              if (n && 1 == ++s)
                'hidden' !== $(document.body).css('overflow').toLowerCase() &&
                  ...
                  l
                    .css(
                      'padding-right',
                      parseInt(l.css('padding-right').replace('px', '')) + p.getScrollbarWidth() + 'px'
                    )
                    .data('wasScroll', !0)),
                  l.addClass('i-no-scroll')
              else if (!n && s > 0 && 0 == --s && (l.removeClass('i-no-scroll'), l.data('wasScroll'))) {
                var t = l.get(0)
                $('.widgetbar-wrap').css('right', 0)
                var r = Boolean(window.widgetbar && window.widgetbar.resizerBridge.fullscreen.value())
                  ? 0
                  : $('.widgetbar-wrap').width() || 0
                t.scrollHeight <= t.clientHeight && (r -= p.getScrollbarWidth()),
                  l.css('padding-right', (r < 0 ? 0 : r) + 'px').data('wasScroll', void 0)
              }
            }
          },
              ...
              var t,
                ...
                o =
                  ...
                  (r = u) === 1 / 0
                    ...
                    : window.matchMedia('(min-width: ' + t + 'px) and (max-width: ' + r + 'px)'))
              o.matches && v(e),
    ...
    'F/us': function (n, t, r) {
      ...
      ;(function () {
        ...
        ;(g.each = g.forEach =
          function (n, t, r) {
            var e, i
            if (((t = m(t, r)), O(n))) for (e = 0, i = n.length; e < i; e++) t(n[e], e, n)
            else {
              var u = g.keys(n)
          ...
          (g.map = g.collect =
            function (n, t, r) {
              t = b(t, r)
              for (var e = !O(n) && g.keys(n), i = (e || n).length, u = Array(i), o = 0; o < i; o++) {
                var a = e ? e[o] : o
                u[o] = t(n[a], a, n)
              }
              return u
          ...
          (g.every = g.all =
            function (n, t, r) {
              t = b(t, r)
              for (var e = !O(n) && g.keys(n), i = (e || n).length, u = 0; u < i; u++) {
                var o = e ? e[u] : u
          ...
          (g.max = function (n, t, r) {
            var e,
              ...
              o = -1 / 0
            if (null == t && null != n)
              for (var a = 0, c = (n = O(n) ? n : g.values(n)).length; a < c; a++) (e = n[a]) > u && (u = e)
            else
              (t = b(t, r)),
                g.each(n, function (n, r, e) {
                  ;((i = t(n, r, e)) > o || (i === -1 / 0 && u === -1 / 0)) && ((u = n), (o = i))
                })
            return u
          }),
          ...
          (g.shuffle = function (n) {
            for (var t, r = O(n) ? n : g.values(n), e = r.length, i = Array(e), u = 0; u < e; u++)
        ...
        ;(g.groupBy = A(function (n, t, r) {
          ...
          (g.toArray = function (n) {
            return n ? (g.isArray(n) ? l.call(n) : O(n) ? g.map(n, g.identity) : g.values(n)) : []
          }),
          (g.size = function (n) {
        ...
        function M(n) {
          return function (t, r, e) {
            r = b(r, e)
            for (var i = j(t), u = n > 0 ? 0 : i - 1; u >= 0 && u < i; u += n) if (r(t[u], u, t)) return u
            return -1
          }
        }
        function E(n, t, r) {
          return function (e, i, u) {
            ...
            if (i != i) return (u = t(l.call(e, o, a), g.isNaN)) >= 0 ? u + o : -1
        ...
        ;(g.flatten = function (n, t) {
          ...
          (g.intersection = function (n) {
            for (var t = [], r = arguments.length, e = 0, i = j(n); e < i; e++) {
              var u = n[e]
              if (!g.contains(t, u)) {
          ...
          (g.unzip = function (n) {
            for (var t = (n && g.max(n, j).length) || 0, r = Array(t), e = 0; e < t; e++) r[e] = g.pluck(n, e)
            return r
          }),
          (g.object = function (n, t) {
            for (var r = {}, e = 0, i = j(n); e < i; e++) t ? (r[n[e]] = t[e]) : (r[n[e][0]] = n[e][1])
            return r
          }),
          (g.findIndex = M(1)),
          (g.findLastIndex = M(-1)),
        ...
        ;(g.bind = function (n, t) {
          ...
          (g.partial = function (n) {
            var t = l.call(arguments, 1),
              r = function () {
                for (var e = 0, i = t.length, u = Array(i), o = 0; o < i; o++) u[o] = t[o] === g ? arguments[e++] : t[o]
          ...
          (g.throttle = function (n, t, r) {
            ...
            r || (r = {})
            var c = function () {
              ;(a = !1 === r.leading ? 0 : g.now()), (o = null), (u = n.apply(e, i)), o || (e = i = null)
            }
            return function () {
              var l = g.now()
              a || !1 !== r.leading || (a = l)
              ...
              return (
                ...
                (i = arguments),
                f <= 0 || f > t
                  ? (o && (clearTimeout(o), (o = null)), (a = l), (u = n.apply(e, i)), o || (e = i = null))
          ...
          (g.debounce = function (n, t, r) {
            var e,
              ...
              c = function () {
                ...
                l < t && l >= 0
                  ? (e = setTimeout(c, t - l))
                  : ((e = null), r || ((a = n.apply(u, i)), e || (u = i = null)))
              }
            return function () {
        ...
        ;(g.keys = function (n) {
          ...
          (g.values = function (n) {
            for (var t = g.keys(n), r = t.length, e = Array(r), i = 0; i < r; i++) e[i] = n[t[i]]
            return e
          }),
          (g.mapObject = function (n, t, r) {
            t = b(t, r)
            for (var e, i = g.keys(n), u = i.length, o = {}, a = 0; a < u; a++) o[(e = i[a])] = t(n[e], e, n)
            return o
          }),
          (g.pairs = function (n) {
            for (var t = g.keys(n), r = t.length, e = Array(r), i = 0; i < r; i++) e[i] = [t[i], n[t[i]]]
            return e
          }),
          (g.invert = function (n) {
            for (var t = {}, r = g.keys(n), e = 0, i = r.length; e < i; e++) t[n[r[e]]] = r[e]
            return t
          }),
          ...
          (g.findKey = function (n, t, r) {
            t = b(t, r)
            for (var e, i = g.keys(n), u = 0, o = i.length; u < o; u++) if (t(n[(e = i[u])], e, n)) return e
          }),
        ...
        var z = function (n, t, r, e) {
          ...
          if (!u) {
            ...
            if (
              o !== a &&
              !(g.isFunction(o) && o instanceof o && g.isFunction(a) && a instanceof a) &&
              'constructor' in n &&
              'constructor' in t
            )
              return !1
          ...
          if ((r.push(n), e.push(t), u)) {
            ...
            for (; c--; ) if (((l = s[c]), !g.has(t, l) || !z(n[l], t[l], r, e))) return !1
          }
        ...
        ;(g.isEqual = function (n, t) {
          ...
          (g.isEmpty = function (n) {
            return (
              null == n ||
              (O(n) && (g.isArray(n) || g.isString(n) || g.isArguments(n)) ? 0 === n.length : 0 === g.keys(n).length)
            )
          }),
        ...
        ;(g.template = function (n, t, r) {
          ...
          var e = RegExp(
              [(t.escape || q).source, (t.interpolate || q).source, (t.evaluate || q).source].join('|') + '|$',
              'g'
            ),
            i = 0,
            u = "__p+='"
        ...
        ;(g.mixin = function (n) {
          ...
          g.each(['pop', 'push', 'reverse', 'shift', 'sort', 'splice', 'unshift'], function (n) {
            ...
            g.prototype[n] = function () {
              var r = this._wrapped
              return (
                t.apply(r, arguments), ('shift' !== n && 'splice' !== n) || 0 !== r.length || delete r[0], L(this, r)
              )
            }
          }),
