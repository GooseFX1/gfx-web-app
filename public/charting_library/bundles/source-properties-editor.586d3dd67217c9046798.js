  ...
  ['source-properties-editor'],
  {
    ...
    CbZh: function (e, t, o) {
      ...
      function I(e) {
        var t = e.model,
          o = e.source
        return i.a.createElement(b.a, { rule: 'screen and (max-width: 768px)' }, function (e) {
            ...
            ;(o._activePageRef = n.createRef()),
              ...
              (o._renderFooterLeft = function () {
                ...
                return Object(D.isLineTool)(t)
                  ...
                  : n.createElement(b.a, { rule: 'screen and (max-width: 419px)' }, function (e) {
                      return (
                        Object(B.isStudy)(t) &&
                        n.createElement(O.a, {
                          model: i,
              ...
              (o._handleSelectPage = function (e) {
                ...
                t !== e &&
                  ...
                  r && d.a.setValue(r, e),
                  o._subscribe(i),
                  o.setState({ activePageId: e, tableKey: Date.now() }, function () {
                    o._requestResize && o._requestResize(), o._focusActivePageFirstTextInput()
                  }))
              }),
              ...
              (o._closePopupDialog = function () {
                window.lineToolPropertiesToolbar && window.lineToolPropertiesToolbar.refresh(), o.props.onClose()
              })
            var i,
              r = o.props.pages
            if (o._getActionPageById(o.props.activePageId)) i = Object(c.ensureDefined)(o.props.activePageId)
            else {
          ...
          return (
            ...
            (t.prototype.render = function () {
              var e,
                ...
                a = (null === (e = o.properties().title) || void 0 === e ? void 0 : e.value()) || o.title()
                ...
                var r = t.props.pages,
                  a = {
                    ...
                    byId: r.reduce(function (e, t) {
                      var o
                      return Object(s.__assign)(Object(s.__assign)({}, e), (((o = {})[t.id] = { title: t.title }), o))
                    }, {})
                  },
                  c = r.find(function (t) {
                    return t.id === e
