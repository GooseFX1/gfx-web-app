  ...
  ['chart-widget-gui'],
  {
    ...
    EV8o: function (t, e, i) {
      ...
      function o(t, e, i, o) {
        ...
        return (
          l.classList.add(i),
          Object(s.isString)(t.icon) ? (l.innerHTML = t.icon) : l.appendChild(t.icon),
          n.appendChild(l),
          n
        )
      }
    ...
    RspR: function (t, e, i) {
      ...
      var s,
        o = i('+jnJ'),
        n = i('1ANp'),
        l = (s = Object(o.b)('PaneButtons.visibility', n.navigationButtonsVisibilityKey)).property,
        a = s.availableValues,
        r = s.actualBehavior
    },
    S48P: function (t, e) {
        ...
        H = (function () {
          function t(t, e, i) {
            ;(this._widget = Object(o.ensureNotNull)(Object(a.a)(E).querySelector('.control-bar-wrapper'))),
              ...
              (this._back = Object(o.ensureNotNull)(Object(a.a)(V).querySelector('.control-bar__btn--back-present'))),
          ...
          return (
              ...
              ;(this._buttons = {
                ...
                this._chart.withModel(this, function () {
                  ...
                  e.fullscreenable.subscribe(t._boundUpdateMaximizeButtonsVisibility),
                    ...
                    (t._chartBackgroundProperty = t._chartModel.model().properties().paneProperties.background),
                    null !== t._chartBackgroundProperty && t._chartBackgroundProperty.subscribe(t, t._updateBgBarStyle),
                    t._updateBgBarStyle()
                })
            }),
            ...
            (t.prototype._updateBgBarStyle = function () {
              if (null !== this._chartModel) {
                for (
                  var t =
                      Object(r.getLuminance)(this._chartModel.model().properties().paneProperties.background.value()) <
                      0.5,
                    e = 0,
              ...
              if (!t.metaKey) {
                ...
                if (
                  !(
                    (37 !== e && 39 !== e) ||
                    this._pressedKey[e] ||
                    ((this._pressedKey[e] = !0), t.target.closest('input, textarea'))
                  )
                ) {
                  var i = 37 === e ? 1 : -1
                  t.ctrlKey || t.altKey ? this._move(i) : this._moveByBar(i), t.preventDefault()
                }
              }
            }),
          ...
          function t(t, e, i) {
            ...
            for (var s = 0, o = Object.entries(this._actions); s < o.length; s++) {
              ...
              ;(this._actionsSpawns[d] = {
                ...
                this._actionsSpawns[d].visible.subscribe(this._updateActionVisibilities.bind(this, d))
            ...
            this._render(),
              ...
              this._parentEl.classList.toggle(u.touchMode, a.trackingModeIsAvailable),
          ...
          return (
            ...
            (t.prototype.updateWidgetModeByWidth = function (t) {
              ...
              i.classList.toggle(d.blockHidden, e),
                s.classList.toggle(d.blockHidden, !e || !this._actions.more.visible.value())
            }),
            ...
            (t.prototype._renderActions = function () {
              null === this._listActionsWrapperEl &&
                ...
                (this._listActionsElements.up = Object(r.a)(this._actions.up, u.button, u.buttonIcon, d.blockHidden)),
            ...
            (t.prototype._updateActionVisibilities = function (t, e) {
              Object(n.ensureNotNull)(this._listActionsElements[t]).classList.toggle(d.blockHidden, !e)
            }),
            ...
            (t.prototype._onMouseEnterLeaveEvent = function (t) {
              ;(this._mouseOverWidget = 'mouseenter' === t.type),
                this._visibilityType.value() === l.a.VisibleOnMouseOver && this._updatePaneControlsWidgetVisibility()
            }),
            (t.prototype._updatePaneControlsWidgetVisibility = function () {
              ...
              this._parentEl.classList.toggle(u.hidden, !t),
                this._parentEl.classList.toggle(u.forceHidden, !this._globalVisibility.value() || e)
            }),
            (t.prototype._updateThemedColor = function (t) {
              t.length > 0 ? (this._parentEl.style.color = t) : this._parentEl.style.removeProperty('color')
            }),
            t
          )
        })(),
        ...
        I = (function () {
          ...
          return (
            ...
            (t.prototype._getUpButtonVisibility = function () {
              var t = this._paneWidget.state()
              return this._model.model().panes().indexOf(t) > 0 && !t.isMaximized() && !k
            }),
            ...
            (t.prototype._getMaximizeButtonVisibility = function () {
              var t = this._paneWidget.state()
              return this._model.model().panes().length > 1 && !t.isMaximized() && !k
            }),
    ...
    sAH5: function (t, e, i) {
        ...
        h = (function () {
          ...
          return (
            (t.prototype.toggleVisibility = function (t) {
              null !== this._loadingEl && this._loadingEl.classList.toggle(d.shown, t)
            }),
      ...
      var g = (function () {
          function t(t, e, i) {
            ...
            for (var n = 0; n < this._titlesSpawns.length; n++)
              this._titlesSpawns[n].subscribe(this._updateTitlesHandler.bind(this, n))
            ...
            for (n = 0; n < this._actionsSpawnArray.length; n++) {
              this._actionsSpawnArray[n].visible.subscribe(this._updateActionVisibilities.bind(this, n))
            ...
            ;(this._withActions = i.withActions),
              ...
              this._withActions &&
                ((this._showActionsHandler = Object(u.b)(this._showActions.bind(this))),
                (this._hideActionsHandler = Object(u.b)(this._hideActions.bind(this))),
                (this._selectedSourceHandler = Object(u.b)(this._model.setSourceSelected.bind(this._model))),
                    ...
                    new r.MouseEventHandler(
                      Object(o.ensureNotNull)(this._el),
                      {
                        contextMenuEvent: function (t) {
                          Object(o.ensureNotNull)(s._actionsParentEl).contains(t.target) ||
          ...
          return (
            (t.prototype.destroy = function () {
              ...
              if (null !== this._titleParentEl) {
                for (var i = 0, s = this._mouseEventHandlers; i < s.length; i++) {
                  s[i].destroy()
                }
                ;(this._titleElements = []),
                  this._withActions &&
            ...
            (t.prototype._renderTitle = function () {
              ...
              for (var t = this._titleParentEl, e = 0; e < this._titlesSpawns.length; e++) {
                ...
                i.classList.add(c.title, v[e], 'apply-overflow-tooltip'), (i.dataset.name = 'legend-source-title')
                var s = this._titlesSpawns[e].value()
                s.length > 0
                  ? (i.appendChild(document.createTextNode(s)), i.classList.add(c.withDot))
            ...
            (t.prototype._renderActions = function () {
              if (this._withActions) {
                ...
                for (
                  var t = Object(o.ensureNotNull)(this._actionAdditionalWrapperEl), e = 0, i = this._model.actions();
                  e < i.length;
                  e++
                ) {
                  var s = i[e],
            ...
            (t.prototype._updateTitlesHandler = function (t, e) {
              var i = Object(o.ensureNotNull)(this._titleElements[t]),
                s = 0 === e.length
              i.classList.toggle(p.blockHidden, s), i.classList.toggle(c.withDot, !s), b(i, e)
            }),
            ...
            (t.prototype._updateValuesHTMLElHandler = function (t, e) {
              b(Object(o.ensure)(this._valuesElements[t].value), e), this._updateShowValues()
            }),
            ...
            (t.prototype._updateValueVisibleHandler = function (t, e) {
              var i = Object(o.ensure)(this._valuesElements[t].value).closest('.' + c.valueItem)
              null !== i && i.classList.toggle(p.blockHidden, !e)
            }),
            (t.prototype._updateShowLine = function () {
              null !== this._el && this._el.classList.toggle(p.blockHidden, this._isRowHidden.value())
            }),
            ...
            (t.prototype._updateShowValues = function () {
              null !== this._valuesAdditionalWrapperEl &&
                this._valuesAdditionalWrapperEl.classList.toggle(p.blockHidden, this._isValuesShouldBeHidden())
            }),
            ...
            (t.prototype._hideActions = function () {
              null !== this._el &&
                ...
                null !== this._valuesParentEl && this._valuesParentEl.classList.remove(c.withTail))
            }),
            ...
            (t.prototype._updateSelectedState = function () {
              null !== this._el && this._withActions && this._el.classList.toggle(c.selected, this._selected.value())
            }),
            (t.prototype._updateLoadingState = function () {
              if (null !== this._el) {
                this._el.classList.contains('tempDisabled') &&
                  (this._loading.value() ? this._el.classList.add(c.hiddenLoading) : this._clearDisableState())
                var t = this._loading.value()
                this._el.classList.toggle(c.loading, t), null !== this._loader && this._loader.toggleVisibility(t)
              }
            }),
            (t.prototype._updateShowTitles = function () {
              null !== this._titleParentEl &&
                (this._titleParentEl.classList.toggle(p.blockHidden, this._isTitleHidden.value()),
                null !== this._actionsParentEl &&
                  this._actionsParentEl.classList.toggle(p.blockHidden, this._isTitleHidden.value()))
            }),
            ...
            (t.prototype._updateActionVisibilities = function (t) {
              null !== this._actionsParentEl &&
                this._actionsParentEl
                  ...
                  [t].classList.toggle(p.blockHidden, !this._actionsSpawnArray[t].visible.value())
            }),
            (t.prototype._updateActionTitle = function (t) {
              var e = this._actionsSpawnArray[t].title
              null !== this._actionsParentEl &&
                null !== e &&
                this._actionsParentEl.querySelectorAll('.' + c.button)[t].setAttribute('title', e.value())
            }),
            (t.prototype._updateCustomTextColor = function () {
              ...
              for (
                var n = Object(o.ensureNotNull)(this._valuesParentEl).querySelectorAll('.' + c.valueTitle), l = 0;
                l < n.length;
                l++
              )
                n[l].style.color = t
              Object(o.ensureNotNull)(this._el).classList.toggle(c.withCustomTextColor, Boolean(t))
            }),
            t
          )
        })(),
          ...
          function e(e, i, s) {
            ...
            return (
              ...
              s.statusWidget &&
                ...
                (o._resizeObserver = new l.default(o._handlerRestrictTitleWidth.bind(o))),
                null !== o._actionsParentEl && o._resizeObserver.observe(o._actionsParentEl),
                null !== o._statusesWrapper && o._resizeObserver.observe(o._statusesWrapper)),
          ...
          return (
            ...
            (e.prototype._render = function () {
              t.prototype._render.call(this),
                ...
                this._el.classList.toggle(c.onlyOneButtonCanBeStick, this._model.isOneButtonCanBeStick()),
              ...
              this._firstLineWrapper.appendChild(e),
                null !== this._actionsParentEl && this._firstLineWrapper.appendChild(this._actionsParentEl)
            ...
            (e.prototype._renderValues = function () {
              null === this._valuesParentEl &&
                ...
                this._valuesAdditionalWrapperEl.classList.add(c.valuesAdditionalWrapper),
              ...
              for (
                ...
                n.classList.add(c.valueItem), n.classList.toggle(p.blockHidden, !s.visible.value())
                var l = document.createElement('div'),
                  a = s.title.value() || ''
            ...
            (e.prototype._updateValuesTitleHTMLElHandler = function (t, e) {
              ...
              b(i, e), i.classList.toggle(p.blockHidden, 0 === e.length), this._updateShowValues()
            }),
            (e.prototype._showActions = function () {
              t.prototype._showActions.call(this), this._updateTitleMaxWidthWithButton()
            }),
            ...
            (e.prototype._updateFlaggedState = function () {
              void 0 !== this._flagged &&
                ...
                Object(o.ensureNotNull)(this._el).classList.toggle(c.flagged, Boolean(this._flagged.value())))
            }),
            (e.prototype._addStatusesWidget = function (t) {
              ;(this._statusesWrapper = document.createElement('div')),
                ...
                Object(o.ensureNotNull)(this._firstLineWrapper).appendChild(this._statusesWrapper)
            }),
            (e.prototype._handlerRestrictTitleWidth = function (t) {
              if (null !== this._actionsParentEl && null !== this._firstLineWrapper) {
                ...
                ;(e === this._lastStatusesWrapperWidth && i === this._lastActionWrapperWidth) ||
            ...
            (e.prototype._updateTitleMaxWidth = function () {
              if (null !== this._firstLineWrapper)
                if (this._isWidthButtonsMode()) this._updateTitleMaxWidthWithButton()
                else {
                  var t = this._lastActionWrapperWidth || 0,
                    e = (this._lastStatusesWrapperWidth || 0) + t
                  this._firstLineWrapper.style.maxWidth = e > 0 ? 'calc(100% - ' + e + 'px)' : ''
                }
            }),
            (e.prototype._updateTitleMaxWidthWithButton = function () {
              if (null !== this._firstLineWrapper && null !== this._actionsParentEl) {
                var t = this._lastActionWrapperWidth || 0,
                  e = (this._lastStatusesWrapperWidth || 0) + t
                if (null === this._allButtonsWidth && null !== this._lastActionWrapperWidth) {
                ...
                this._firstLineWrapper.style.maxWidth = 'calc(100% - ' + Math.max(s, e) + 'px)'
              }
            }),
          ...
          return (
            ...
            (e.prototype._updateShowLine = function () {
              if (null !== this._el && void 0 !== this._globalRowVisibility) {
                ...
                e ? this._el.classList.toggle(p.blockHidden, e) : t.prototype._updateShowLine.call(this)
              }
            }),
            (e.prototype._render = function () {
              t.prototype._render.call(this),
              ...
              var e = Object(o.ensureNotNull)(this._titleParentEl)
              this._el.appendChild(e), null !== this._actionsParentEl && this._el.appendChild(this._actionsParentEl)
              var i = Object(o.ensureNotNull)(this._valuesParentEl)
              this._el.appendChild(i), this._parentEl.append(this._el)
            }),
            (e.prototype._renderValues = function () {
            ...
            (e.prototype._updateErrorState = function () {
              void 0 !== this._error &&
                ...
                Object(o.ensureNotNull)(this._el).classList.toggle(c.error, this._error.value())
            }),
        ...
        L = (function () {
          function t(t, e, i) {
            ;(this._el = null),
              ...
              (this._showObjectTreeHandler = Object(u.b)(i.onShowObjectsTreeDialog)),
              null !== this._el &&
                (this._el.addEventListener('touchend', this._toggleStateHandler),
                this._el.addEventListener('mousedown', this._toggleStateHandler)),
              null !== this._objectTreeEl &&
                (this._objectTreeEl.addEventListener('touchend', this._showObjectTreeHandler),
                this._objectTreeEl.addEventListener('mousedown', this._showObjectTreeHandler))
          }
          return (
            (t.prototype.destroy = function () {
              this._sourceCount.destroy(),
                ...
                null !== this._objectTreeEl &&
                  ...
                  this._objectTreeEl.removeEventListener('mousedown', this._showObjectTreeHandler),
                  (this._objectTreeEl = null)),
                (this._arrowIconEL = null),
                (this._counterEl = null),
                null !== this._el &&
            ...
            (t.prototype._render = function () {
              ;(this._el = document.createElement('div')),
                ...
                (this._arrowIconEL.innerHTML = f.trackingModeIsAvailable ? C : S),
                ...
                (this._objectTreeEl.innerHTML = f.trackingModeIsAvailable ? E : M),
            ...
            (t.prototype._updateSourceCount = function (t) {
              b(Object(o.ensureNotNull)(this._counterEl), String(t)), this._updateCounterVisibility(t)
            }),
            ...
            (t.prototype._updateObjectTreeVisibility = function (t) {
              null !== this._objectTreeEl && this._objectTreeEl.classList.toggle(p.blockHidden, !t)
            }),
            t
          )
        })(),
        ...
        A = (function () {
          function t(t, e) {
            ;(this._renderToggler = null),
              ...
              this._parentEl.classList.toggle(c.noActions, !this._options.withActions),
              this._parentEl.classList.toggle(c.touchMode, f.trackingModeIsAvailable),
          ...
          return (
            ...
            (t.prototype.addDataSources = function (t) {
              ...
              for (
                var i = Object(o.ensureNotNull)(this._dataSourcesAdditionalWrapperEl),
                  s = function (t) {
                    var s = new y(t, i, {
                    ...
                    n._dataSourceRenderers.push(s),
                      ...
                      t.onDestroy().subscribe(
                        ...
                        function () {
                          ...
                          ;-1 !== t && (e._dataSourceRenderers[t].destroy(), e._dataSourceRenderers.splice(t, 1))
                        },
                        !0
                      )
                  },
            ...
            (t.prototype._renderToggle = function (t) {
              this._options.showToggleButton &&
                (this._renderToggler = new L(t, this._options.themedColor, this._togglerOptions))
            }),
            (t.prototype._renderCollapsedCounter = function (t) {
              ;(this._collapsedDataSourcesWrapperEl = document.createElement('div')),
                (this._collapsedDataSourcesWrapperEl.className = c.item + ' ' + c.last),
                (this._collapsedDataSourcesEl = document.createElement('span')),
                (this._collapsedDataSourcesEl.className = c.text + ' apply-common-tooltip'),
            ...
            (t.prototype._updateCollapsedSourcesCount = function (t) {
              if (null !== this._collapsedDataSourcesWrapperEl && null !== this._collapsedDataSourcesEl) {
                var e = 0 === t
                this._collapsedDataSourcesWrapperEl.classList.toggle(p.blockHidden, e),
                  e ||
            ...
            (t.prototype._updateLegendVisibility = function () {
              this._parentEl.classList.toggle(p.blockHidden, this._isAllLegendHidden.value()),
                null !== this._dataSourcesEl &&
                  this._dataSourcesEl.classList.toggle(p.blockHidden, this._isStudiesLegendHidden.value())
            }),
            (t.prototype._setCustomBg = function () {
              ...
              if (t) {
                var o = Object(n.parseRgb)(e),
                  ...
                  a = o[1],
                  r = o[2]
                s = Object(n.rgbaToString)([l, a, r, Object(n.normalizeAlphaComponent)(1 - i / 100)])
              }
          ...
          return (
            ...
            (t.prototype.onShowSettings = function () {
              this._source.userEditEnabled() &&
                ...
                this._callbacks.showChartPropertiesForSource(this._source, j.TabNames.style),
            ...
            (t.prototype.onContextMenuShow = function (t, e) {
              return this._options.readOnlyMode
                ...
                : (vi('Show legend context menu'),
                  this._callbacks.showLegendWidgetContextMenu(this._calcNewPosition(t), e))
            }),
            ...
            (t.prototype._updateTitle = function () {
              ...
              if (null !== t)
                for (var e = t.getSplitTitle(), i = 0; i < this._titles.length; i++) {
                  var s = e[i],
                    o = Object(R.clean)(Array.isArray(s) ? s.join(' ') : s || '', !0)
        ...
        $ = (function (t) {
          function e(e, i, s, o, n) {
            ...
            ;(l._titles = [new P.a(''), new P.a(''), new P.a(''), new P.a('')]),
              ...
              l._model
                .model()
                .properties()
                .paneProperties.legendProperties.showSeriesTitle.subscribe(l, function () {
                  l._isTitleHidden.setValue(l._getTitleHiddenValue())
                })
            for (
              var a = 0,
                r = [
                  l._model.model().properties().paneProperties.legendProperties.showSeriesOHLC,
                  l._model.model().properties().paneProperties.legendProperties.showBarChange
                ];
              a < r.length;
              a++
            ) {
          ...
          return (
            ...
            (e.prototype.onShowSettings = function () {
              this._source.userEditEnabled() && this._callbacks.showGeneralChartProperties(j.TabNames.style)
            }),
            ...
            (e.prototype._getMarkerTitle = function () {
              return null !== this._symbolMarker ? (this._symbolMarker.isMarked() ? J : Y) : ''
            }),
            (e.prototype._symbolActionHandler = function () {
              null !== this._symbolMarker && (this._updateSymbolMarker(), vi('Change flag state'))
            }),
      ...
      var it = i('z61+'),
          ...
          function e(e, i, s, o, n) {
            ...
            return (
              ...
              l._model
                .model()
                .properties()
                .paneProperties.legendProperties.showStudyTitles.subscribe(l, function () {
                  l._isTitleHidden.setValue(l._getTitleHiddenValue())
                }),
              l._model
                .model()
                .properties()
                .paneProperties.legendProperties.showStudyValues.subscribe(l, function () {
                  l._isValuesHidden.setValue(l._getValuesHiddenValue())
                }),
              l.update(),
              l
          ...
          return (
              ...
              if (null !== t && 0 !== t.items().length) {
                ...
                if (0 === e.length) {
                  ...
                  for (var s = t.items(), o = 0; o < s.length; o++) {
                    var n = e[o],
                      l = s[o]
                    n.value.setValue(l.value()), n.color.setValue(I(l.color())), n.visible.setValue(l.visible())
                  }
              }
            }),
            (e.prototype._updateStates = function () {
            ...
            (e.prototype._createActions = function () {
              ...
              if (!this._options.readOnlyMode) {
                ...
                ct &&
                  pt &&
                  (!Object(tt.isStudy)(this._source) || new it.a(this._source.metaInfo()).hasUserEditableOptions()) &&
                  this._actions.push({
                    icon: ot,
        ...
        ft = (function () {
          ...
          return (
            ...
            (t.prototype._updateIconClassName = function (t) {
              null !== t ? this._iconClassNames.setValue([yt.statusItem, t]) : this._iconClassNames.setValue(null)
            }),
            t
          )
        })(),
        ...
        jt = Object(wt.b)(window.t('{symbolName} data is delayed by {time} minutes.')),
        Nt = Object(wt.b)(window.t('{listedExchange} real-time data is available for free to registered users.')),
        Rt = Object(wt.b)(window.t('To get real-time data for {description}, please buy the real-time data package.')),
        It = Object(wt.b)(
        ...
        Ut = Object(wt.b)(window.t('Data is updated once per second, even if there are more updates on the market.')),
        Kt = Object(wt.b)(window.t('Paid plans feature faster data updates.')),
        Xt = Object(wt.b)(window.t('Real-time data for {symbolName} is provided by {exchange} exchange.')),
        Zt = Object(wt.b)(
          window.t(
              ...
              (e.prototype._getHtmls = function () {
                return Object(s.__awaiter)(this, void 0, void 0, function () {
                  ...
                  return Object(s.__generator)(this, function (s) {
                    switch (s.label) {
                      case 0:
                        if (null === (t = this._dataUpdatedMode.value())) return [2, Promise.resolve(null)]
                      ...
                      case 3:
                        return (
                          (l = s.sent()),
                          kt.logError("Can't get exchange description, reason: " + Object(Mt.a)(l)),
                          [3, 4]
                        )
                      case 4:
                        for (a = 0, r = t; a < r.length; a++)
                          (u = r[a]),
                            ...
                            'EOD' === u && (e[u] = [Ft]),
                            'TickByTick' === u &&
                              (e[u].push(this._options.subscriptionFullInfo ? Gt : Ut),
                              this._options.subscriptionFullInfo && e[u].push(Kt)),
                            null !== n &&
                              'BATSToRealtime' === u &&
                              e[u].push(Xt.format({ symbolName: i, exchange: n }), Zt)
              ...
              (e.prototype._getActions = function () {
                return Object(s.__awaiter)(this, void 0, void 0, function () {
                  ...
                  return Object(s.__generator)(this, function (s) {
                    switch (s.label) {
                      case 0:
                        return null === this._dataUpdatedMode.value() ? [2, null] : ((t = {}), [3, 4])
                      case 1:
            ...
            (e.prototype._getHtml = function (t) {
              return Object(s.__awaiter)(this, void 0, void 0, function () {
                ...
                return Object(s.__generator)(this, function (e) {
                  return null === (t = this._dataProblem.value()) ? [2, null] : [2, [Object(wt.b)(t.text)]]
                })
              })
            }),
        ...
        me = (function () {
          ...
          return (
            ...
            (t.prototype._render = function (t) {
              this._el.classList.add(yt.statusItem, yt[this._size]), t.appendChild(this._el)
            }),
      ...
      var ge = (function () {
          function t(t, e) {
            ...
            f.trackingModeIsAvailable && n.push(yt.touchMode),
              (i = this.element.classList).add.apply(i, Object(s.__spreadArrays)(n, [yt[t]])),
          ...
          return (
            (t.prototype.destroy = function () {
              ...
              this.element.removeEventListener('click', this._onClick), this.element.remove()
            }),
            (t.prototype.addStatusModel = function (t) {
              ...
              e.subscribe(this._updateSpecialClassAndTooltip.bind(this)), this._visibilitySpawns.push(e)
              var i = t.model.tooltip().spawn()
              i.subscribe(this._updateTooltip.bind(this)), this._tooltipSpawns.push(i)
            }),
                    ...
                    case 1:
                      return (
                        null !== (i = s.sent()) &&
                          ...
                          ('pre_market' === e && this._options.preMarketSolution && i.push(Ge),
                          'post_market' === e && this._options.postMarketSolution && i.push(Ge)),
                        [2, i]
                      )
                  }
                })
      ...
      var Ke = (function () {
          function t(t, e) {
            ...
            if (
              ...
              this._isSymbolInvalid = Object(gt.a)(t.isSymbolInvalid.bind(t), t.onStatusChanged())
              ...
              this._statusWidgetInfos.push(o),
                ...
                Object(N.a)(
                  ...
                  i._symbolInvalidVisibility.setValue(i._symbolInvalidShow.value() && s.visible().value())
                })
            }
            if (this._options.marketStatusEnabled) {
              var n = t.marketStatusModel()
              if (null !== n) {
                var l = new Ue(n.status(), this._size, this._options.marketStatus),
                ...
                this._statusWidgetInfos.push(a),
                  ...
                  Object(N.a)(
                    ...
                    i._marketStatusVisibility.setValue(i._marketStatusShow.value() && l.visible().value())
                  })
              }
            }
              ...
              if (null !== r) {
                ...
                this._statusWidgetInfos.push(d),
                  ...
                  Object(N.a)(
                    ...
                    i._dataUpdatedModeVisibility.setValue(i._dataUpdatedModeShow.value() && u.visible().value())
                  })
              }
            }
            if (this._options.dataUpdateModeEnabled) {
              ...
              if (null !== h) {
                ...
                this._statusWidgetInfos.push(d),
                  ...
                  Object(N.a)(
                    ...
                    i._dataProblemVisibility.setValue(i._dataProblemShow.value() && c.visible().value())
                  })
              }
            }
          ...
          return (
            (t.prototype.destroy = function () {
              var t
              Object(tt.isStudy)(this._source) || this._source.properties().symbol.listeners().unsubscribeAll(this),
                this._options.sourceStatusesEnabled && this._isSymbolInvalid.destroy(),
            ...
            (t.prototype._addVisibilitySubscriptions = function () {
              var t
              this._options.sourceStatusesEnabled &&
                (this._isSymbolInvalid.subscribe(this._updateSymbolInvalidShow.bind(this), { callWithLast: !0 }),
            ...
            (t.prototype._updateForceStatusActive = function () {
              ...
              this._marketStatusShow.setValue(!t),
                ...
                this._dataProblemShow.setValue(!this._isDataProblemShouldBeHide())
            }),
            ...
            (t.prototype._getWidgetsTooltip = function () {
              for (var t = [], e = 0, i = this._statusWidgetInfos; e < i.length; e++) {
                var s = i[e]
                if (s.visible.value()) {
            ...
            (t.prototype._updateDropdownMenu = function () {
              var t = this
              Promise.all([i.e('react'), i.e(2), i.e(23), i.e(89), i.e(1), i.e(10), i.e('full-tooltips-popup')])
            ...
            (t.prototype._handleToggleDropdown = function (t) {
              ...
              ;(this._menuPosition = t),
                ...
                this._menuOpened &&
                  ...
                  (e = 'Open full tooltip for statuses: ' + this._getWidgetsTooltip()),
        ...
        qe = window.t("You're in Replay mode. You're in Replay mode. You're in Replay mode."),
        Ye =
          (new Map([
            [
              !0,
        ...
        return (function (t, e, i, s) {
          ...
          o.push(
            new Je.Action({
              ...
              onExecute: function () {
                return ei(t, n.showSeriesTitle, 'Change Symbol Description Visibility')
              }
            })
          ),
          ...
          o.push(
            ...
            o.push(
              new Je.Action({
                ...
                onExecute: function () {
                  return ei(t, n.showStudyTitles, 'Change Indicator Titles Visibility')
                }
              })
            ),
            o.push(
              new Je.Action({
                ...
                onExecute: function () {
                  return ei(t, n.showStudyArguments, 'Change Indicator Arguments Visibility')
                }
              })
            ),
            o.push(
              new Je.Action({
                ...
                onExecute: function () {
                  return ei(t, n.showStudyValues, 'Change Indicator Values Visibility')
                }
              })
            ),
            hi ||
              ...
              o.push(
                new Je.Action({
                  ...
                  statName: 'Wrap Text',
                  onExecute: function () {
                    ei(t, n.wrapText, 'Change wrap text'), vi('Change wrap text ' + (n.wrapText ? 'on' : 'off'))
                  }
                })
              ))
          e.settings &&
      ...
      var _i = {
        ...
        bi = (Z.enabled('hide_legend_by_default'), Z.enabled('fundamental_widget')),
      ...
      var gi = (function () {
        function t(t, e, i, o, n, l) {
          ...
          var d = this._model.model().properties().paneProperties.legendProperties.showBackground,
            h = new P.a(d.value())
          d.subscribe(this, function () {
            h.setValue(d.value())
          })
          var c = this._model.model().properties().paneProperties.legendProperties.backgroundTransparency,
            p = new P.a(c.value())
          c.subscribe(this, function () {
            p.setValue(c.value())
          })
          var _ = this._model.model().properties().paneProperties.legendProperties.wrapText
          ;(this._wrapText = new P.a(_.value())),
            ...
            (this._updateCollapsedSourcesModeThrottle = pi()(this._updateCollapsedSourcesMode.bind(this), 100)),
        ...
        return (
          (t.prototype.destroy = function () {
            this._hideNotMainSources.destroy(),
              null !== this._mainSeriesViewModel && this._mainSeriesViewModel.destroy()
            ...
            this._clearVisibilitiesSubscriptions(),
              ...
              this._model.model().properties().paneProperties.legendProperties.wrapText.unsubscribeAll(this)
          }),
          (t.prototype.onShowLegendWidgetContextMenu = function (t, e) {
            return mi
              ? ii(this._model, this._options.contextMenu, this._callbacks.showGeneralChartProperties, t, e)
              : Promise.resolve(null)
          }),
              ...
              ? (t.splice(i, 1),
                bi ||
                  ...
                  this._renderer.addMainDataSource(
                    ...
                    new Ye(e, this._model.model(), this._options.statusesWidgets)
                  )))
              : null !== this._mainSeriesViewModel &&
                (this._mainSeriesViewModel.destroy(), (this._mainSeriesViewModel = null))
            var s = [],
            ...
            if (0 === o)
              ...
              for (n = t.length - 1; n >= 0; n--)
                this._dataSourceViewModels[l]
                  ...
                  l++
              for (n = l; n < this._dataSourceViewModels.length; n++) this._dataSourceViewModels[n].destroy()
              this._dataSourceViewModels.splice(l, this._dataSourceViewModels.length - l)
            }
            0 !== s.length &&
              (this._renderer.addDataSources(s), (this._dataSourceViewModels = this._dataSourceViewModels.concat(s))),
          ...
          (t.prototype._updateWidgetModeByHeight = function (t) {
            ;(this._availableHeight = 0.9 * t), this._updateCollapsedSourcesModeThrottle()
          }),
