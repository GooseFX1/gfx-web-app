;(window.webpackJsonp = window.webpackJsonp || []).push([
  ['object-tree-dialog'],
  {
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              key: 'getTarget',
              value: function (e) {
                return (0, o.default)(this.isTargetId(e), 'Expected a valid target ID.'), this.dropTargets.get(e)
              }
            },
            {
              key: 'getSourceType',
            ...
            },
            {
              ...
              value: function (e) {
                ...
                ;(0, o.default)(t, 'Expected an existing source.'), (this.pinnedSourceId = e), (this.pinnedSource = t)
              }
            },
            {
              key: 'unpinSource',
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.default = function (e) {
          return function (t) {
            ...
            c(o, a, d)
            var f = a.getItemType()
            return u(o, d, f), l(o, a, d), { type: i.HOVER, payload: { targetIds: o, clientOffset: r || null } }
          }
        })
      var r = a(n('QLaP')),
        o = a(n('gGVb')),
        ...
        (t.DragLayer = function (e) {
          ...
          return (
            ...
            function (n) {
                            ...
                            return void 0 === n
                              ...
                              : (e.receiveDragDropManager(n),
                                e.isCurrentlyMounted
                                  ? r.createElement(
                                      c,
                                      Object.assign({}, e.props, e.state, { ref: (0, u.isRefable)(c) ? e.ref : null })
                                    )
                                  : null)
                          })
                        }
              ...
              return (m.displayName = 'DragLayer('.concat(p, ')')), (m.DecoratedComponent = n), (0, i.default)(m, n)
            }
          )
        })
      var r = (function (e) {
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                key: 'hover',
                value: function () {
                  this.spec.hover && this.spec.hover(this.props, this.monitor, (0, i.getDecoratedComponent)(this.ref))
                }
              },
              {
                key: 'drop',
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.validateType = function e(t, n) {
          ...
          ;(0, o.default)(
            ...
            n ? 'Type can only be a string, a symbol, or an array of either.' : 'Type can only be a string or a symbol.'
          )
        })
      var r,
        o = (r = n('QLaP')) && r.__esModule ? r : { default: r }
        ...
        function e(t, n) {
          ...
          !(function (e, t) {
            ...
            (this.handleTopDragStart = function (e) {
              if (!e.defaultPrevented) {
                ...
                if (r.monitor.isDragging()) {
                  ...
                  if (o && !o.types && ((e.target && !e.target.hasAttribute) || !e.target.hasAttribute('draggable')))
                    return
                  e.preventDefault()
                }
              }
            ...
            (this.handleTopDropCapture = function (e) {
              ;(r.dropTargetIds = []),
                e.preventDefault(),
                r.isDraggingNativeItem() && r.currentNativeSource.mutateItemByReadingDataTransfer(e.dataTransfer),
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return (0, r.default)(t, 'Expected to find a valid source.'), !this.isDragging() && t.canDrag(this, e)
              }
            },
            {
              key: 'canDropOnTarget',
              value: function (e) {
                ...
                if (((0, r.default)(t, 'Expected to find a valid target.'), !this.isDragging() || this.didDrop()))
                  return !1
    ...
    laIQ: function (e, t, n) {
      ...
      var f = (function () {
        function e() {
          ...
          var r = d(n)
          ;(this.store = r), (this.monitor = new a.default(r, new s.default(r))), r.subscribe(this.handleRefCountChange)
        }
        var t, n, r
        return (
          (t = e),
    ...
    mGlc: function (e, t, n) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.getDragPreviewOffset = function (e, t, n, r, s) {
          var c = ((_ = t), 'IMG' === _.nodeName && ((0, o.isFirefox)() || !document.documentElement.contains(_))),
            u = a(c ? e : t),
          ...
          var _
          return {
            x: 0 === y || y ? y : new i.default([0, 0.5, 1], [l.x, (l.x / d) * v, l.x + v - d]).interpolate(h),
            y: O
              ? m
    ...
    td7b: function (e, t, n) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.default = function (e) {
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      if (this.handlerMonitor && this.manager && this.handlerConnector && e !== this.currentType) {
                        ...
                        var s = this.manager.getMonitor().subscribeToStateChange(this.handleChange, { handlerIds: [i] })
          ...
          return (D.DecoratedComponent = t), (D.displayName = ''.concat(b, '(').concat(w, ')')), (0, a.default)(D, t)
        })
      var r = (function (e) {
          if (e && e.__esModule) return e
          var t = d()
    ...
    xNz2: function (e, t, n) {
      ...
      var ne =
          (te((J = {}), H.mouse, { start: 'mousedown', move: 'mousemove', end: 'mouseup', contextmenu: 'contextmenu' }),
      ...
      const Qe = (e) => e.nodes,
        ...
        lt = Object(qe.a)([Qe, ut], (e, t) => t.reduce((t, n) => [...t, ...dt(e, Object(D.ensureDefined)(n))], []))
      function dt(e, t) {
        const n = []
      ...
      function* Tt(e = {}) {
        const {
          ...
          u = [Object(w.d)(_t, r), Object(w.d)(St, n), Object(w.d)(mt, i, c), Object(w.d)(yt, i, a), Object(w.d)(bt)]
        for (t && u.push(Object(w.d)(t)), o && u.push(Object(w.d)(wt, o)), c && u.push(Object(w.d)(vt, c)); ; ) {
            ...
            case ue: {
              ...
              for (const t of Object.keys(e))
                if (!r.includes(t)) {
                  ...
                  e &&
                    (o[e] = Object.assign(Object.assign({}, o[e]), { children: o[e].children.filter((e) => e !== t) })),
                    delete o[t]
                }
              for (const e of n) {
                const t = e.id
            ...
            case Me: {
              ...
              for (const t of n) {
                ...
                if (n.parentId) {
                  ...
                  s[n.parentId] = Object.assign(Object.assign({}, r), { children: r.children.filter((e) => e !== t) })
                }
      ...
      const an = o.a.forwardRef((e, t) => {
          ...
          return (
            ...
            Object(r.useImperativeHandle)(t, () => ({ getNode: () => Object(D.ensureNotNull)(n.current) }), []),
      ...
      const bn = o.a.forwardRef(function (e, t) {
          ...
          const L = Object(r.useCallback)((e) => {
              ...
              return (
                n === A.current.length - 1 &&
                  ((t = Object.assign(Object.assign({}, t), { bottom: 0, minHeight: t.height })), delete t.height),
          ...
          const K = Object(r.useRef)(null),
            ...
            X = Object(r.useRef)({
              startScroll(e) {
                const t = () => {
                  null !== z.current && ((Q.current = requestAnimationFrame(t)), z.current.scrollBy({ top: e }))
                }
                this.stopScroll(), t()
              },
              stopScroll() {
                ...
                ;(s = a > 20 && a <= 40),
                  ...
                  (c = i > 20 && i <= 40) || s
                    ? 'touch' === e.drag
                      ? n.startScroll(c ? -5 : 5)
                      : n.startScroll(c ? -2 : 2)
                    : (u || l) && ('touch' === e.drag ? n.startScroll(u ? -10 : 10) : n.startScroll(u ? -5 : 5))
              })(r.y, i.bottom, i.top)
            }
          },
      ...
      function Zn(e) {
        ...
        if (u) {
          const e = A.entity(u)
          e && (H['data-parent-name'] = e.title()), (H['data-type'] = l.hasChildren() ? 'group' : 'data-source')
        }
        ...
        return o.a.createElement(
            ...
            onClick:
              1 === p
                ...
                : function (e) {
                    ...
                    if (R.current)
                      e.preventDefault(), clearTimeout(R.current), (R.current = null), A.openProperties(l), N(!1)
                    else {
          ...
          !U &&
            o.a.createElement(
              ...
              B && B.type === Hn.Text && o.a.createElement('span', { className: T(Qn.icon, Qn.textIcon) }, B.content),
              o.a.createElement(
                'span',
                Object.assign(
                  {
        ...
        constructor(e) {
          super(e),
            ...
            (this._handleMediaChange = () => {
              this.state.showDrawer && !window.matchMedia(m.a.TabletSmall).matches && this.setState({ showDrawer: !1 })
            }),
      ...
      class Sr {
        ...
        onLockChanged() {
          return Object(sr.isLineTool)(this._dataSource) ? this._dataSource.properties().frozen.listeners() : _r
        }
        getIcon() {
          const e = u,
      ...
      class Tr {
        constructor(e) {
          ;(this._controller = e), (this._facade = new Dr(e)), (this._groupModel = e.model().lineToolsGroupModel())
        }
        buildTree() {
          const e = {},
            t = {}
          for (const n of this._controller.model().panes()) {
            ...
            for (const o of this._groupModel.groups()) {
              ...
              if (r.pane() === n) {
                t[r.id()] = r
                const i = [...o.lineTools()].sort((e, t) => (e.zorder() > t.zorder() ? -1 : 1)).map((e) => e.id())
      ...
      class Gr {
        ...
        _getActionsForGroupItem(e, t, n) {
          ...
          return (
            1 === this._objects.length && (r.unshift(new Er.Separator()), r.unshift(this._getRenameAction(t))),
        ...
        _normalizeTargetAndDropType(e, t) {
          ...
          return 'inside' === t && ((t = 'before'), (n = Object(D.ensureDefined)([...n.children()].shift()))), [n, t]
        }
        _getSelectedEntities() {
          ...
          return (
            t.length &&
              Br.logWarn('Detected dangling sources in selection. They will be ignored: ' + JSON.stringify(t)),
            e
          )
        }
        _getEntityById(e) {
      ...
      class Ur extends Fr.a {
        constructor() {
          ...
          ;(this._activeChartWidget = e.activeChartWidget.value()), (this._viewModel = new Gr(e.activeChartWidget))
        }
        hide() {
          this._handleClose()
        }
    ...
    yN0L: function (e, t, n) {
      ...
      function d(e, t, n, r) {
        ...
        return (
          (function (e) {
            ;(0, o.default)(void 0 === e || (0, a.isObject)(e), 'Drop result must either be an object or undefined.')
          })(s),
