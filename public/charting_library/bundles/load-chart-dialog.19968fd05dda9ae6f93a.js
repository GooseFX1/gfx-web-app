    ...
    AMW5: function (e, t, n) {
      ...
      function C(e) {
        ...
        return o.a.createElement(
          ...
          Object(a.__assign)({}, i, {
            ref: c,
            className: m(w.sortButton, 'apply-common-tooltip', 'common-tooltip-vertical'),
            onClick: function () {
              u(!s)
            }
          }),
        ...
        Object(r.useEffect)(
          function () {
            if (E) {
              ...
              e && (e.addEventListener('mousemove', I), e.addEventListener('mouseup', L))
            } else p && p()
            return function () {
              var e = Object(c.ensureNotNull)(w.current).ownerDocument
              e && (e.removeEventListener('mousemove', I), e.removeEventListener('mouseup', L))
            }
          },
          [E]
        )
        ...
        return o.a.createElement(
          'div',
          {
            ...
            onMouseDown: function (e) {
              ...
              var n = a - i,
                r = M(e.nativeEvent, Object(c.ensureNotNull)(w.current)) - N.current
              r < 0
                ? ((r = 0), (N.current = M(e.nativeEvent, Object(c.ensureNotNull)(w.current))))
                : r > n * _ * x &&
                  ((r = n * _ * x), (N.current = M(e.nativeEvent, Object(c.ensureNotNull)(w.current)) - r))
              u(r / _ / x), j(!0)
            }
          },
          o.a.createElement(
            'div',
            {
              ...
              style:
                ...
                (n[d ? 'width' : 'height'] = y),
                (n.transform = 'translate' + (d ? 'X' : 'Y') + '(' + (T * _ * x || 0) + 'px)'),
                n),
              onMouseDown: function (e) {
                e.preventDefault(), (N.current = M(e.nativeEvent, Object(c.ensureNotNull)(C.current))), j(!0)
              }
            },
            ...
            function () {
              var e = [
                ...
                o = function (e) {
                  ...
                  ;(a = t.length - f > 0 ? n(o, { timeout: 500 }) : null), m.current && m.current()
                },
                a = n(o, { timeout: 500 })
              return function () {
                null !== a && r(a)
      ...
      function B(e) {
        ...
        return o.a.createElement(
          ...
          o.a.createElement('div', { className: R.overlapScrollWrap }, o.a.createElement(L, Object(a.__assign)({}, h))),
          o.a.createElement(M, {
            key: n,
            initCount: 10,
            items: C,
      ...
      function Y(e) {
        ...
        return o.a.createElement(
          ...
          a.map(function (e, t) {
            return t % 2
              ? o.a.createElement('span', { key: t, className: f()(Q.highlight, i && Q.active) }, e)
        ...
        return o.a.createElement(
          ...
          g &&
            ...
            o.a.createElement(U.a, {
              className: f()(Q.favoriteButton, v && Q.favorite, u.CheckMobile.any() && Q.mobile),
              isActive: m,
              isFilled: v,
          ...
          o.a.createElement(
            ...
            o.a.createElement('div', { className: f()(Q.details, m && Q.active, p && Q.mobile) }, i)
          ),
            ...
            return Object(a.__spreadArrays)(t)
              .sort(
                ...
                function (t, n) {
                  ...
                  if (!D[t.id] && D[n.id]) return 1
                  var r = 0 === e ? 1 : -1
                  return 'modified' === x.sortField ? r * (t.modified - n.modified) : r * t.title.localeCompare(n.title)
                })
              )
              .filter(function (e) {
                return !w.includes(e.id) && (U(e.title) || U(e.symbol) || U(te(e.interval)))
              })
            var e
          },
          [f, x, w, D]
    ...
    QHWU: function (e, t, n) {
      ...
      function m(e) {
        ...
        return i.a.createElement(
          ...
          n && i.a.createElement('div', { className: d.cancel, onClick: n }, Object(l.t)('Cancel'))
        )
      }
      function f(e) {
        var t = e.className,
      ...
      function O(e) {
        ...
        return i.a.createElement(
          ...
          i.a.createElement(
            ...
            n && i.a.createElement('div', { className: l()(C.ellipsis, C.subtitle) }, n)
          ),
          a,
          ...
          return (
            ...
            (t.prototype.render = function () {
              var e = this,
                ...
                y = 'after' !== s ? u : void 0,
                D = 'after' === s ? u : void 0
              return i.a.createElement(v.a, { rule: f.a.SmallHeight }, function (t) {
                return i.a.createElement(v.a, { rule: f.a.TabletSmall }, function (s) {
                  return i.a.createElement(
                    d.a,
                    {
    ...
    'i/MG': function (e, t, n) {
      ...
      function u(e) {
        var t = e.className,
          ...
          h = Object(r.__rest)(e, ['className', 'isActive', 'onClick', 'title', 'hidden', 'data-name'])
        return o.createElement(
          a.Icon,
          Object(r.__assign)({}, h, {
            'data-name': v,
            className: i(l.button, 'apply-common-tooltip', n && l.active, m && l.hidden, t),
            icon: c,
            onClick: u,
            title: d || s.remove
          })
    ...
    pr86: function (e, t, n) {
      ...
      function d(e) {
        var t = e.className,
          ...
          d = e.isActive,
          m = e.onClick,
          f = Object(r.__rest)(e, ['className', 'isFilled', 'isActive', 'onClick'])
        return o.createElement(
          a.Icon,
          Object(r.__assign)({}, f, {
