  ...
  ['study-template-dialog'],
  {
    ...
    IDfV: function (e, t, n) {
          ...
          function t(t) {
            ...
            if (
              ...
              (n._handleChange = function (e) {
                ...
                if (o && '' === c) n.setState({ queryValue: c, isOpened: !1, active: void 0 }), a && a()
                else {
                  ...
                  switch (e.which) {
                    ...
                    case o.Enter:
                      ...
                      r && (u && _ ? n.setState(n._valueToQuery(_)) : (_ = p)),
                        void 0 !== _ &&
                          (n._close(), u || n._blur(), _ !== s ? i && i(_) : n.setState(n._valueToQuery(_)))
                  }
                }
              }),
            ...
            (t.prototype._renderSuggestions = function () {
              var e = this,
                ...
                n = Object.keys(t).map(function (n) {
                  var o,
                    r = u(d.suggestion, (((o = {})[d.selected] = e.state.active === n), o))
                  return a.createElement(
                    'li',
                    {
                      id: n,
                ...
                o = a.createElement('li', { className: d.noResults }, window.t('No results found'))
              return !n.length && this.props.noEmptyText
                ? null
                : a.createElement('ul', { className: d.suggestions, ref: this._setSuggestionsRef }, n.length ? n : o)
            }),
        ...
        return (
          ...
          c.a.createElement(
            ...
            c.a.createElement(
              ...
              c.a.createElement('div', { className: u(C.indicators, L && C.withSuggestions) }, r)
            )
          )
        )
      }
          ...
          function e(e) {
            ...
            ;(this._container = document.createElement('div')),
              ...
              (this.unmount = function () {
                D.unsubscribe(k.CLOSE_POPUPS_AND_DIALOGS_COMMAND, t.unmount, null),
              ...
              D.subscribe(k.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.unmount, null)
          }
          return (
      ...
      var M = Object(i.t)('Save Indicator Template'),
        ...
        H = Object(i.t)("Study Template '{templateName}' already exists. Do you really want to replace it?")
      function P(e, t, n) {
        j.backend.saveStudyTemplate(e, function (e) {
          ;('error' in e && e.error) || (j.backend.invalidateStudyTemplatesList(), j.backend.getStudyTemplatesList(t))
        })
      }
      var z = (function () {
        function e(e) {
                ...
                ;(function (e, t) {
                  return new Promise(function (n) {
                    Object(A.createConfirmDialog)({
                      type: 'modal',
                      content: document.createTextNode(H.format({ templateName: e })),
                      manager: t
                    }).then(function (e) {
                      var t = !1
    ...
    L0Sj: function (e, t, n) {
            ...
            (t.prototype.render = function () {
              var e,
                ...
                b = s(
                  ...
                  (((e = {})[i.error] = a), (e[i.success] = l), (e[i[u]] = Boolean(u)), e)
                ),
                S = s(i.inputWrapper, (((t = {})[_] = Boolean(_)), (t[i.grouped] = h), (t[i.column] = f), t)),
                w = [],
                O = r.createElement(
                  'input',
                  Object(o.__assign)({ ref: v, className: b, key: 'textInput', style: y }, g)
                )
              if (p) {
                var C = {
      ...
      function u(e) {
        var t,
          ...
          d = Object(o.__rest)(e, ['className', 'icon', 'clearable', 'onClear', 'size', 'strictLeftDirectionInput']),
          v = s(c.inputWrapper, (((t = {})[n] = Boolean(n)), (t[c.iconed] = Boolean(u)), (t[c.clearable] = p), t))
