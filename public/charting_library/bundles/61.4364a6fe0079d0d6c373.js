            ...
            if ('options' in t) {
              ...
              b.push(
                Object(n.j)(
                  ...
                  { id: `${u}${t.name}`, title: y, type: 0, min: new s.a(t.min), max: new s.a(t.max), defval: t.defval }
                )
              )
          }),
          b
        ...
        _createSeriesDefinitions() {
          ...
          return new Promise((e) => {
            ...
            const t = Object(a.a)(
              ...
              e,
              r,
              { seriesPriceSources: $, lineStyleTypes: I, isJapaneseChartsAvailable: !0, defaultSeriesFontSizes: E },
              'mainSeries'
            )
            null !== i && t.push(...i)
            const o = Object(n.k)(
