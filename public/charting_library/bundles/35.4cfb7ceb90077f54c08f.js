    ...
    DxCR: function (t, e, i) {
      ...
      ;(function (t) {
        ...
        function w(t, e, i, o, n, r, s) {
          v.call(this, t, e, o, n, r), (this._transformFunction = i), (this._setter = s), this._attachToControl(t, o)
        }
        ...
        function R(e, i, o, n, r, s) {
          isNumber(i.value()) ||
            (g.logWarn('Property cannot be binded to control, bad value (expect number): ' + i.value()), (i = new t())),
          ...
          function l(t, e) {
            var i = a.control().slider('option', 'min'),
              ...
              n = a._property.value()
            ;((i <= n && n <= o) || (i < e.value && e.value < o)) && a.setValueToProperty(e.value)
          }
          function c(t, e) {
            a.setValueToProperty(e.value)
          }
          o && (s ? (e.bind('slidechange', l), e.bind('slide', l)) : (e.bind('slidechange', c), e.bind('slide', c))),
        ...
        function H(t, e, i, o, n, r, s, a) {
          ...
          t.slider({
            ...
            r &&
              ...
              $(r).each(function () {
                $(this).on('keydown', function (t) {
                  parseInt($(r[0]).val()) < l._transformers[0]
                    ...
                    : parseInt($(r[1]).val()) > l._transformers[1] && $(r[1]).val(l._transformers[1]),
              ...
              $(r[0]).on('keyup', function (t) {
                parseInt($(this).val()) < l._transformers[0]
                  ...
                  parseInt($(this).val()) > parseInt($(r[1]).val()) && $(this).val(r[1].val()),
                  l._control.slider('values', 0, $(this).val()),
                  H.prototype.setValueToProperty.call(l, l._control.slider('values'), 'from')
              }),
              $(r[1]).on('keyup', function (t) {
                parseInt($(this).val()) < l._transformers[0]
                  ? $(this).val(l._transformers[0])
                  : parseInt($(this).val()) > l._transformers[1] && $(this).val(l._transformers[1]),
                  parseInt($(this).val()) < $(r[0]).val() && $(this).val(r[0].val()),
                  l._control.slider('values', 1, $(this).val()),
                  H.prototype.setValueToProperty.call(l, l._control.slider('values'), 'to')
              })),
            this._propFrom.listeners().subscribe(this, H.prototype.propertyChanged),
            ...
            t.slider({
              stop: function (t, e) {
                r && ($(r[0]).val(l._control.slider('values', 0)), $(r[1]).val(l._control.slider('values', 1))),
                  l.setValueToProperty(l._control.slider('values'), e.handle)
              },
              start: function (t, e) {
                r && ($(r[0]).val(l._control.slider('values', 0)), $(r[1]).val(l._control.slider('values', 1))),
        ...
        ;(b.prototype.model = function () {
          ...
          (b.prototype.createLabeledCell = function (t, e, i) {
            var o,
              n,
              r = null
            'number' == typeof t.valueOf() ? ((r = t), (o = e), (n = i)) : ((o = t), (n = e)), (o += '')
          ...
          (b.prototype.addLabeledRow = function (t, e, i, o) {
            ...
            if ((o && ((o = parseInt(o)), r(o) && (o = 2), a.attr('colspan', o)), i)) {
          ...
          (V.prototype.value = function () {
            ...
            return (
              i <= e && (e = i - 1),
              1e3 *
                n(this._mainSeries.bars().valueAt(n(this._mainSeries.bars().lastIndex()) - e))[TradingView.TIME_PLOT]
            )
          }),
              ...
              return t.widget('ui.slider', t.ui.mouse, {
                        ...
                        ;(i = ((l.values(o) - l._valueMin()) / (l._valueMax() - l._valueMin())) * 100),
                          ...
                          !0 === l.options.range &&
                            ('horizontal' === l.orientation
                              ? (0 === o && l.range.stop(1, 1)[c ? 'animate' : 'css']({ left: i + '%' }, a.animate),
                                1 === o &&
                ...
                _handleEvents: {
                  keydown: function (e) {
                    ...
                    switch (
                      ((n = this.options.step),
                      (i = o = this._hasMultipleValues() ? this.values(r) : this.value()),
                      e.keyCode)
                    ) {
                      case t.ui.keyCode.HOME:
                        o = this._valueMin()
        ...
        return (
          ...
          (t.prototype.initEvents = function () {
            var t = this.$el.prop('ownerDocument'),
              ...
              i = function (o) {
                return $(t).off('mousemove mouseup', e), $(t).off('mouseup', i), this.mouseupHandler(o)
              }.bind(this)
            this.$el.on(
              'mousedown',
              function (o) {
        ...
        var u = function () {},
          ...
          d = function (l, d, f) {
            var v = n(),
              ...
              _ = r(g),
              b = d || e
            if (('function' == typeof b && (b = b()), $(this).hasClass('open') || $(this).hasClass('active')))
              return l.preventDefault(), p(), void (P = h.scrollTop)
            function y(e) {
              var i = $(e.target).parents().andSelf()
              i.is(k) || i.is(t) || i.is('.charts-popup-tab-headers, .charts-popup-itemheader') || p()
            }
            function C(t) {
            ...
            a.addClass && k.addClass(a.addClass), a.zIndex && k.css('z-index', a.zIndex)
            var w = k
              ...
              $.each(b, function (e) {
                !(function e(o, n, r) {
                  if (o instanceof s.TabGroup) {
                    ...
                    var l = $('<div class="charts-popup-tab-group"></div>').appendTo(r),
                      c = $('<div class="charts-popup-tab-headers"></div>').appendTo(l),
                      u = null
                    $.each(o.tabs || [], function (t, i) {
                      if (i.items && i.items.length) {
                        var n = $('<div class="charts-popup-tab"></div>').hide().appendTo(l)
                        $.each(i.items, function () {
                          e(this, void 0, n)
                        })
                        var r = $('<span class="charts-popup-tab-header">')
                          .append($('<a href="javascript://" class="charts-popup-tab-header-label">').text(i.name))
                          .appendTo(c)
                        r.on('click', function (t) {
                          r.is('.active') ||
                            ...
                            n.show(),
                            t && t.preventDefault(),
                            'function' == typeof o.onChange && o.onChange.call(o, i.name))
                        }),
                          (u && !i.active) ||
                            ((u = r),
                            c.find('.charts-popup-tab-header.active').removeClass('active'),
                    ...
                    var p = $('<div class="charts-popup-group"></div>').appendTo(r)
                    if (o.title) {
                      ...
                      o.collapsible &&
                        ...
                        h.on('click', function () {
                          p.toggleClass('collapsed'),
                            'function' == typeof o.onChange && o.onChange(p.hasClass('collapsed')),
                            k.height() === parseInt(k.css('max-height'))
                              ? k.addClass('popup-menu-scroll-y')
                              : k.height() < parseInt(k.css('max-height')) && k.removeClass('popup-menu-scroll-y')
                        })),
                        p.append(h)
                    }
                    ...
                    r.append($('<div class="charts-popup-itemheader"></div>').text(o.title))
                  else if (o.separator) {
                    ...
                    if (o.date)
                      ...
                      !0 === a.svg && o.svg
                        ? (a.wrapIcon
                            ? d.append($('<span class="icon-wrap">').addClass(o.iconClass).append(o.svg))
                            : d.append(o.svg),
                          (f = $('<span class="title"></span>').appendTo(d)))
                        : o.iconClass
                        ? (d.append($('<span class="icon"></span>').addClass(o.iconClass)),
                          (f = $('<span class="title"></span>').appendTo(d)))
                        : (f = $('<span class="title-expanded"></span>').appendTo(d))
                    o.html ? f.html(o.html) : f.text(TradingView.clean(o.title, !0) || '')
                    var _ = $('<span class="shortcut"></span>').appendTo(d)
                    if ((o.shortcut && _.text(o.shortcut.keys), 'function' == typeof o.deleteAction)) {
                    ...
                    if (
                      ...
                      if ('function' == typeof o.counter) {
                        $('<span class="counter"></span>').html(o.counter()).appendTo(d)
                      } else {
                    ...
                    o.name && d.attr('data-name', o.name), r.append(d), t.data('popup-menu', r)
                  }
                })(this, e, w)
              }),
            ...
            var x = g.documentElement.clientWidth,
              ...
              E = t.offset(),
              P = $(m).scrollTop() || 0
            ;(E.top -= P), (E.top = Math.round(E.top)), (E.left = Math.round(E.left))
            var O = k.outerWidth(),
              I = k.outerHeight(),
              ...
              A = I - k.height(),
              L = 'down'
            a.direction && (L = 'function' == typeof a.direction ? a.direction() : a.direction)
            var H = !!a.reverse
            if ('down' === L) {
            ...
            switch (L) {
              ...
              case 'up':
                'down' === L
                  ...
                  H
                    ? k.css('left', Math.max(E.left + R + V - O, D) + 'px').css('right', 'auto')
              ...
              case 'left':
                ;(F = Math.max(F, 4)),
                  'right' === L
                    ? k.css('left', Math.floor(E.left + V + F) + 'px').css('right', 'auto')
                    : k.css('left', Math.floor(Math.max(E.left - O - F, D)) + 'px').css('right', 'auto'),
                  H
                    ? k.css('top', Math.floor(Math.max(E.top + R + S - I, D)) + 'px')
      ...
      !(function (t) {
        ...
        function b(y) {
          ...
          function T(e, i, o) {
            ...
            ;(e = f(n(v(e), i))),
              $.call(this, e),
              r.removeData('tvcolorpicker').removeData('tvcolorpicker-custom-color'),
              o && (M.call(r), r.blur())
          }
          function $(e) {
            var i = t(this)
            i.val(e), i.change(), e ? i.trigger('pick-color', e) : i.trigger('pick-transparent'), k.call(this, e)
          }
          function k(e) {
            '' !== e
            ...
            return (
              t.each(e, function (e, s) {
                ...
                var l = t('<td class="tvcolorpicker-cell"></td>').appendTo(o),
                  p = t('<div class="tvcolorpicker-transparency"><div class="tvcolorpicker-swatch"></div></div>')
                    .appendTo(l)
          ...
          function x(i) {
            ...
            var k = t('<div class="tvcolorpicker-custom-area"></div>').css({ display: 'none' }).appendTo(b),
            ...
            function N(e) {
              1 == e.which && ((A = !1), b.is('.opened') && t(r).get(0).focus())
            }
            function W(e) {
              var i = (function (e) {
                var i = e.pageY,
              ...
              I.css({ top: i + 'px' }), (B[2] = c(1 - Math.max(0, Math.min(i, F)) / F)), U()
            }
            function G(e) {
              1 == e.which && ((L = !1), t(_).unbind('mouseup', G), b.is('.opened') && t(r).get(0).focus())
            }
            function U() {
              H && ((H = !1), b.find('.tvcolorpicker-swatch.active').removeClass('active'))
              var t = n(h(B), C.val())
            ...
            E.bind('mousedown', function (e) {
              1 == e.which && ((A = !0), t(_).bind('mouseup', N), z(e), e.preventDefault())
            }),
              ...
              t(C).on(
                'change',
                function () {
                  o ? U() : T.call(this, t(this).val() || 'rgb(14, 15, 16)', C.val())
                }.bind(this)
              ),
              t(C).on(
                'afterChange',
              ...
              P.bind('mousedown', function (e) {
                1 == e.which && ((L = !0), t(_).bind('mouseup', G), W(e), e.preventDefault())
              }),
            ...
            return (
              ...
              (function (e, i, o) {
                var n,
                  ...
                  d = t(i).outerWidth(),
                  f = t(i).outerHeight()
                switch ('function' == typeof o.direction ? o.direction() : o.direction) {
                  default:
                  case 'down':
          ...
          function M() {
            ...
            t(i).find('.tvcolorpicker-popup').removeClass('opened').remove(),
              ...
              t(S).each(function () {
                ...
                o && o != t(this).val() && t(this).trigger('change'), t(this).removeData('tvcolorpicker-previous-color')
              })
          }
          function V(t) {
