  ...
  },
  {
    ...
    answer: (
      <div>
        ...
        impermanent loss doesn't occur, but because of the occasional exposure that the single sided pools get to
        the tokens that we trade there is some risk. We control the token exposure risk using thresholds and by
        letting the real-time token exposure risk influence the prices we quote in order to balance the trade-off
        between profitable market making and holding inventory. For more information see our{' '}
        <GFX_LINK
