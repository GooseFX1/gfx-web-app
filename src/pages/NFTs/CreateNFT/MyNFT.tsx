...
export const MyNFT = ({ visible, setVisible, handleCancel, handleOk, backUrl, data, type }: Props) => {
  ...
  return (
    <StyledMyNFT>
      ...
      <EditMyNFT visible={visible} handleOk={handleOk} handleCancel={handleCancel} type={type} />
    </StyledMyNFT>
  )
}
