...
export const layout = borsh.struct([types.UpdateProductFundingParams.layout('params')])

export function updateProductFunding(args: UpdateProductFundingArgs, accounts: UpdateProductFundingAccounts) {
