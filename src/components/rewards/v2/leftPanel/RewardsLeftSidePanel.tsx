...
export default function RewardsLeftSidePanel({ apy }: { apy: number }): JSX.Element {
  ...
  return (
    <RewardsLeftLayout>
      ...
      />
      <div className={`flex w-full flex-col items-center mb-0 px-[11%] gap-8`}>
        <div
        ...
        border-b-border-lightmode-secondary dark:border-b-border-darkmode-secondary
         px-2 pt-2.5 min-md:px-0 min-md:pt-7`}
        >
       ...
       <div className={'inline-flex gap-4 w-full'}>
         <div
           className={`flex-col gap-4 hidden min-md:flex p-4 border-1 border-solid rounded-[8px]
        border-border-lightmode-primary dark:border-border-darkmode-primary`}
         >
           <div className={'flex flex-col gap-2 w-[250px]'}>
             ...
             {userHasGoFx ? (
               ...
               >
                 You have{' '}
                 <span className={'font-bold text-text-lightmode-primary dark:text-text-darkmode-primary'}>
         ...
         <div
           className={`flex-col gap-3 hidden min-md:flex p-4 border-1 border-solid rounded-[8px]
         ...
         >
           <div className={'inline-flex w-full justify-between'}>
             ...
             <div className={'inline-flex items-center gap-1.25'}>
               ...
               <span className={cn(`font-semibold text-b2 text-text-lightmode-secondary
