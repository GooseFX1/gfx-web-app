  ...
  return (
    ...
    >
      ...
      <div className={'flex flex-col gap-2 w-full'}>
        ...
        <RewardInfoRow label={'Earning Rate'}>{apy}% APY</RewardInfoRow>
        <RewardInfoRow label={'Cooldown Period'}>7 Days</RewardInfoRow>
        <RewardInfoRow label={'Earning Period'}>24H</RewardInfoRow>
      </div>
      <RewardsClaimButton />
    </RewardsRightLayout>
  )
