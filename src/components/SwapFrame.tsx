...
export const SwapFrame: FC<{
  ...
  button: ReactElement
  midColFlexValue: number
  midChild: ReactElement
}> = ({
  rowGutterValue,
  firstColFlexValue,
  secondColFlexValue,
  ...
  return (
    <div>
      <WRAPPER>
        <Row gutter={rowGutterValue} align={'top'}>
          ...
          <Col flex={midColFlexValue}>
            <MIDGRID>{midChild}</MIDGRID>
          </Col>
