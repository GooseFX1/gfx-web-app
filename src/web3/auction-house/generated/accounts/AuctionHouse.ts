...
export class AuctionHouseAccountData implements AuctionHouseAccountDataArgs {
   ...
   */
  static fromAccountInfo(accountInfo: web3.AccountInfo<Buffer>, offset = 0): [AuctionHouseAccountData, number] {
  ...
  static async getMinimumBalanceForRentExemption(
    ...
    return connection.getMinimumBalanceForRentExemption(AuctionHouseAccountData.byteSize, commitment)
  }
