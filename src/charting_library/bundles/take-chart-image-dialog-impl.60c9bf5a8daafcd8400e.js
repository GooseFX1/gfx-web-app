  ...
  ['take-chart-image-dialog-impl'],
  {
          ...
          return (
            ...
            (t.prototype.render = function () {
              var e = this.props,
                ...
                v = e.className,
                w = e.backdrop,
                f = i(v, l.dialog, n && l.rounded, p && l.shadowed, u && l.fullscreen, h && l.darker),
    ...
    fMMV: function (e, t, n) {
          ...
          Object(r.__awaiter)(this, void 0, void 0, function () {
            ...
            return Object(r.__generator)(this, function (h) {
              if (((a = new FormData()), void 0 !== o.previews))
                for (c = 0, l = o.previews; c < l.length; c++) (p = l[c]), a.append('previews[]', p)
              return (
                void 0 !== o.cme && a.append('cme', String(o.cme)),
                void 0 !== o.wl && a.append('wl', String(o.wl)),
                void 0 !== o.onWidget && a.append('onWidget', String(o.onWidget)),
                o.isReport && a.append('isReport', String(o.isReport)),
                (d = window.urlParams) && d.locale && a.append('language', d.locale),
              ...
              return p.createElement(
                ...
                p.createElement(
                  ...
                  p.createElement(
                    ...
                    p.createElement(v.a, { mouseDown: !0, touchStart: !0, handler: o }, function (t) {
                      return p.createElement(
                        'div',
        ...
        N = (function (e) {
          ...
          return (
            ...
            (t.prototype.componentDidMount = function () {
              k.subscribe(I.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._onClose, null)
            }),
            (t.prototype.componentWillUnmount = function () {
              k.unsubscribe(I.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._onClose, null)
            }),
            ...
            (t.prototype.render = function () {
              ...
              return p.createElement(
                ...
                p.createElement(g.b, { onClose: this._onClose }, window.t('Image URL')),
                o &&
                  p.createElement(g.c, {
                    text: o,
                    isError: !1,
                    ...
                    p.createElement(
                      ...
                      p.createElement(
                        ...
                        p.createElement(y.b, {
                          ...
                          style: Object(S.isRtl)() ? { paddingLeft: 84 } : void 0
                        }),
                        p.createElement(
                          'div',
                          {
                          ...
                          p.createElement(O.a, { type: 'primary', theme: 'ghost' }, window.t('Copy'))
                        )
                      ),
                      p.createElement(
                        'div',
                        ...
                        p.createElement(
                          ...
                          p.createElement('span', { className: x.socialsText }, window.t('Tweet'))
                        )
                      )
                    )
                  )
      ...
      function M(e, t, n) {
        var r
        function s(e) {
          r || ((r = document.createElement('div')), document.body.appendChild(r)), d.render(p.createElement(N, e), r)
        }
        function c() {
          s({ isOpened: !1 })
        }
