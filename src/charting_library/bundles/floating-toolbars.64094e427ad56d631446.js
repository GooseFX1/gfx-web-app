      ...
      ;(function (e, i) {
        ...
        o('m/4m'),
          ...
          (w.prototype._createWidthsButton = function (t) {
            if ((t = t || this.selectedSources().filter(f)).length < 1 || !y.canCreateForSources(t)) return !1
            ...
            return this._createButton({
              ...
              callback: function () {
                t._trackContextAction('Settings'),
                  t
                    .activeChartWidget()
                    .showChartPropertiesForSource(t.selectedSources()[0], null, {
          ...
          (w.prototype._cloneButtonTitle = function () {
            ...
            return (
              ...
              h(this._chartWidgetCollection.layout.value()) && (t += ', ' + $.t('Sync')),
              t
            )
          }),
