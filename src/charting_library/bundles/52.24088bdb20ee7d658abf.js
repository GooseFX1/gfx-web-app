  ...
  [52],
  {
    ...
    'MP+M': function (o, e, l) {
      ...
      var i = l('+GxX'),
        ...
        t = l('Ijvb'),
        s = l('0qMc')
      const c = { keys: ['Shift'], text: window.t('{0} — drawing a straight line at angles of 45') },
        ...
        d = {
          ...
          group: { icon: t.a.group, localizedName: window.t('Show Hidden Tools') },
          hideAllDrawings: {
          ...
          removeAllDrawingTools: { icon: t.a.removeAllDrawingTools, localizedName: window.t('Remove Drawings') },
          showObjectsTree: { icon: t.a.showObjectTree, localizedName: window.t('Show Object Tree') },
          zoom: { icon: t.a.zoom, localizedName: window.t('Zoom In') },
          'zoom-out': { icon: t.a['zoom-out'], localizedName: window.t('Zoom Out') }
        }
