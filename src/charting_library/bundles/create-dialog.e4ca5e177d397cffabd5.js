  ...
  ['create-dialog'],
  {
              ...
              function (n, r, h) {
                ...
                return (
                  'get' === n
                    ? (a = r)
                    : ((l = r),
                      'object' === (void 0 === n ? 'undefined' : o(n)) && void 0 === r
                        ? ((l = n), (n = 'init'))
                  ...
                  'getInstance' === n
                    ...
                    ? (c = $(this).eq(0).data(t))
                      ? void ('function' == typeof c.destroy
                          ...
                          : s.logError('[Block Plugin] ' + t + ' does not support destroy command'))
                      : void console.warn(
                    ...
                    : $(this).each(function () {
                        var o = $(this),
                          r = o.data(t)
                        void 0 === r && ((r = void 0 === l ? e(o) : e(o, l)), o.data(t, r)),
                          'init' !== n &&
                            ('function' == typeof r[n]
                              ? i(r, n, l)
                              : s.logError('[Block Plugin] ' + t + ' does not support command ' + n))
                      })
                )
              }
            )
    ...
    QwKQ: function (t, e, i) {
      ...
      ;(function (o) {
        ...
        ;($.fn.tvControlCheckbox = (0, n.createTvBlockWithInstance)('tv-control-checkbox', function (t) {
        ...
        function n(e, i, o) {
          ...
          if (
            ...
            return (
              ...
              void this._$wrapper.addClass(s.touch).scroll(this._onScroll.bind(this))
            )
          this._$wrapper.css('overflow', 'hidden'),
            this._$wrapper
              .on('mouseenter.sidebar-scroll', function () {
                n._bottomFixed ||
                  n._dragging ||
                  (n._options.alwaysVisible || n._$scrollBar.addClass('active'), n._onScroll())
              })
              .on('mouseleave.sidebar-scroll', function () {
                n._bottomFixed ||
                  n._dragging ||
                  (n._options.alwaysVisible || n._$scrollBar.removeClass('active'), n._onScroll())
              })
          ...
          var r = this._options.additionalClass ? ' ' + this._options.additionalClass : '',
            h = this._options.alwaysVisible ? ' active-always' : ''
          ;(this._$scrollBarWrapper = $('<div class="sb-scrollbar-wrap">').appendTo(this._$wrapper)),
            (this._$scrollBar = $('<div class="sb-scrollbar sb-scrollbar-body' + r + h + '"></div>').appendTo(
        ...
        ;(n.prototype.isTouch = function () {
            ...
            return (
              e <= 0 ||
                ((this._scroll_target_top =
                  o <= 0 ? this._header_height : Math.min((-t * i) / e + this._header_height, this._header_height)),
          ...
          (n.prototype.scroll = function (t, e) {
            var i = this._$content.position().top,
              o = this._$content.outerHeight() - this.getContainerHeightWithoutHeader() - 1,
              s = e || this._scroll_speed
            return (
              o <= 0 ||
              ((this._scroll_target_top = Math.max(-o + this._header_height, Math.min(this._header_height, i + t * s))),
