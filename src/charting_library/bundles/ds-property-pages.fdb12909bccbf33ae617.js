  ...
  ['ds-property-pages'],
  {
            ...
            if (!l) {
              ...
              var e = s(),
                t = function () {
                  ...
                  t !== o.AlwaysOn &&
                    t !== o.AlwaysOff &&
                    (t = Modernizr.mobiletouch ? o.AlwaysOn : o.VisibleOnMouseOver),
                    l && l.setValue(t)
                }
              e.subscribe(l, t), t()
            }
      ...
      inherit(c, o),
        (c.prototype.prepareLayout = function () {
          ...
          var c = this.createColorPicker(),
            ...
            C = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-bold"></span></span>'),
          ...
          $('<td>').append(g).appendTo(o), $("<td colspan='3'>").append(w).appendTo(o)
          var T = $("<textarea rows='7' cols='60'>").css('width', '100%')
          o = $('<tr>').appendTo(this._table)
          $("<td colspan='7'>").append(T).appendTo(o),
            this.bindControl(
              new r(a, this._linetool.properties().showLabel, !0, this.model(), 'Change Horz Line Text Visibility')
            ),
            this.bindControl(
              new l(
                g,
            ...
            this.bindControl(new s(T, this._linetool.properties().text, null, !0, this.model(), 'Change Text')),
            this.bindControl(
              new r(n, this._linetool.properties().showPrice, !0, this.model(), 'Change Horz Line Price Visibility')
            ),
            this.bindControl(
              new d(i, this._linetool.properties().linecolor, !0, this.model(), 'Change Horz Line Color')
            ),
            this.bindControl(
              new l(t, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Horz Line Style')
            ),
            this.bindControl(
              new p(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Horz Line Width')
            ),
            this.bindControl(
              new l(b, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new l(u, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new d(c, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color')),
            this.bindControl(new r(C, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new r(y, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic')),
            this.loadData()
        }),
        ...
        (b.prototype.prepareLayout = function () {
          if (
            ...
            $('<td>' + $.t('Price') + '</td>').appendTo(i), $('<td>').append(t).appendTo(i), this.loadData()
          }
        }),
    ...
    '/1PJ': function (e, t, i) {
      ...
      inherit(p, n),
        (p.prototype.prepareLayout = function () {
          var e = $('<table class="property-page" cellspacing="0" cellpadding="0">'),
            t = $('<table class="property-page" cellspacing="0" cellpadding="0">').data({
              'layout-tab': d.TabNames.inputs,
              'layout-tab-priority': d.TabPriority.Inputs
            })
          ;(this._table = e.add(t)), n.prototype.prepareLayoutForTable.call(this, e)
          var i = $('<tr>').appendTo(t)
          $('<td>').append($.t('Avg HL in minticks')).appendTo(i)
          var o = $('<td>').appendTo(i),
            a = $("<input type='text'>").addClass('ticker').appendTo(o)
          ;(i = $('<tr>').appendTo(t)), $('<td>').append($.t('Variance')).appendTo(i)
          var r = $('<td>').appendTo(i),
            l = $("<input type='text'>").addClass('ticker').appendTo(r),
            s = this._linetool.properties()
          this.bindInteger(a, s.averageHL, $.t('Change Average HL value'), 1, 5e4),
            this.bindInteger(l, s.variance, $.t('Change Variance value'), 1, 100),
            this.loadData()
        }),
        ...
        (h.prototype.prepareLayout = function () {
          ...
          var e = $('<table cellspacing=4>').appendTo(this._widget),
            ...
            d = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(o)),
            p = this.addLabeledRow(e, $.t('Candles'))
          $('<td>').prependTo(p), $('<td>').append(t).appendTo(p), $('<td>').append(i).appendTo(p)
          ...
          this.bindColor(t, c.candleStyle.upColor, 'Change Candle Up Color'),
            ...
            this.bindBoolean(d, c.candleStyle.drawWick, 'Change Candle Wick Visibility'),
            ...
            this.bindControl(new l(h, c.transparency, !0, this.model(), 'Change Guest Feed Transparency'))
        }),
        ...
        n = (function () {
          ...
          return (
            ...
            (e.prototype.change = function (e) {
              e ? (this._callback = e) : this._callback && this._callback.call(this)
            }),
    ...
    '04K5': function (e, t, i) {
      ...
      inherit(_, a),
        ...
        (_.prototype.prepareLayoutImpl = function (e, t, i, o) {
          ...
          for (var w = 0; w < e.inputs.length; w++) {
            var v,
              _ = e.inputs[w],
              m = _.id,
              f = e.name === g(y.STYLE_RENKO) || e.name === g(y.STYLE_KAGI) || e.name === g(y.STYLE_PB)
            ...
            if (
              !((e.name === g(y.STYLE_RENKO) && 'wicks' === m) || (e.name === g(y.STYLE_RANGE) && 'range' === m)) &&
              (!f || 'source' !== m)
            ) {
              var L,
                S = $('<tr/>'),
                k = this._labelToId(m)
              e.name === g(y.STYLE_RANGE) && 'phantomBars' === m && (L = $('<table><tr></tr></table>')).appendTo(S),
                _.isHidden || S.appendTo(t),
                e.name === g(y.STYLE_RANGE) && 'phantomBars' === m && (S = L.find('tr'))
              var x = $('<td' + (o.nameColspan ? ' colspan = "' + o.nameColspan + '"' : '') + '/>')
              x.addClass('propertypage-name-label'),
                x.html(C(v, k)),
                (e.name === g(y.STYLE_RANGE) && 'phantomBars' === m) || x.appendTo(S)
              var B = $('<td' + (o.valueColspan ? ' colspan = "' + o.valueColspan + '"' : '') + '/>')
              B.appendTo(S)
              var P = null
              if (_.options) {
                P = $("<select id='" + k + "' />")
                for (var R = 0; R < _.options.length; R++) {
                  var E = _.options[R]
                  $("<option value='" + E + "'>" + $.t(E) + '</option>').appendTo(P)
                }
              } else {
              ...
              P.appendTo(B),
                (e.name === g(y.STYLE_RANGE) && 'phantomBars' === m) || P.css('width', '100px'),
                e.name === g(y.STYLE_RANGE) && 'phantomBars' === m && x.appendTo(S)
              var D,
                I = 'Change ' + v
              if (_.options) this.bindControl(new h(P, i.inputs[m], null, !0, this.model(), I))
              else if ('integer' === _.type)
                (D = [s(_.defval)]),
                  _.min && D.push(r(_.min)),
                  _.max && D.push(l(_.max)),
                  this.bindControl(new p(P, i.inputs[m], D, !1, this.model(), I)),
                  P.addClass('ticker')
              else if ('float' === _.type) {
                if (((D = [d(_.defval)]), _.min)) {
                  var W
                  if (
                    ((e.id === g(y.STYLE_RENKO) || e.id === g(y.STYLE_PNF)) && 'boxSize' === _.id) ||
                ...
                'text' === _.type
                  ? this.bindControl(new p(P, this._property.inputs[m], null, !1, this.model(), I))
                  : 'bool' === _.type && this.bindControl(new b(P, i.inputs[m], !0, this.model(), I))
              P.change(c), (n[_.id] = S)
            }
          }
        ...
        (_.prototype.getMetaInfo = function (e) {
          for (var t = this._model.m_model._studiesMetaData, i = 0; i < t.length; i++) if (t[i].id === e) return t[i]
          return null
        }),
        ...
        (_.prototype._prepareSeriesStyleLayout = function (e, t, i, n) {
          var a = $('<tbody>').appendTo(e),
            ...
            S = null
          this._isHiLoChartsAvailable() && (S = this._hiloTbody = $('<tbody>').appendTo(i))
          var k,
          ...
          if (this._isShowStyleSwitcher()) {
            ...
            P.addClass('property-wide-select'),
              ...
              $('<option value=' + y.STYLE_BARS + '>' + $.t('Bars') + '</option>').appendTo(k),
              $('<option value=' + y.STYLE_CANDLES + '>' + $.t('Candles') + '</option>').appendTo(k),
              $('<option value=' + y.STYLE_HOLLOW_CANDLES + '>' + $.t('Hollow Candles') + '</option>').appendTo(k),
              this._isJapaneseChartsAvailable() &&
                $('<option value=' + y.STYLE_HEIKEN_ASHI + '>' + $.t('Heikin Ashi') + '</option>').appendTo(k),
              $('<option value=' + y.STYLE_LINE + '>' + $.t('Line') + '</option>').appendTo(k),
              $('<option value=' + y.STYLE_AREA + '>' + $.t('Area') + '</option>').appendTo(k),
              $('<option value=' + y.STYLE_BASELINE + '>' + $.t('Baseline') + '</option>').appendTo(k),
              this._isHiLoChartsAvailable() &&
                $('<option value=' + y.STYLE_HILO + '>' + $.t('High-Low') + '</option>').appendTo(k),
              k.css('width', '100px').appendTo(P),
              this.switchStyle(),
              this.bindControl(new h(k, n.style, parseInt, !0, this.model(), 'Change Series Style'))
          }
          ...
          var R = this.createColorPicker(),
            ...
            V = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(I).add(W)),
            O = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(F).add(D)),
          ...
          $('<td>').append(A).prependTo(M), $('<td>').append(R).appendTo(M), $('<td>').append(E).appendTo(M)
          M = this.addLabeledRow(T, 'Borders', V)
          $('<td>').append(V).prependTo(M), $('<td>').append(I).appendTo(M), $('<td>').append(W).appendTo(M)
          M = this.addLabeledRow(T, 'Wick', O)
          $('<td>').append(O).prependTo(M),
            $('<td>').append(F).appendTo(M),
            $('<td>').append(D).appendTo(M),
            this.bindControl(new c(R, n.candleStyle.upColor, !0, this.model(), 'Change Candle Up Color')),
            this.bindControl(new c(E, n.candleStyle.downColor, !0, this.model(), 'Change Candle Down Color')),
            this.bindControl(new b(O, n.candleStyle.drawWick, !0, this.model(), 'Change Candle Wick Visibility')),
            this.bindControl(new c(F, n.candleStyle.wickUpColor, !0, this.model(), 'Change Candle Wick Up Color')),
            this.bindControl(new c(D, n.candleStyle.wickDownColor, !0, this.model(), 'Change Candle Wick Down Color')),
            this.bindControl(new b(A, n.candleStyle.drawBody, !0, this.model(), 'Change Candle Body Visibility')),
            this.bindControl(new b(V, n.candleStyle.drawBorder, !0, this.model(), 'Change Candle Border Visibility')),
            this.bindControl(new c(I, n.candleStyle.borderUpColor, !0, this.model(), 'Change Candle Up Border Color')),
            this.bindControl(
              new c(W, n.candleStyle.borderDownColor, !0, this.model(), 'Change Candle Down Border Color')
            ),
            this.bindControl(
              new b(
                z,
          ...
          var Y = this.createColorPicker(),
            ...
            U = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(Y).add(q)),
            K = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(G).add(j)),
            Q = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(H).add(N))
          M = this.addLabeledRow(v, 'Bodies', U)
          $('<td>').append(U).prependTo(M), $('<td>').append(Y).appendTo(M), $('<td>').append(q).appendTo(M)
          M = this.addLabeledRow(v, 'Borders', K)
          $('<td>').append(K).prependTo(M), $('<td>').append(G).appendTo(M), $('<td>').append(j).appendTo(M)
          M = this.addLabeledRow(v, 'Wick', Q)
          $('<td>').append(Q).prependTo(M),
            $('<td>').append(H).appendTo(M),
            $('<td>').append(N).appendTo(M),
            this.bindControl(new c(Y, n.hollowCandleStyle.upColor, !0, this.model(), 'Change Hollow Candle Up Color')),
            this.bindControl(
              new c(q, n.hollowCandleStyle.downColor, !0, this.model(), 'Change Hollow Candle Down Color')
            ),
            this.bindControl(
              new b(Q, n.hollowCandleStyle.drawWick, !0, this.model(), 'Change Hollow Candle Wick Visibility')
            ),
            this.bindControl(
              new c(H, n.hollowCandleStyle.wickUpColor, !0, this.model(), 'Change Hollow Candle Wick Up Color')
            ),
            this.bindControl(
              new c(N, n.hollowCandleStyle.wickDownColor, !0, this.model(), 'Change Hollow Candle Down Wick Color')
            ),
            this.bindControl(
              new b(U, n.hollowCandleStyle.drawBody, !0, this.model(), 'Change Hollow Candle Body Visibility')
            ),
            this.bindControl(
              new b(K, n.hollowCandleStyle.drawBorder, !0, this.model(), 'Change Hollow Candle Border Visibility')
            ),
            this.bindControl(
              new c(G, n.hollowCandleStyle.borderUpColor, !0, this.model(), 'Change Hollow Candle Up Border Color')
            ),
            this.bindControl(
              new c(j, n.hollowCandleStyle.borderDownColor, !0, this.model(), 'Change Hollow Candle Down Border Color')
            )
          ...
          if (
            (this.bindControl(new c(J, n.barStyle.upColor, !0, this.model(), 'Change Bar Up Color')),
            this.bindControl(new c(ee, n.barStyle.downColor, !0, this.model(), 'Change Bar Down Color')),
            this.bindControl(
              new b(Z, n.barStyle.barColorsOnPrevClose, !0, this.model(), 'Change Color Bars Based on Previous Close')
            ),
            this.bindControl(new b(X, n.barStyle.dontDrawOpen, !0, this.model(), 'Change HLC Bars')),
            this.bindControl(new b(te, n.barStyle.thinBars, !0, this.model(), 'Change Thin Bars')),
            n.hiloStyle)
          ) {
            var ie = this.createColorPicker(),
              oe = this.createColorPicker(),
              ne = this.createColorPicker(),
              ae = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(oe)),
              re = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(ne))
            ...
            $('<td>').append(re).prependTo(M),
              ...
              this.bindControl(new c(ie, n.hiloStyle.color, !0, this.model(), 'Change High-Low Bodies Color')),
              this.bindControl(new b(ae, n.hiloStyle.showBorders, !0, this.model(), 'Change Show High-Low Borders')),
              this.bindControl(new c(oe, n.hiloStyle.borderColor, !0, this.model(), 'Change High-Low Border Color')),
              this.bindControl(new b(re, n.hiloStyle.showLabels, !0, this.model(), 'Change Show High-Low Labels')),
              this.bindControl(new c(ne, n.hiloStyle.labelColor, !0, this.model(), 'Change High-Low Labels Color')),
              this.bindControl(
                new h(le, n.hiloStyle.fontSize, parseInt, !0, this.model(), 'Change High-Low Labels Font Size')
              )
          }
          var se = w()
          ...
          $('<option value=' + y.STYLE_LINE_TYPE_SIMPLE + '>' + $.t('Simple') + '</option>').appendTo(he),
            $('<option value=' + y.STYLE_LINE_TYPE_MARKERS + '>' + $.t('With Markers') + '</option>').appendTo(he),
            $('<option value=' + y.STYLE_LINE_TYPE_STEP + '>' + $.t('Step') + '</option>').appendTo(he),
            he.appendTo(pe)
          ...
          if (
            ...
            this.bindControl(new h(se, n.lineStyle.priceSource, null, !0, this.model(), 'Change Price Source')),
            this.bindControl(new h(he, n.lineStyle.styleType, parseInt, !0, this.model(), 'Change Line Type')),
            this.bindControl(new c(ce, n.lineStyle.color, !0, this.model(), 'Change Line Color')),
            this.bindControl(new u(be, n.lineStyle.linewidth, !0, this.model(), 'Change Line Width')),
            n.haStyle)
          ) {
            var ue = this.createColorPicker(),
              ...
              $e = this.createColorPicker(),
              Te = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(we).add($e)),
              ve = $("<input type='checkbox' class='visibility-switch'/>").data('hides', $(ye).add(ge)),
              _e = $("<input type='checkbox'/>")
            M = this.addLabeledRow(g, $.t('Color Bars Based on Previous Close'), _e)
            $('<td>').append(_e).prependTo(M)
            M = this.addLabeledRow(_, $.t('Candles'))
            $('<td>').prependTo(M), $('<td>').append(ue).appendTo(M), $('<td>').append(Ce).appendTo(M)
            M = this.addLabeledRow(_, $.t('Borders'), Te)
            $('<td>').append(Te).prependTo(M), $('<td>').append(we).appendTo(M), $('<td>').append($e).appendTo(M)
            M = this.addLabeledRow(_, $.t('Wick'), ve)
            $('<td>').append(ve).prependTo(M),
              $('<td>').append(ye).appendTo(M),
              $('<td>').append(ge).appendTo(M),
              this.bindControl(new c(ue, n.haStyle.upColor, !0, this.model(), 'Change Heikin Ashi Up Color')),
              this.bindControl(new c(Ce, n.haStyle.downColor, !0, this.model(), 'Change Heikin Ashi Down Color')),
              this.bindControl(new b(ve, n.haStyle.drawWick, !0, this.model(), 'Change Heikin Ashi Wick Visibility')),
              this.bindControl(new c(ye, n.haStyle.wickUpColor, !0, this.model(), 'Change Heikin Ashi Wick Up Color')),
              this.bindControl(
                new c(ge, n.haStyle.wickDownColor, !0, this.model(), 'Change Heikin Ashi Wick Down Color')
              ),
              this.bindControl(
                new b(Te, n.haStyle.drawBorder, !0, this.model(), 'Change Heikin Ashi Border Visibility')
              ),
              this.bindControl(
                new c(we, n.haStyle.borderUpColor, !0, this.model(), 'Change Heikin Ashi Up Border Color')
              ),
              this.bindControl(
                new c($e, n.haStyle.borderDownColor, !0, this.model(), 'Change Heikin Ashi Down Border Color')
              ),
              this.bindControl(
                new b(_e, n.haStyle.barColorsOnPrevClose, !0, this.model(), 'Change Color Bars Based on Previous Close')
              )
          }
          this._isJapaneseChartsAvailable() && o.enabled('japanese_chart_styles')
          var me = w()
          ...
          $('<td>').appendTo(M).append(fe), $('<td colspan="2">').appendTo(M).append(Le)
          ...
          $('<td>').appendTo(M).append(Se),
            ...
            this.bindControl(new h(me, n.areaStyle.priceSource, null, !0, this.model(), 'Change Price Source')),
            this.bindControl(new c(fe, n.areaStyle.linecolor, !0, this.model(), 'Change Line Color')),
            this.bindControl(new u(Le, n.areaStyle.linewidth, !0, this.model(), 'Change Line Width')),
            this.bindControl(
              new c(Se, n.areaStyle.color1, !0, this.model(), 'Change Line Color', n.areaStyle.transparency)
            ),
            this.bindControl(
              new c(ke, n.areaStyle.color2, !0, this.model(), 'Change Line Color', n.areaStyle.transparency)
            )
          var xe = w()
          M = this.addLabeledRow(x, window.t('Price Source'))
          $('<td colspan="3">').appendTo(M).append(xe),
            this.bindControl(new h(xe, n.baselineStyle.priceSource, null, !0, this.model(), 'Change Price Source'))
          ...
          $('<td>').appendTo(M).append(Be),
            ...
            this.bindControl(new c(Be, n.baselineStyle.topLineColor, !0, this.model(), 'Change Top Line Color')),
            this.bindControl(new u(Pe, n.baselineStyle.topLineWidth, !0, this.model(), 'Change Top Line Width'))
          ...
          $('<td>').appendTo(M).append(Re),
            ...
            this.bindControl(new c(Re, n.baselineStyle.bottomLineColor, !0, this.model(), 'Change Bottom Line Color')),
            this.bindControl(new u(Ee, n.baselineStyle.bottomLineWidth, !0, this.model(), 'Change Bottom Line Width'))
          var Fe = this.createColorPicker(),
          ...
          $('<td>').appendTo(M).append(Fe),
            ...
            this.bindControl(
              new c(Fe, n.baselineStyle.topFillColor1, !0, this.model(), 'Change Fill Top Area Color 1'),
              n.baselineStyle.transparency
            ),
            this.bindControl(
              new c(De, n.baselineStyle.topFillColor2, !0, this.model(), 'Change Fill Top Area Color 2'),
              n.baselineStyle.transparency
            )
          var Ie = this.createColorPicker(),
            We = this.createColorPicker()
          ...
          $('<td>').appendTo(M).append(Ie),
            ...
            this.bindControl(
              new c(Ie, n.baselineStyle.bottomFillColor1, !0, this.model(), 'Change Fill Bottom Area Color 1'),
              n.baselineStyle.transparency
            ),
            this.bindControl(
              new c(We, n.baselineStyle.bottomFillColor2, !0, this.model(), 'Change Fill Bottom Area Color 2'),
              n.baselineStyle.transparency
            )
          ...
          var Ve = [s(n.baselineStyle.baseLevelPercentage.value()), l(100), r(0)]
          this.bindControl(new p(Ae, n.baselineStyle.baseLevelPercentage, Ve, !0, this.model(), 'Change Base Level'))
        }),
        (_.prototype._addThinBarsEditorRow = function (e) {
          ...
          return (
            ...
            t.change(function () {
              t.is(':checked') ? v('GUI', 'Style', 'Enable thin bars') : v('GUI', 'Style', 'Disable thin bars')
            }),
            t
          )
        }),
    ...
    '11dv': function (e, t, i) {
      ...
      ;(function (t) {
        ...
        var o = i('04K5'),
          ...
          C = a.DisabledBinder,
          y = (a.CheckboxWVBinding, a.ToFloatTransformerWithDynamicDefaultValue),
        ...
        inherit(R, o),
          (R.prototype.setScalesOpenTab = function () {
            this.scalesTab && this.scalesTab.data('layout-tab-open', n.TabOpenFrom.Override)
          }),
          (R.prototype._isAlertControlsShouldBeShown = function () {
            return !S('hide-alert-controls-on-property-page') && t.enabled('alerts')
          }),
          (R.prototype.setTmzOpenTab = function () {
            this.tmzSessTable && this.tmzSessTable.data('layout-tab-open', n.TabOpenFrom.Override)
          }),
          (R.prototype.prepareLayout = function () {
            ...
            if (t.enabled('chart_property_page_style')) {
              ;(e = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                ...
                (this._priceLineTable = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                  'layout-tab',
                  n.TabNames.style
                )),
              ...
              $('<td>').append(B).prependTo(P),
                ...
                this.bindControl(
                  new h(B, this._seriesProperty.showPriceLine, !0, this.model(), 'Change Price Price Line')
                )
              var R = $('<input type="checkbox">'),
                E = this.addLabeledRow(a, window.t('Show Label on Price Scale'), R)
              ...
              $(
                ...
                $('<td colspan="2">').css('width', '370px').append(F).appendTo(E),
                this.bindControl(
                  new u(
                    F,
              ...
              this.bindControl(
                new b(D, this._seriesProperty.priceLineColor, !0, this.model(), 'Change Price Line Color')
              )
              var I = this.createLineWidthEditor()
              $('<td>').append(I).appendTo(P),
                this.bindControl(
                  new c(I, this._seriesProperty.priceLineWidth, !0, this.model(), 'Change Price Line Width')
                ),
                (C = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                  'layout-tab',
                  n.TabNames.style
                ))
            }
            if (t.enabled('chart_property_page_scales')) {
              var W = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                'layout-tab',
                n.TabNames.scales
              )
              ;(this._scaleBindings.autoScale = {}),
                (this._scaleBindings.autoScaleDisabled = {}),
                (this._scaleBindings.autoScale.control = $('<input type="checkbox">').change(function () {
                  this.checked &&
                    setTimeout(function () {
              ...
              $('<td>').append(this._scaleBindings.autoScale.control).prependTo(A),
                (this._scaleBindings.lockScale = {}),
                (this._scaleBindings.lockScale.control = $("<input type='checkbox'/>"))
              var V = this.addLabeledRow(W, window.t('Lock'), this._scaleBindings.lockScale.control)
              $('<td>').append(this._scaleBindings.lockScale.control).prependTo(V)
              this._seriesProperty.style.listeners().subscribe(this, function (e) {
              ...
              var O = this.addLabeledRow(W, window.t('Percent'), this._scaleBindings.percentage.control)
              $('<td>').append(this._scaleBindings.percentage.control).prependTo(O),
              ...
              var z = this.addLabeledRow(W, window.t('Indexed to 100'), this._scaleBindings.indexedTo100.control)
              $('<td>').append(this._scaleBindings.indexedTo100.control).prependTo(z),
                (this._scaleBindings.log = {}),
                (this._scaleBindings.logDisabled = {}),
                (this._scaleBindings.log.control = $('<input type="checkbox">'))
              var M = this.addLabeledRow(W, window.t('Logarithmic'), this._scaleBindings.log.control)
              ...
              $('<td>').append(Y).prependTo(q),
                this.bindControl(
                  new h(Y, this._property.scalesProperties.scaleSeriesOnly, !0, this.model(), 'Scale Series Only')
                ),
                (this._scaleBindings.invertScale = {})
              var H = $("<input type='checkbox'/>")
              this._scaleBindings.invertScale.control = H
              var N = this.addLabeledRow(W, window.t('Invert Scale'), this._scaleBindings.invertScale.control)
              H.change(function () {
                k('GUI', 'Scales', 'Invert Scale')
              }),
                $('<td>').append(this._scaleBindings.invertScale.control).prependTo(N)
              var G = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                  'layout-tab',
                  n.TabNames.scales
                ),
                j = $('<input type="text" class="ticker ticker--longer-sign_8">'),
              ...
              K.push(s(25)),
                K.push(l(0)),
                this.bindControl(new p(j, this._property.paneProperties.topMargin, K, !0, this.model(), 'Top Margin'))
              var Q = $('<input type="text" class="ticker ticker--longer-sign_8">'),
              ...
              if (
                ...
                X.push(l(0)),
                this.bindControl(
                  new p(Q, this._property.paneProperties.bottomMargin, X, !0, this.model(), 'Bottom Margin')
                ),
                t.enabled('chart_property_page_right_margin_editor'))
              ) {
                var J = $('<input type="text" class="ticker ticker--longer-sign_8">'),
                  ee = this.addLabeledRow(G, window.t('Right Margin'), J)
                $('<td>').appendTo(ee).append(J),
                  $('<td>' + window.t('bars', { context: 'margin' }) + '</td>').appendTo(ee)
                var te = this._chart.timeScale(),
                  ie = [d(te.defaultRightOffsetProperty().value())]
                ie.push(s(~~te.maxRightOffset())),
                  ie.push(l(0)),
                  this.bindControl(new p(J, te.defaultRightOffsetProperty(), ie, !0, this.model(), 'Right Margin'))
              }
              var oe = $('<input type="text" class="ticker ticker--longer-sign_8">'),
                ne = ((ee = this.addLabeledRow(G, window.t('Price/Bar Ratio'), oe)), !0)
              ...
              var ae = g('', 7),
                re = [
                  y(this._mainSeriesScaleRatioProperty.value.bind(this._mainSeriesScaleRatioProperty)),
                  l(this._mainSeriesScaleRatioProperty.getMinValue()),
                  s(this._mainSeriesScaleRatioProperty.getMaxValue()),
                  ae
                ],
                le = new p(oe, this._mainSeriesScaleRatioProperty, re, !1, this.model(), 'Price/Bar Ratio', function (
                  e
                ) {
                  this._undoModel.setScaleRatioProperty(this._property, e, this._undoText),
                    ne && (k('GUI', 'Scales', 'Edit scale ratio value'), (ne = !1))
                })
              le.addFormatter(ae), this.bindControl(le)
              var se = $('<table class="property-page" cellspacing="0" cellpadding="2" width="100%">').data(
                'layout-tab',
                n.TabNames.scales
              )
              if (t.enabled('countdown')) {
                var de = $("<input type='checkbox'>"),
                  pe = this.addLabeledRow(se, window.t('Countdown To Bar Close'), de)
                $('<td>').append(de).prependTo(pe),
                  this.bindControl(
                    new h(de, this._seriesProperty.showCountdown, !0, this.model(), 'Change Show Countdown')
                  )
              }
              var he = $('<input type="checkbox">'),
                ce = this.addLabeledRow(se, window.t('Indicator Last Value'), he)
              ...
              $('<td>').append(be).prependTo(ue),
                this.bindControl(
                  new h(be, this._property.scalesProperties.showSymbolLabels, !0, this.model(), 'Show Symbol Labels')
                )
              var Ce = $('<input type="checkbox">'),
                ye = this.addLabeledRow(se, window.t('Indicator Name Label'), Ce)
              ...
              $('<td>').append(this._scaleBindings.alignLabels.control).prependTo(ge), this._bindScaleProperties()
              var we = $('<div class="property-page-column-2">').append(W).append(G),
                $e = $('<div class="property-page-column-2">').append(se)
              ;(m = $('<div>').css('min-width', '620px').data('layout-tab', n.TabNames.scales)).append(we).append($e),
                (this.scalesTab = m),
              ...
              var Te = $('<tr>')
              $('<td>' + window.t('Price Scales Placement') + '</td>').appendTo(Te), r.append(Te)
              ...
              r.append(_e).appendTo(Le),
                this.bindControl(
                  new u(me, this._seriesProperty.minTick, null, !0, this.model(), 'Change Decimal Places')
                )
            }
            if (t.enabled('chart_property_page_background')) {
              var Se = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
              ...
              $('<td colspan="2">').append(ke).appendTo(xe),
                this.bindControl(
                  new b(ke, this._property.paneProperties.background, !0, this.model(), 'Change Chart Background Color')
                )
              ...
              $('<td>').append(Ie).appendTo(We),
                this.bindControl(
                  new b(Ie, this._property.scalesProperties.textColor, !0, this.model(), 'Change Scales Text Color')
                )
              ...
              $('<td colspan="2">').append(Ve).appendTo(Oe),
                this.bindControl(
                  new b(Ve, this._property.scalesProperties.lineColor, !0, this.model(), 'Change Scales Lines Color')
                )
              ...
              $('<td>').append(qe).appendTo(this.addRow(Se).prepend('<td/><td/>')),
                this.bindControl(
                  new c(
                    qe,
              ...
              if (null !== He) {
                ...
                Ge.prependTo(je.find('td')),
                  this.bindControl(new h(Ge, Ne.visibility, !0, this.model(), 'Change Symbol Watermark Visibility'))
                var Ue = this.createColorPicker()
                $('<td colspan="2">').append(Ue).appendTo(je),
                  this.bindControl(new b(Ue, Ne.color, !0, this.model(), 'Change Symbol Watermark Color'))
              }
              var Ke = $('<table class="property-page">'),
                Qe = this.addLabeledRow(Ke, window.t('Navigation Buttons'), null, !0),
                Ze = $(document.createElement('select'))
              L.availableValues().forEach(function (e) {
                $(document.createElement('option')).attr('value', e.value).text(e.title).appendTo(Ze)
              }),
                $('<td>').append(Ze).appendTo(Qe),
                this.bindControl(
                  new u(Ze, L.property(), null, !0, this.model(), 'Change Navigation Buttons Visibility')
                )
              var Xe = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
              ...
              it.forEach(function (e) {
                $(document.createElement('option')).attr('value', e.value).text(e.title).appendTo(tt)
              }),
                this.bindControl(
                  new u(
                    tt,
                ...
                et.find('td').eq(1).append($('<span>').css('margin-left', '30px').append(tt))
              ...
              var dt = $('<input type="checkbox">'),
                pt = this.addLabeledRow(Xe, window.t('Indicator Arguments'), dt),
                ht = function (e) {
              ...
              $('<td>').append(dt).prependTo(pt),
                ...
                this._property.paneProperties.legendProperties.showStudyTitles.listeners().subscribe(this, ht),
                ht(this._property.paneProperties.legendProperties.showStudyTitles)
              ...
              ;(f = $('<div>').css('min-width', '620px').data('layout-tab', n.TabNames.background))
                .append(ut)
                .append(Ct)
                .append(yt)
            }
            if (t.enabled('chart_property_page_timezone_sessions')) {
              var gt = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                'layout-tab',
                n.TabNames.timezoneSessions
              )
              this.tmzSessTable = gt
              ee = $('<tr>').appendTo(gt)
              var wt = $('<td>').appendTo(ee),
                $t = $('<table cellspacing="0" cellpadding="0">').appendTo(wt)
              this.addTimezoneEditorRow($t), this.addTateFormatEditorRow($t), this.createSessTable(gt)
            }
            ;(t.enabled('trading_options') || t.enabled('chart_property_page_trading')) &&
              (S = this.createTradingTable())
            var Tt = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
              vt = $('<table class="property-page property-page-unpadded" cellspacing="0" cellpadding="0">')
                .css({ width: '100%' })
                .data('layout-separated', !0),
              _t = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                'layout-tab',
                n.TabNames.drawings
              )
            ;(this._table = $()
          ...
          (R.prototype._bindScaleProperties = function () {
            ...
            ;(this._scaleBindings.autoScale.binder = new h(
              ...
              'Auto Scale',
              function (i) {
                ;(e = { autoScale: i }), this._undoModel.setPriceScaleMode(e, t._series.priceScale(), this._undoText)
              }
            )),
            ...
            ;(this._scaleBindings.percentage.binder = new h(
              ...
              'Scale Percentage',
              function (i) {
                ;(e = { percentage: i }), this._undoModel.setPriceScaleMode(e, t._series.priceScale(), this._undoText)
              }
            )),
            ...
            ;(this._scaleBindings.indexedTo100.binder = new h(
              ...
              function (i) {
                ;(e = { indexedTo100: i }), this._undoModel.setPriceScaleMode(e, t._series.priceScale(), this._undoText)
              }
            )),
            ...
            ;(this._scaleBindings.log.binder = new h(
              ...
              'Log Scale',
              function (i) {
                ;(e = { log: i }), this._undoModel.setPriceScaleMode(e, t._series.priceScale(), this._undoText)
              }
            )),
            ...
            ;(this._scaleBindings.lockScale.binder = new h(
              ...
              'Change lock scale',
              function (i) {
                ;(e = { lockScale: i }), this._undoModel.setPriceScaleMode(e, t._series.priceScale(), this._undoText)
              }
            )),
          ...
          (R.prototype.createTemplateButton = function (e) {
            if (!t.enabled('chart_property_page_template_button')) return $('<span />')
            return (
              e || (e = {}),
              $('<a href="#" class="_tv-button">' + window.t('Template') + '<span class="icon-dropdown"></span></a>')
            )
          }),
          ...
          (R.prototype.switchStyle = function () {
            if (this._hasSeriesStyleLayout) {
              ...
              this._priceLineTable.css(
                'display',
                this._seriesProperty.style.value() === T.STYLE_HILO ? 'none' : 'table'
              )
            }
          }),
          (R.prototype.onResoreDefaults = function () {
            ...
            e.listeners().fire(e), t.listeners().fire(t), this._chart.timeScale().restoreRightOffsetPropertyToDefault()
          ...
          (R.prototype.createSessTable = function (e) {
            ...
            $('<td>').append(o).prependTo(n),
              ...
              this.bindControl(
                new h(o, t.vertlines.sessBreaks.visible, !0, this.model(), 'Change Sessions Breaks visibility')
              ),
              this.bindControl(new b(r, t.vertlines.sessBreaks.color, !0, this.model(), 'Change Session Breaks color')),
              this.bindControl(
                new u(a, t.vertlines.sessBreaks.style, parseInt, !0, this.model(), 'Change Session Breaks style')
              ),
              this.bindControl(new c(l, t.vertlines.sessBreaks.width, !0, this.model(), 'Change Session Breaks width'))
          ...
          (R.prototype.addTimezoneEditorRow = function (e) {
            ...
            r.appendTo(o),
              this.bindControl(new u(r, this._property.timezone, null, !0, this.model(), 'Change Timezone'))
          }),
          (R.prototype.addTateFormatEditorRow = function (e) {
            ...
            var o = $('<td colspan="2" class="tzeditor">')
            o.appendTo(t)
            for (var n = '', a = new Date(Date.UTC(1997, 8, 29)), r = 0; r < x.length; r++) {
              var l = new P(x[r])
          ...
          (R.prototype._createStudySessRow = function (e, t, i) {
            var o = $("<input type='checkbox' />"),
              ...
              a = v($('<td>').appendTo(n))
            return (
              this.bindControl(new h(o, i.visible, !0, this.model(), 'Change ' + t + ' visibility')),
              this.bindControl(new b(a, i.color, !0, this.model(), t + ' color', i.transparency)),
              $('<td>').append(o).prependTo(n),
          ...
          (R.prototype.createTradingTable = function () {
            var e = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
                'layout-tab',
                n.TabNames.trading
              ),
              t = $('<tr>').appendTo(e),
            ...
            ;(t = this.addLabeledRow(o, window.t('Show Orders'), r)),
              ...
              this.bindControl(
                new h(r, this._property.tradingProperties.showOrders, !0, this.model(), 'Change Orders Visibility')
              )
            var b = $('<input type="checkbox">'),
              C = this.addLabeledRow(o, window.t('Extend Lines Left'), b)
            $('<td>').append(b).prependTo(C),
              this.bindControl(
                new h(b, this._property.tradingProperties.extendLeft, !0, this.model(), 'Extend Lines Left')
              )
            var y = this.createLineWidthEditor()
            this.bindControl(
              new c(y, this._property.tradingProperties.lineWidth, !0, this.model(), 'Change Connecting Line Width')
            )
            var g = _()
            this.bindControl(
              new u(
            ...
            var w = $('<input type="text" class="ticker">'),
              T = [d(this._property.tradingProperties.lineLength.value()), s(100), l(0)]
            this.bindControl(
              new p(
                w,
    ...
    '1WFa': function (e, t, i) {
      ...
      inherit(d, o),
        (d.prototype.prepareLayout = function () {
          ...
          $('<td>').append(o).prependTo(n),
            this.bindControl(
              new r(i, this._linetool.properties().color, !0, this.model(), 'Change Elliott Label Color')
            ),
            this.bindControl(
              new a(t, this._linetool.properties().degree, parseInt, !0, this.model(), 'Change Elliott Wave Size')
            ),
            this.bindControl(
              new s(o, this._linetool.properties().showWave, !0, this.model(), 'Change Elliott Labels Background')
            ),
            this.bindControl(
              new l(d, this._linetool.properties().linewidth, parseInt, this.model(), 'Change Elliott Wave Line Width')
            ),
            this.loadData()
        }),
      ...
      inherit(p, n),
        (p.prototype.prepareLayout = function () {
          ...
          $('<td>').append(o).prependTo(p),
            ...
            this.bindControl(new a(i, this._study.properties().font, null, !0, this.model(), 'Change Pivots Font')),
            this.bindControl(
              new a(t, this._study.properties().fontsize, parseInt, !0, this.model(), 'Change Pivots Font Size')
            ),
            this.bindControl(new r(o, this._property.levelsStyle.showLabels, !0, e.model(), 'Show Pivot Labels'))
          ...
          !(function (e, t, i, o) {
            ...
            $('<td>').append(p).appendTo(d), e.bindControl(new s(p, i, !0, e.model(), 'Change ' + n + ' color'))
            var c = e.createLineWidthEditor()
            $('<td>').append(c).appendTo(d),
              e.bindControl(new l(c, o, !0, e.model(), 'Change ' + n + ' width')),
        ...
        (p.prototype.lockNotUsedVisEditors = function (e) {
          for (var t = 0; t < this._rows.length; t++) {
            ...
            i.visibilityEditor.prop('disabled', !n), i.row.css('opacity', n ? 1 : 0.5)
          }
        }),
        (p.prototype.widget = function () {
          return this._table
      ...
      inherit(b, o),
        ...
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          if ((o.appendTo(this._table), e)) {
            ...
            u.appendTo(b),
              u.css('width', '70px'),
              this.bindControl(new a(c, t.visible, !0, this.model(), 'Change Pitchfork Line Visibility')),
              this.bindControl(new r(u, t.coeff, !1, this.model(), 'Change Pitchfork Line Coeff'))
          } else $('<td></td>').appendTo(o), $('<td>' + $.t('Median') + '</td>').appendTo(o)
          ...
          v.render().appendTo(T),
            ...
            this.bindControl(new s(v, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfork Line Style')),
        ...
        (b.prototype.prepareLayout = function () {
          ...
          this.addOneColorPropertyWidget(this._table), (n = $('<tr>')).appendTo(this._table)
          var i = $("<input type='checkbox' class='visibility-switch'>")
          $('<td>').append(i).appendTo(n), this.createLabeledCell('Background', i).appendTo(n)
          var o = c()
          ...
          ;(n = $('<tr>')).appendTo(this._table),
            ...
            $('<td>').append(r).appendTo(n),
            this.bindControl(
              new s(r, this._linetool.properties().style, parseInt, !0, this.model(), 'Change Pitchfork Style')
            ),
            this.bindControl(
              new a(
                i,
      ...
      inherit(s, o),
        (s.prototype.prepareLayout = function () {
          ...
          $('<td>').append(i).prependTo(n),
            ...
            this.bindControl(
              new a(i, this._linetool.properties().fillBackground, !0, this.model(), 'Change Triangle Filling')
            ),
            this.bindControl(
              new r(t, this._linetool.properties().color, !0, this.model(), 'Change Triangle Line Color')
            ),
            this.bindControl(
              new r(
                o,
            ...
            this.bindControl(
              new l(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Triangle Border Width')
            ),
            this.loadData()
        }),
      ...
      inherit(p, o),
        (p.prototype.prepareLayout = function () {
          ...
          var p = this.createColorPicker(),
            ...
            b = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-bold"></span></span>'),
            u = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-italic"></span></span>')
          ...
          var C = $('<tbody>').appendTo(this._table),
            ...
            g = this.createColorPicker(),
            w = ((n = this.addLabeledRow(C, $.t('Background'), y)), $('<table>'))
          ...
          $("<td colspan='2'>").append(B).appendTo(n),
            this.bindControl(
              new a(h, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new a(c, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new r(p, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color')),
            this.bindControl(new l(b, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new l(u, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic')),
            this.bindControl(
              new l(x, this._linetool.properties().showPrices, !0, this.model(), 'Change Disjoint Angle Show Prices')
            ),
            this.bindControl(
              new l(_, this._linetool.properties().extendLeft, !0, this.model(), 'Change Disjoint Angle Extending Left')
            ),
            this.bindControl(
              new l(
                f,
            ...
            this.bindControl(
              new r(o, this._linetool.properties().linecolor, !0, this.model(), 'Change Disjoint Angle Color')
            ),
            this.bindControl(
              new a(i, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Disjoint Angle Style')
            ),
            this.bindControl(
            ...
            this.bindControl(
              new l(y, this._linetool.properties().fillBackground, !0, this.model(), 'Change Disjoint Angle Filling')
            ),
            this.bindControl(
              new r(
                g,
    ...
    '68pv': function (e, t, i) {
      ...
      inherit(l, o),
        (l.prototype.prepareLayout = function () {
          ...
          $('<td>').append(o).appendTo(n),
            this.bindControl(new r(e, this._linetool.properties().color, !0, this.model(), 'Change Price Text Color')),
            this.bindControl(
              new a(t, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Price Text Font Size')
            ),
            this.bindControl(
              new r(
                i,
            ...
            this.bindControl(
              new r(o, this._linetool.properties().borderColor, !0, this.model(), 'Change Border Color')
            ),
            this.loadData()
        }),
    ...
    '68yv': function (e, t, i) {
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          h.appendTo(d),
            h.css('width', '70px'),
            this.bindControl(new a(s, i.visible, !0, this.model(), 'Change Gann Square Line Visibility')),
            this.bindControl(new l(h, i.coeff, !1, this.model(), 'Change Pitchfork Line Coeff'))
          var c = $("<td class='colorpicker-cell'>")
          c.appendTo(o)
          var b = p(c)
          this.bindControl(new r(b, i.color, !0, this.model(), 'Change Gann Square Line Color', 0))
        }),
        (b.prototype.prepareLayout = function () {
          ;(this._table = $(document.createElement('table'))),
          ...
          l.appendTo(o),
            ...
            $("<tr><td align='center' colspan='4'>" + $.t('Time Levels') + '</td></tr>').appendTo(l)
          for (var p = 1; p <= 7; p++) {
            var b = 'hlevel' + p
          ...
          var u = $("<input type='checkbox' class='visibility-switch'>"),
            ...
            T = $('<tr>').appendTo(w),
            v = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo(
              $('<td>').css({ width: '50%' }).appendTo(T)
            ),
          ...
          var f = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
            L = this.createLineWidthEditor(),
            S = h(),
          ...
          $('<td>').append(x).prependTo(m),
            ...
            (m = $('<tr>')).appendTo(f)
          x = $("<input type='checkbox' class='visibility-switch'>")
          $('<td>').append(x).appendTo(m), this.createLabeledCell('Background', x).appendTo(m)
          var B = c()
      ...
      inherit(c, o),
        (c.prototype.addLevelEditor = function (e, t, i, o) {
          ...
          var h = 'control-level-' + i + '-' + o,
            c = $('<td>')
          c.appendTo(n)
          var b = $("<input type='checkbox' class='visibility-switch' id='" + h + "'>")
          b.appendTo(c), this.createLabeledCell(e).appendTo(n).find('label').attr('for', h)
          ...
          var T = p()
          T.render().appendTo(w),
            this.bindControl(new a(b, t.visible, !0, this.model(), 'Change Gann Fan Line Visibility')),
            this.bindControl(new r(C, t.color, !0, this.model(), 'Change Gann Fan Line Color', 0)),
            this.bindControl(new l(T, t.linestyle, parseInt, !0, this.model(), 'Change Gann Fan Line Style')),
            this.bindControl(new s(g, t.linewidth, !0, this.model(), 'Change Gann Fan Line Width'))
        }),
        (c.prototype.prepareLayout = function () {
          var e = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
          ...
          $('<td>').append(p).prependTo(c),
            this.bindControl(
              new a(p, this._linetool.properties().showLabels, !0, this.model(), 'Change Gann Fan Labels Visibility')
            ),
            (this._table = e.add(t)),
            (c = $('<tr>')).appendTo(this._table)
          var b = $("<input type='checkbox' class='visibility-switch'>")
          $('<td>').append(b).appendTo(c), this.createLabeledCell($.t('Background'), b).appendTo(c)
          var u = h()
    ...
    '8TiD': function (e, t, i) {
      ...
      inherit(p, o),
        (p.prototype.prepareLayout = function () {
          ...
          this.bindControl(
            new r(p, this._linetool.properties().linecolor, !0, this.model(), 'Change Time Cycles Color')
          ),
            this.bindControl(
              new a(
                n,
            ...
            this.bindControl(
              new l(o, this._linetool.properties().linewidth, !0, this.model(), 'Change Time Cycles Line Width')
            ),
            e &&
              (this.bindControl(
                new s(e, this._linetool.properties().fillBackground, !0, this.model(), 'Change Time Cycles Filling')
              ),
              this.bindControl(
                new r(
                  t,
    ...
    A3Hk: function (e, t, i) {
      ...
      function a() {
        var e = $('<select />')
        return (
          $('<option value="' + o.LeftToRight + '">' + $.t('Left') + '</option>').appendTo(e),
          $('<option value="' + o.RightToLeft + '">' + $.t('Right') + '</option>').appendTo(e),
          e
        )
      }
      !(function (e) {
      ...
      inherit(h, o),
        (h.prototype.addLevelEditor = function (e, t, i) {
          ...
          h.appendTo(p),
            h.css('width', '70px'),
            this.bindControl(new a(s, i.visible, !0, this.model(), 'Change Gann Square Line Visibility')),
            this.bindControl(new r(h, i.coeff, !1, this.model(), 'Change Pitchfork Line Coeff'))
          var c = $("<td class='colorpicker-cell'>")
          c.appendTo(o)
          var b = d(c)
          this.bindControl(new l(b, i.color, !0, this.model(), 'Change Gann Square Line Color', 0))
        }),
        (h.prototype.addFannEditor = function (e) {
          var t = $('<tr>').appendTo(e),
            i = $("<input type='checkbox' class='visibility-switch'>")
          i.appendTo($('<td>').appendTo(t)), $('<td>' + $.t('Angles') + '</td>').appendTo(t)
          var o = $("<td class='colorpicker-cell'>").appendTo(t),
            n = d(o)
          this.bindControl(
            new a(i, this._linetool.properties().fans.visible, !0, this.model(), 'Change Gann Square Angles Visibility')
          ),
            this.bindControl(
              new l(n, this._linetool.properties().fans.color, !0, this.model(), 'Change Gann Square Angles Color', 0)
            )
        }),
        (h.prototype.prepareLayout = function () {
          ;(this._table = $(document.createElement('table'))),
          ...
          r.appendTo(o),
            ...
            $("<tr><td align='center' colspan='4'>" + $.t('Price Levels') + '</td></tr>').appendTo(n),
            $("<tr><td align='center' colspan='4'>" + $.t('Time Levels') + '</td></tr>').appendTo(r)
          for (var l = 1; l <= 7; l++) {
            var d = 'hlevel' + l
            this.addLevelEditor(n, $.t('Level {0}').format(l), this._linetool.properties()[d])
          }
          for (l = 1; l <= 7; l++) {
            d = 'vlevel' + l
            this.addLevelEditor(r, $.t('Level {0}').format(l), this._linetool.properties()[d])
          }
          ...
          if (
            ...
            $('<td>').append(m).prependTo(T),
              this.bindControl(
                new a(m, this._linetool.properties().reverse, !0, this.model(), 'Change Gann Box Reverse')
              )
          }
          this.loadData()
        }),
      ...
      inherit(s, o),
        (s.prototype.prepareLayout = function () {
          ...
          $('<td>').append(i).prependTo(n),
            $('<td>').append(o).appendTo(n),
            this.bindControl(
              new a(i, this._linetool.properties().fillBackground, !0, this.model(), 'Change Polyline Filling')
            ),
            this.bindControl(
              new r(t, this._linetool.properties().linecolor, !0, this.model(), 'Change Polyline Line Color')
            ),
            this.bindControl(
              new r(
                o,
            ...
            this.bindControl(
              new l(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Polyline Border Width')
            ),
            this.loadData()
        }),
        (s.prototype.widget = function () {
    ...
    GjuB: function (e, t, i) {
      ...
      inherit(p, o),
        (p.prototype.prepareLayout = function () {
          ...
          var e = $('<table cellspacing="0" cellpadding="2">').appendTo(this._block),
            t = $('<tbody>').appendTo(e),
          ...
          var h = $('<table cellspacing="0" cellpadding="2">').appendTo(this._block),
            c =
          ...
          var u = $('<table cellspacing="0" cellpadding="2">').appendTo(this._block),
            C = $(
              "<select><option value='0'>" +
                $.t('Normal') +
                "</option><option value='1'>" +
          ...
          $('<td colspan="3">').appendTo(p).append(y).append(T),
            this.bindControl(
              new a(n, this._linetool.properties().linecolor, !0, this.model(), 'Change Curve Line Color')
            ),
            this.bindControl(
              new r(o, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Curve Line Style')
            ),
            this.bindControl(
              new l(i, this._linetool.properties().linewidth, !0, this.model(), 'Change Curve Line Width')
            ),
            this.bindControl(
              new s(c, this._linetool.properties().fillBackground, !0, this.model(), 'Change Curve Filling')
            ),
            this.bindControl(
              new a(
                b,
            ...
            this.bindControl(
              new r(C, this._linetool.properties().leftEnd, parseInt, !0, this.model(), 'Change Curve Line Left End')
            ),
            this.bindControl(
              new r(y, this._linetool.properties().rightEnd, parseInt, !0, this.model(), 'Change Curve Line Right End')
            ),
            this.bindControl(
              new s(w, this._linetool.properties().extendLeft, !0, this.model(), 'Change Curve Line Extending Left')
            ),
            this.bindControl(
              new s(v, this._linetool.properties().extendRight, !0, this.model(), 'Change Curve Line Extending Right')
            ),
            this.loadData()
        }),
        (p.prototype.widget = function () {
    ...
    ICcj: function (e, t, i) {
      ...
      inherit(l, a),
        ...
        (l.prototype._symbolInfoBySymbolProperty = n.prototype._symbolInfoBySymbolProperty),
        ...
        (l.prototype.prepareLayout = function () {
          ...
          for (var i = this._linetool.points(), o = 0; o < i.length; o++) {
            ...
            this.bindBarIndex(p.bar, d, this.model(), 'Change ' + this._linetool.title() + ' point bar index')
          }
          var h = this._model
            .model()
      ...
      inherit(h, o),
        (h.prototype.addLevelEditor = function (e, t, i) {
          ...
          if ((p.appendTo(n), e)) {
            ...
            c.appendTo(h),
              c.css('width', '70px'),
              this.bindControl(new a(c, t.coeff, !1, this.model(), 'Change Pitchfork Line Coeff'))
          ...
          var y = this.createLineWidthEditor()
          y.appendTo(C),
            this.bindControl(new r(p, t.visible, !0, this.model(), 'Change Fib Wedge Visibility')),
        ...
        (h.prototype.prepareLayout = function () {
          ...
          for (var e = 1; e <= 11; e++) {
            var t = 'level' + e
            this.addLevelEditor('Level ' + e, this._linetool.properties()[t], !1)
          }
          ...
          $('<td>').append(i).prependTo(o),
            this.bindControl(
              new r(i, this._linetool.properties().showCoeffs, !0, this.model(), 'Change Fib Wedge Levels Visibility')
            ),
            (o = $('<tr>')).appendTo(this._table)
          var n = $("<input type='checkbox' class='visibility-switch'>")
          $('<td>').append(n).appendTo(o), this.createLabeledCell('Background', n).appendTo(o)
          var a = p()
    ...
    IfF0: function (e, t, i) {
      ...
      inherit(d, o),
        (d.prototype.prepareLayout = function () {
          ...
          $('<td>').prependTo(o), $('<td>').append(i).appendTo(o), $('<td>').append(t).appendTo(o)
          var n = this.createColorPicker(),
            ...
            C = $('<input type="checkbox" class="visibility-switch">')
          this.bindControl(new r(n, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color')),
            this.bindControl(
              new a(p, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new a(h, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(
              new r(c, this._linetool.properties().labelBackgroundColor, !0, this.model(), 'Change Text Background')
            ),
            this.bindControl(
              new l(b, this._linetool.properties().fillLabelBackground, !0, this.model(), 'Change Text Background Fill')
            ),
            this.bindControl(
              new r(
                u,
            ...
            this.bindControl(
              new l(C, this._linetool.properties().fillBackground, !0, this.model(), 'Change Text Background Fill')
            ),
            this.bindControl(
              new r(d, this._linetool.properties().borderColor, !0, this.model(), 'Change Text Border Color')
            )
          ...
          $('<td>').append(b).prependTo(y),
            ...
            this.bindControl(
              new r(i, this._linetool.properties().linecolor, !0, this.model(), 'Change Date Range Color')
            ),
            this.bindControl(
          ...
          if (void 0 !== w.extendTop && void 0 !== w.extendBottom) {
            ...
            this.bindControl(new l(T, this._linetool.properties().extendTop, !0, this.model(), 'Change Extend Top')),
              this.bindControl(
                new l(v, this._linetool.properties().extendBottom, !0, this.model(), 'Change Extend Bottom')
              )
          ...
          if (void 0 !== w.extendLeft && void 0 !== w.extendRight) {
            ...
            this.bindControl(new l(f, this._linetool.properties().extendLeft, !0, this.model(), 'Change Extend Left')),
              this.bindControl(
                new l(L, this._linetool.properties().extendRight, !0, this.model(), 'Change Extend Right')
              )
      ...
      inherit(l, o),
        (l.prototype.prepareLayout = function () {
          ...
          $('<td>').append(n).appendTo(i),
            ...
            this.bindControl(
              new r(n, this._linetool.properties().trendline.color, !0, this.model(), 'Change Projection Line Color')
            ),
            this.bindControl(
              new r(
                e,
            ...
            this.bindControl(
              new a(o, this._linetool.properties().linewidth, !0, this.model(), 'Change Projection Border Width')
            ),
            this.loadData()
        }),
        (l.prototype.widget = function () {
      ...
      inherit(h, o),
        (h.prototype.prepareLayout = function () {
          ...
          $('<td>').append(a).appendTo(i),
            this.bindControl(
              new d(n, this._linetool.properties().mirrored, !0, this.model(), 'Change Bars Pattern Mirroring')
            ),
            this.bindControl(
              new d(a, this._linetool.properties().flipped, !0, this.model(), 'Change Bars Pattern Flipping')
            ),
            this.bindControl(
              new s(t, this._linetool.properties().color, !0, this.model(), 'Change Bars Pattern Color')
            ),
            this.bindControl(
              new l(o, this._linetool.properties().mode, null, !0, this.model(), 'Change Bars Pattern Mode')
            ),
            this.loadData()
        }),
        (h.prototype.widget = function () {
        ...
        (c.prototype.prepareLayout = function () {
          ...
          var s = this._linetool.properties().points[0],
            d = [r(s.price.value())]
          this.bindControl(new p(o, s.price, d, !1, this.model(), 'Change ' + this._linetool + ' point price')),
            this.bindBarIndex(s.bar, l, this.model(), 'Change ' + this._linetool + ' point bar index'),
            this.loadData()
        }),
      ...
      i('PVgW'),
        ...
        (C.prototype.addOneColorPropertyWidget = function (e) {
          var t = this.createOneColorForAllLinesWidget(),
            i = $('<tr>')
          i.append($('<td>')).append($('<td>')).append(t.editor).append($('<td>').append(t.label)), i.appendTo(e)
        }),
        (C.prototype.prepareLayout = function () {
          ;(this._table = $(document.createElement('table'))),
            this._table.addClass('property-page property-page-unpadded'),
          ...
          var C = $('<tr>')
          for (var y in ($("<td colspan='3'>" + $.t('Levels') + '</td>').appendTo(C),
          C.appendTo(n),
          o.levels._childs)) {
            var g = o.levels[y],
              w = $('<tr>')
            ...
            $('<td>').append(T).appendTo(w), (R = $("<td class='colorpicker-cell'>")).appendTo(w)
            var v = b(R)
            ;(E = $('<td>')).appendTo(w),
              (N = this.createLineWidthEditor()).appendTo(E),
              this.bindControl(new s(T, g.visible, !0, t, 'Change Gann Line Visibility')),
              this.bindControl(new p(v, g.color, !0, t, 'Change Gann Line Color', 0)),
              this.bindControl(new d(N, g.width, !0, t, 'Change Gann Line Width'))
          }
          var _ = $('<table>')
          $("<td valign='top'>").append(_).appendTo(e)
          var m = $('<tr>')
          for (var y in ($("<td colspan='4'>" + $.t('Fans') + '</td>').appendTo(m),
          m.appendTo(_),
          o.fanlines._childs)) {
            var f = o.fanlines[y],
              L = $('<tr>')
            ...
            $('<td>' + S + '</td>').appendTo(L), (R = $("<td class='colorpicker-cell'>")).appendTo(L)
            v = b(R)
            ;(E = $('<td>')).appendTo(L),
              (N = this.createLineWidthEditor()).appendTo(E),
              this.bindControl(new s(T, f.visible, !0, t, 'Change Gann Line Visibility')),
              this.bindControl(new p(v, f.color, !0, t, 'Change Gann Fan Color', 0)),
              this.bindControl(new d(N, f.width, !0, t, 'Change Gann Line Width'))
          }
          var k = $('<table>')
          $("<td valign='top'>").append(k).appendTo(e)
          var x = $('<tr>')
          for (var y in ($("<td colspan='4'>" + $.t('Arcs') + '</td>').appendTo(x), x.appendTo(k), o.arcs._childs)) {
            var B = o.arcs[y],
              P = $('<tr>')
            P.appendTo(k)
            T = $("<input type='checkbox' class='visibility-switch'>")
            ...
            $('<td>' + S + '</td>').appendTo(P), (R = $("<td class='colorpicker-cell'>")).appendTo(P)
            var E
            v = b(R)
            ;(E = $('<td>')).appendTo(P),
              (N = this.createLineWidthEditor()).appendTo(E),
              this.bindControl(new s(T, B.visible, !0, t, 'Change Gann Line Visibility')),
              this.bindControl(new p(v, B.color, !0, t, 'Change Gann Arc Color', 0)),
              this.bindControl(new d(N, B.width, !0, t, 'Change Gann Line Width'))
          }
          ...
          this.bindControl(new s(D, o.arcsBackground.fillBackground, !0, t, 'Change Gann Square Filling')),
            this.bindControl(
              new d(I, o.arcsBackground.transparency, !0, t, 'Change Gann Square Background Transparency')
            )
          var z = $('<input type="text">')
          W = this.addLabeledRow(A, $.t('Price/Bar Ratio'), z, !0)
          $('<td>').append(z).appendTo(W), z.TVTicker({ step: i.getScaleRatioStep() })
          ...
          $('<td>').append(H).prependTo(W),
            this.bindControl(new s(H, o.showLabels, !0, t, 'Change Gann Square Lables Visibility'))
          var N = this.createLineWidthEditor(),
            ...
            j = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-italic"></span></span>'),
            U = this.createFontSizeEditor(),
            K = this.createFontEditor(),
            Q = o.labelsStyle
          this.bindControl(new h(U, Q.fontSize, parseInt, !0, t, 'Change Text Font Size')),
            this.bindControl(new h(K, Q.font, null, !0, t, 'Change Text Font')),
            this.bindControl(new s(G, Q.bold, !0, t, 'Change Text Font Bold')),
            this.bindControl(new s(j, Q.italic, !0, t, 'Change Text Font Italic'))
          var Z = $('<table class="property-page" cellspacing="0" cellpadding="2"><tr>')
            .append($(document.createElement('td')).attr({ width: 1 }).append(K))
            .append($(document.createElement('td')).attr({ width: 1 }).append(U))
            .append($(document.createElement('td')).css('vertical-align', 'top').attr({ width: 1 }).append(G))
            .append($(document.createElement('td')).css('vertical-align', 'top').append(j))
            .append($('</tr></table>'))
    ...
    JyhW: function (e, t, i) {
      ...
      inherit(h, n),
        (h.prototype.prepareLayout = function () {
          ...
          this.bindControl(new r(e, this._linetool.properties().textColor, !0, this.model(), 'Change Text Color')),
            this.bindControl(
              new l(t, this._linetool.properties().fontSize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new l(i, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new s(o, this._linetool.properties().text, null, !0, this.model(), 'Change Text')),
            this.bindControl(
              new r(n, this._linetool.properties().markerColor, !0, this.model(), 'Change Marker and Border Color')
            ),
            this.bindControl(
              new r(
                a,
            ...
            this.bindControl(new d(p, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new d(h, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic'))
          var c = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
          ...
          ;(this._table = c.add(u).add(b)),
            $(document.createElement('tr'))
              .append($(document.createElement('td')).attr({ width: 1 }).append(e))
              .append($(document.createElement('td')).attr({ width: 1 }).append(i))
              .append($(document.createElement('td')).attr({ width: 1 }).append(t))
              .append($(document.createElement('td')).attr({ width: 1 }).append(p))
              .append($(document.createElement('td')).append(h))
              .appendTo(c),
            $(document.createElement('tr'))
              .append($(document.createElement('td')).attr({ colspan: 5 }).append(o))
              .appendTo(c)
        ...
        (h.prototype.dialogPosition = function (e, t) {
          if (e && t) {
            for (
              var i, n = 0, a = this._linetool._model.paneForSource(this._linetool), r = p.getChartWidget();
        ...
        inherit(_, s),
          (_.prototype._addSessionEditor = function (e, t, i, o) {
            if ('session' === i.type) {
              var n = function (e, t) {
                  var i = $('<td/>')
                  i.appendTo(e), i.css('padding-left', '0px'), i.css('padding-right', '0px')
                  var o = $('<input>')
                  o.attr('type', 'text'), o.addClass('ticker'), o.css('width', '40px'), o.attr('id', t), o.appendTo(i)
                },
                a = function (e, t, i) {
                  var o = $('<td/>')
                  o.css('padding-left', i), o.css('padding-right', i), o.appendTo(e)
                  var n = $('<div/>')
              ...
              var s = $('<tr/>')
              s.appendTo(r)
              var d = ['start_hours', 'start_minutes', 'end_hours', 'end_minutes']
              n.call(this, s, d[0]),
                a.call(this, s, ':', 0),
                n.call(this, s, d[1]),
                a.call(this, s, '-', 4),
          ...
          (_.prototype.prepareControl = function (t, i, o) {
            ...
            if ('resolution' === t.type)
              ...
              (a = $('<input class="symbol-edit single">')),
                ...
                i.attr('colspan', 5)
            else if ('session' === t.type) this._addSessionEditor(i, this._property.inputs[t.id], t, o)
              ...
              if (c) {
                var b = this._study.source().title(!0, null, !0),
                  u = w.getChildSourceInputTitles(t, this._study.source().metaInfo(), b)
                for (var C in s) u[C] && (s[C] = 1 === Object.keys(u).length ? b : u[C])
              }
              if (
                ...
                for (var g = this._model.model().allStudies(), _ = 0; _ < g.length; ++_) {
                  var m = g[_]
                      ...
                      for (h = 0; h < x.length; ++h)
                        (B = x[h]),
                          ~w.CHILD_STUDY_ALLOWED_PLOT_TYPES.indexOf(B.type) &&
                            (s[L + '$' + h] = f + ': ' + ((k && k[B.id] && k[B.id].title) || B.id))
                    }
                  }
                }
                ;(r = (function (e) {
                  return function (t) {
                    ...
                    if (0 === t.indexOf('#')) {
                      ...
                      if (null === a) return void T.logError('Can not get Study by id ' + o)
                      a.isStarted() || a.start(null, !0)
                      var r = a.sourceId()
                      if (!r) return void T.logError('Can not get source id for ' + a.metaInfo().id)
                      i = t.replace(/^[^\$]+/, r)
                    }
                    ;(!~t.indexOf('$') && !~t.indexOf('#')) || n._study.isStarted() || n._study.start(null, !0),
                  ...
                  (l = (function (e) {
                    return function (t) {
                      ...
                      for (
                        var i = t.slice(0, t.indexOf('$')), o = n._model.model().allStudies(), a = 0;
                        a < o.length;
                        ++a
                      ) {
                        var r = o[a]
            ...
            } else (a = $('<input/>')), 'bool' === t.type ? a.attr('type', 'checkbox') : a.attr('type', 'text')
            return (
              a && (a.appendTo(i), a.is(':checkbox') || 'symbol' === t.type || a.css('width', '100px')),
          ...
          (_.prototype.prepareLayoutImpl = function (e, t) {
            ...
            for (var o = this._sortInputs(e.inputs), l = 0; l < o.length; l++) {
              ...
              if (
                ...
                v.appendTo(t)
                var _ = $('<td/>')
                _.appendTo(v), _.addClass('propertypage-name-label'), _.text(window.t(F, { context: 'input' }))
                var m = $('<td/>')
                m.appendTo(v)
                ...
                if (s.options) this.bindControl(new u(L, this._property.inputs[w], null, !0, this.model(), T, S, k))
                else if ('bar_time' === s.type) {
                  this.bindControl(
                    new r(L, this._property.inputs[w], !0, this.model(), T, this.model().mainSeries(), 10)
                  ),
                    L.addClass('ticker')
                  ...
                  ;(0 === s.min || s.min) && x.push(d(s.min)),
                    ...
                    this.bindControl(new y(L, this._property.inputs[w], x, !1, this.model(), T)),
                    L.addClass('ticker'),
                    isFinite(s.step) && s.step > 0 && L.attr('data-step', s.step)
                } else if ('float' === s.type) {
                  x = [c(s.defval)]
                  ;(0 === s.min || s.min) && x.push(d(s.min)), (0 === s.max || s.max) && x.push(p(s.max))
                  var B = new y(L, this._property.inputs[w], x, !1, this.model(), T)
                  B.addFormatter(i),
                    this.bindControl(B),
                    L.addClass('ticker'),
                    isFinite(s.step) && s.step > 0 && L.attr('data-step', s.step)
                } else if ('text' === s.type)
                  this.bindControl(new y(L, this._property.inputs[w], null, !1, this.model(), T))
                else if ('bool' === s.type) this.bindControl(new C(L, this._property.inputs[w], !0, this.model(), T))
                else if ('resolution' === s.type)
                  this.bindControl(new u(L, this._property.inputs[w], n, !0, this.model(), 'Change Interval'))
                else if ('symbol' === s.type) {
                  var P = this._symbolInfoBySymbolProperty.bind(this, this._property.inputs[w]),
            ...
            if (this._property.offset) {
              ...
              ;(L = this.addOffsetEditorRow(t, F)),
                (x = [h(this._property.offset.val)]).push(d(this._property.offset.min)),
                x.push(p(this._property.offset.max)),
                this.bindControl(new y(L, this._property.offset.val, x, !1, this.model(), 'Undo ' + F))
            }
                ...
                function (e, i) {
                  if (this._property.offsets[i.id]) {
                    ...
                    if (void 0 === o.isHidden || !o.isHidden.value()) {
                      ...
                      a.push(d(o.min)),
                        a.push(p(o.max)),
                        this.bindControl(new y(L, o.val, a, !1, this.model(), 'Undo ' + n))
                    }
                  }
                }.bind(this)
              )
    ...
    LkNV: function (e, t, i) {
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          v.render().appendTo(T),
            this.bindControl(new l(y, t.color, !0, this.model(), 'Change Pitchfork Line Color'), 0),
            this.bindControl(new s(v, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfan Line Style')),
        ...
        (b.prototype.prepareLayout = function () {
          ...
          $('<td>').append(o).appendTo(i), this.createLabeledCell($.t('Background'), o).appendTo(i)
          var n = c()
      ...
      inherit(d, o),
        (d.prototype.prepareLayout = function () {
          ...
          $('<td>').append(i).appendTo(o),
            ...
            this.bindControl(
              new r(i, this._linetool.properties().linecolor, !0, this.model(), 'Change Circle Lines Color')
            ),
            this.bindControl(
              new a(t, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Circle Lines Style')
            ),
            this.bindControl(
              new l(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Circle Lines Width')
            ),
            this.loadData()
        }),
        (d.prototype.widget = function () {
    ...
    NHMx: function (e, t, i) {
      ...
      inherit(h, o),
        (h.prototype.prepareLayout = function () {
          ...
          this.bindControl(new r(e, this._linetool.properties().color, !0, this.model(), 'Change Text Color')),
            this.bindControl(
              new l(t, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new l(i, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new d(o, this._linetool.properties().text, null, !0, this.model(), 'Change Text')),
            this.bindControl(
              new r(
                n,
                this._linetool.properties().backgroundColor,
            ...
            this.bindControl(new r(c, this._linetool.properties().bordercolor, !0, this.model(), 'Change Text Color')),
            this.bindControl(new s(h, this._linetool.properties().linewidth, !0, this.model(), 'Change Border Width')),
            this.bindControl(new a(b, this._linetool.properties().wordWrap, !0, this.model(), 'Change Text Wrap')),
            this.bindControl(new a(u, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new a(C, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic'))
          var y = $('<table class="property-page" cellspacing="0" cellpadding="2">').data(
              'layout-tab-open',
              p.Override
            ),
            g = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
    ...
    PVgW: function (e, t, i) {
      ...
      function a(e) {
        return (
          (e = Math.abs(e)),
          !Object(o.isInteger)(e) && e > 1 && (e = parseFloat(e.toString().replace(/^.+\./, '0.'))),
          0 < e && e < 1
            ? Math.pow(
                10,
                (function (e) {
      ...
      function r(e, t) {
        ...
        var i = e.data('TVTicker'),
          n = i && i.step,
          r = 0
        ;(r = i.parser ? i.parser(e.val()) : Object(o.isInteger)(n) ? parseInt(e.val(), 10) : parseFloat(e.val())),
          isNaN(r) && (r = 0)
        var l = a(n),
          ...
          this.each(function () {
            ...
            if (
              ...
              var a = $('<div class="tv-ticker">').appendTo(i.parent()),
                r = $('<div class="tv-ticker__btn tv-ticker__btn--up">').html(n).appendTo(a),
                d = $('<div class="tv-ticker__btn tv-ticker__btn--down">').html(n).appendTo(a)
              a.on('mousedown', function (e) {
                ...
                i.keydown(function (e) {
                  i.is(':disabled') ||
                    (38 === e.keyCode ? r.addClass('i-active') : 40 === e.keyCode && d.addClass('i-active'))
                }),
                i.keyup(function (e) {
                  i.is(':disabled') ||
                    (38 === e.keyCode
    ...
    QPOT: function (e, t, i) {
      ...
      inherit(l, o),
        (l.prototype.prepareLayout = function () {
          ...
          var s = $('<tr>').appendTo(t),
            d = $('<td>').appendTo(s).css({ 'vertical-align': 'top', width: '50%' }),
            p = $('<td>').appendTo(s).css({ 'vertical-align': 'top', width: '50%' }),
            h = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo(d),
            c = $('<table class="property-page" cellspacing="0" cellpadding="0">').appendTo(p),
          ...
          this.bindControl(new a(o, this._linetool.properties().linecolor, !0, this.model(), 'Forecast Line Color')),
            this.bindControl(new r(n, this._linetool.properties().linewidth, !0, this.model(), 'Forecast Line Width')),
            this.bindControl(new a(o, this._linetool.properties().linecolor, !0, this.model(), 'Forecast Line Color')),
            this.bindControl(new r(n, this._linetool.properties().linewidth, !0, this.model(), 'Forecast Line Width')),
            this.bindControl(
              new a(
            ...
            this.bindControl(
              new a(C, this._linetool.properties().sourceStrokeColor, !0, this.model(), 'Forecast Source Border Color')
            ),
            this.bindControl(
              new a(u, this._linetool.properties().sourceTextColor, !0, this.model(), 'Forecast Source Text Color')
            ),
            this.bindControl(
              new a(
                w,
            ...
            this.bindControl(
              new a(v, this._linetool.properties().targetStrokeColor, !0, this.model(), 'Forecast Target Border Color')
            ),
            this.bindControl(
              new a(T, this._linetool.properties().targetTextColor, !0, this.model(), 'Forecast Target Text Color')
            ),
            this.bindControl(
              new a(y, this._linetool.properties().successBackground, !0, this.model(), 'Forecast Success Back Color')
            ),
            this.bindControl(
              new a(g, this._linetool.properties().successTextColor, !0, this.model(), 'Forecast Success Text Color')
            ),
            this.bindControl(
              new a(_, this._linetool.properties().failureBackground, !0, this.model(), 'Forecast Failure Back Color')
            ),
            this.bindControl(
              new a(m, this._linetool.properties().failureTextColor, !0, this.model(), 'Forecast Failure Text Color')
            ),
            this.loadData()
        }),
        (l.prototype.widget = function () {
    ...
    QxMc: function (e, t, i) {
      ...
      inherit(p, o),
        ...
        (p.prototype.prepareLayout = function () {
          ...
          var o = $('<tr>')
          for (var n in ($("<td colspan='3'>" + $.t('Levels') + '</td>').appendTo(o),
          o.appendTo(i),
          t.levels._childs)) {
            var p = t.levels[n],
              h = $('<tr>')
            ...
            var c = $("<input type='checkbox' class='visibility-switch'>")
            $('<td>').append(c).appendTo(h), (f = $("<td class='colorpicker-cell'>")).appendTo(h)
            var b = s(f)
            ;(L = $('<td>')).appendTo(h),
              (S = this.createLineWidthEditor()).appendTo(L),
              this.bindControl(new a(c, p.visible, !0, this.model(), 'Change Gann Line Visibility')),
              this.bindControl(new l(b, p.color, !0, this.model(), 'Change Gann Line Color', 0)),
              this.bindControl(new r(S, p.width, !0, this.model(), 'Change Gann Line Width'))
          }
          var u = $('<table>')
          $("<td valign='top'>").append(u).appendTo(e)
          var C = $('<tr>')
          for (var n in ($("<td colspan='4'>" + $.t('Fans') + '</td>').appendTo(C),
          C.appendTo(u),
          t.fanlines._childs)) {
            var y = t.fanlines[n],
              g = $('<tr>')
            ...
            $('<td>' + w + '</td>').appendTo(g), (f = $("<td class='colorpicker-cell'>")).appendTo(g)
            b = s(f)
            ;(L = $('<td>')).appendTo(g),
              (S = this.createLineWidthEditor()).appendTo(L),
              this.bindControl(new a(c, y.visible, !0, this.model(), 'Change Gann Line Visibility')),
              this.bindControl(new l(b, y.color, !0, this.model(), 'Change Gann Fan Color', 0)),
              this.bindControl(new r(S, y.width, !0, this.model(), 'Change Gann Line Width'))
          }
          var T = $('<table>')
          $("<td valign='top'>").append(T).appendTo(e)
          var v = $('<tr>')
          for (var n in ($("<td colspan='4'>" + $.t('Arcs') + '</td>').appendTo(v), v.appendTo(T), t.arcs._childs)) {
            var _ = t.arcs[n],
              m = $('<tr>')
            m.appendTo(T)
            c = $("<input type='checkbox' class='visibility-switch'>")
            ...
            $('<td>' + w + '</td>').appendTo(m), (f = $("<td class='colorpicker-cell'>")).appendTo(m)
            var L, S
            b = s(f)
            ;(L = $('<td>')).appendTo(m),
              (S = this.createLineWidthEditor()).appendTo(L),
              this.bindControl(new a(c, _.visible, !0, this.model(), 'Change Gann Line Visibility')),
              this.bindControl(new l(b, _.color, !0, this.model(), 'Change Gann Arc Color', 0)),
              this.bindControl(new r(S, _.width, !0, this.model(), 'Change Gann Line Width'))
          }
          ...
          if (
            ...
            $('<td>').append(E).prependTo(P),
              this.bindControl(new a(E, t.reverse, !0, this.model(), 'Change Gann Square Reverse'))
          }
          this.bindControl(new a(x, t.arcsBackground.fillBackground, !0, this.model(), 'Change Gann Square Filling')),
            this.bindControl(
              new r(B, t.arcsBackground.transparency, !0, this.model(), 'Change Gann Square Background Transparency')
            )
        }),
        (p.prototype.widget = function () {
          return this._table
      ...
      inherit(d, n),
        (d.prototype.prepareLayout = function () {
          ...
          if (l.enabled('seconds_resolution')) {
            ...
            $('<td>').append(n).appendTo(t)
            var d = $('<div>').addClass('slider-range ui-slider-horizontal').slider()
            $('<td>').append(d).appendTo(t)
            var p = $("<input type='text'>").addClass('ticker-text')
            $('<td>').append(p).appendTo(t),
              this.bindControl(new a(o, e.seconds, !0, this.model(), 'Change Line Tool Visibility On Seconds')),
              this.bindControl(
                new r(
                  d,
          ...
          ;(t = $('<tr>').appendTo(this._block)), (i = $('<label>').append($.t('Minutes')))
          ...
          $('<td>').append(p).appendTo(t),
            this.bindControl(new a(h, e.minutes, !0, this.model(), 'Change Line Tool Visibility On Minutes')),
            this.bindControl(
              new r(
                d,
          ...
          ;(t = $('<tr>').appendTo(this._block)), (i = $('<label>').append($.t('Hours')))
          var b = $("<input type='checkbox'>").addClass('visibility-checker').prependTo(i)
          ...
          p = $("<input type='text'>").addClass('ticker-text')
          $('<td>').append(p).appendTo(t),
            this.bindControl(new a(b, e.hours, !0, this.model(), 'Change Line Tool Visibility On Hours')),
            this.bindControl(
              new r(
                d,
          ...
          ;(t = $('<tr>').appendTo(this._block)), (i = $('<label>').append($.t('Days')))
          ...
          p = $("<input type='text'>").addClass('ticker-text')
          $('<td>').append(p).appendTo(t),
            this.bindControl(new a(u, e.days, !0, this.model(), 'Change Line Tool Visibility On Days')),
            this.bindControl(
              new r(
                d,
                [e.daysFrom, e.daysTo],
          ...
          ;(t = $('<tr>').css('height', '29px').appendTo(this._block)), (i = $('<label>').append($.t('Weeks')))
          var C = $("<input type='checkbox'>").prependTo(i)
          $('<td>').append(i).appendTo(t),
            this.bindControl(new a(C, e.weeks, !0, this.model(), 'Change Line Tool Visibility On Weeks'))
          ;(t = $('<tr>').css('height', '29px').appendTo(this._block)), (i = $('<label>').append($.t('Months')))
          var y = $("<input type='checkbox'>").prependTo(i)
          $('<td>').append(i).appendTo(t),
            this.bindControl(new a(y, e.months, !0, this.model(), 'Change Line Tool Visibility On Months')),
            this.loadData()
        }),
        (d.prototype.widget = function () {
          return this._block
      ...
      inherit(s, o),
        (s.prototype.prepareLayout = function () {
          ...
          $('<td>').append(i).prependTo(n),
            $('<td>').append(o).appendTo(n),
            this.bindControl(
              new r(i, this._linetool.properties().fillBackground, !0, this.model(), 'Change Rectangle Filling')
            ),
            this.bindControl(
              new a(t, this._linetool.properties().color, !0, this.model(), 'Change Rectangle Line Color')
            ),
            this.bindControl(
              new a(
                o,
            ...
            this.bindControl(
              new l(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Rectangle Border Width')
            ),
            this.loadData()
        }),
        (s.prototype.widget = function () {
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          if ((c.appendTo(n), e)) {
            ...
            u.appendTo(b),
              u.css('width', '70px'),
              this.bindControl(new a(u, t.coeff, !1, this.model(), 'Change Pitchfork Line Coeff'))
          ...
          var v = h()
          v.render().appendTo(T),
            this.bindControl(new r(c, t.visible, !0, this.model(), 'Change Pitchfork Line Visibility')),
            this.bindControl(new l(y, t.color, !0, this.model(), 'Change Pitchfork Line Color', 0)),
            this.bindControl(new s(v, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfork Line Style')),
        ...
        (b.prototype.prepareLayout = function () {
          ...
          $("<td colspan='5'>").append(n).appendTo(o),
            ...
            (o = $('<tr>')).appendTo(this._table)
          var p = $("<input type='checkbox' class='visibility-switch'>")
          $('<td>').append(p).appendTo(o), this.createLabeledCell($.t('Background'), p).appendTo(o)
          var h = c()
      ...
      inherit(p, o),
        (p.prototype.prepareLayout = function () {
          ...
          var c = this.createLineWidthEditor(),
            b = d(),
            u = this.createColorPicker()
          $('<td>').append(u).appendTo(n), $('<td>').append(c).appendTo(n), $('<td>').append(b.render()).appendTo(n)
          n = $('<tr>').appendTo(e)
          var C = $('<td>').appendTo(n),
            y = $("<input type='checkbox' class='visibility-switch'>")
          ...
          var w = $('<tbody>').appendTo(this._table),
            T = this.addEditorRow(w, 'Extend Left', $("<input type='checkbox'>"), 2),
            v = this.addEditorRow(w, 'Extend Right', $("<input type='checkbox'>"), 2),
            _ = this._linetool.properties()
          this.bindControl(new a(y, _.fillBackground, !0, this.model(), 'Change Parallel Channel Fill Background')),
            this.bindControl(new a(h, _.showMidline, !0, this.model(), 'Change Parallel Channel Show Center Line')),
            this.bindControl(new a(T, _.extendLeft, !0, this.model(), 'Change Parallel Channel Extending Left')),
            this.bindControl(new a(v, _.extendRight, !0, this.model(), 'Change Parallel Channel Extending Right')),
            this.bindControl(new r(o, _.linecolor, !0, this.model(), 'Change Parallel Channel Color')),
            this.bindControl(new l(i, _.linestyle, parseInt, !0, this.model(), 'Change Parallel Channel Style')),
            this.bindControl(new s(t, _.linewidth, !0, this.model(), 'Change Parallel Channel Width')),
            this.bindControl(new r(u, _.midlinecolor, !0, this.model(), 'Change Parallel Channel Middle Color')),
            this.bindControl(
              new l(b, _.midlinestyle, parseInt, !0, this.model(), 'Change Parallel Channel Middle Style')
            ),
            this.bindControl(new s(c, _.midlinewidth, !0, this.model(), 'Change Parallel Channel Middle Width')),
            this.bindControl(
              new r(g, _.backgroundColor, !0, this.model(), 'Change Parallel Channel Back Color', _.transparency)
            ),
            this.loadData()
        }),
        (p.prototype.widget = function () {
      ...
      inherit(d, o),
        (d.prototype.prepareLayout = function () {
          ...
          var e = this.createLineWidthEditor(),
            t = this.createColorPicker(),
            i = this.createColorPicker(),
            o = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-bold"></span></span>'),
          ...
          p = this.createFontEditor()
          this.bindControl(new a(t, this._linetool.properties().color, !0, this.model(), 'Change Pattern Line Color')),
            this.bindControl(
              new a(i, this._linetool.properties().textcolor, !0, this.model(), 'Change Pattern Text Color')
            ),
            this.bindControl(
              new r(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Pattern Border Width')
            ),
            this.bindControl(
              new l(d, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new l(p, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new s(o, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new s(n, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic'))
          var h = $('<table class="property-page" cellspacing="0" cellpadding="2"><tr>')
              .append($(document.createElement('td')).attr({ width: 1 }).append(i))
              .append($(document.createElement('td')).attr({ width: 1 }).append(p))
              .append($(document.createElement('td')).attr({ width: 1 }).append(d))
              .append($(document.createElement('td')).css('vertical-align', 'top').attr({ width: 1 }).append(o))
      ...
      inherit(y, n),
        (y.prototype.prepareLayout = function () {
          ...
          var e = $('<tbody>').appendTo(this._table),
            ...
            i = $('<input type="text">')
          $('<td>').append(i).appendTo(t), i.addClass('ticker ticker--evenlonger')
          var o = $('<input type="text" class="ticker ticker--evenlonger">')
          $('<td>' + $.t('Price:') + '</td>').appendTo(t), $('<td>').append(o).appendTo(t)
          ...
          var y = [s(this._linetool.properties().stopLevel.value()), l(0), r(1e9)]
          this.bindControl(
            new p(
              i,
        ...
        (g.prototype.prepareLayout = function () {
          ...
          $('<td>').append(y).appendTo(a), $('<td>').append(w).appendTo(a), $('<td>').append(g).appendTo(a)
          a = $('<tr>').appendTo(i)
          ...
          ;(this._riskEdit = $('<input type="text" class="ticker">')),
            ...
            this._riskEdit.data('step', e.getRiskStep(t.riskDisplayMode.value())),
          ...
          $('<td>').append(f).appendTo(a),
            this.bindControl(new h(n, t.linecolor, !0, this.model(), 'Change Risk/Reward line Color')),
            this.bindControl(new c(o, t.linewidth, !0, this.model(), 'Change Risk/Reward line width')),
            this.bindControl(
              new h(s, t.stopBackground, !0, this.model(), 'Change stop color', t.stopBackgroundTransparency)
            ),
            this.bindControl(
              new h(C, t.profitBackground, !0, this.model(), 'Change target color', t.profitBackgroundTransparency)
            ),
            this.bindControl(new b(g, t.fontsize, parseInt, !0, this.model(), 'Change Text Font Size')),
            this.bindControl(new b(w, t.font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new h(y, t.textcolor, !0, this.model(), 'Change Text Color')),
            this.bindControl(new u(v, t.showPriceLabels, !0, this.model(), 'Show Price Labels')),
            this.bindControl(new u(_, t.compact, !0, this.model(), 'Compact mode'))
          var L = [d(t.accountSize.value()), l(1), r(1e9)]
          this.bindControl(new p(m, t.accountSize, L, !1, this.model(), 'Change ' + this._linetool + ' Account Size')),
            this.bindControl(new b(f, t.riskDisplayMode, null, !0, this.model(), '% / Cash'))
          var S = [
            d(t.risk.value()),
            l(1),
            function (i) {
          ...
          this.bindControl(new p(this._riskEdit, t.risk, S, !1, this.model(), 'Change ' + this._linetool + ' Risk')),
            this.loadData()
        }),
    ...
    Yc1q: function (e, t, i) {
      ...
      inherit(s, n),
        (s.prototype.createOneColorForAllLinesWidget = function () {
          ...
          return (
            this.bindControl(
              new a(r(e), this._linetool.properties().collectibleColors, !0, this.model(), 'Change All Lines Color', 0)
            ),
    ...
    a0Rg: function (e, t, i) {
      ...
      function n() {
        var e = $('<select />')
        return (
          $('<option value="' + o.LineStudyPlotStyle.Line + '">' + $.t('Line') + '</option>').appendTo(e),
          $(
            '<option value="' + o.LineStudyPlotStyle.LineWithBreaks + '">' + $.t('Line With Breaks') + '</option>'
          ).appendTo(e),
          $('<option value="' + o.LineStudyPlotStyle.StepLine + '">' + $.t('Step Line') + '</option>').appendTo(e),
          $('<option value="' + o.LineStudyPlotStyle.Histogram + '">' + $.t('Histogram') + '</option>').appendTo(e),
          $(
            '<option value="' +
          ...
          $('<option value="' + o.LineStudyPlotStyle.Area + '">' + $.t('Area') + '</option>').appendTo(e),
          $(
            '<option value="' + o.LineStudyPlotStyle.AreaWithBreaks + '">' + $.t('Area With Breaks') + '</option>'
          ).appendTo(e),
          $('<option value="' + o.LineStudyPlotStyle.Columns + '">' + $.t('Columns') + '</option>').appendTo(e),
          $('<option value="' + o.LineStudyPlotStyle.Circles + '">' + $.t('Circles') + '</option>').appendTo(e),
          e
        )
      }
    },
      ...
      inherit(p, o),
        (p.prototype.prepareLayout = function () {
          ...
          $('<td>').append(o).appendTo(n),
            ...
            $('<td colspan="3">').append(i.render()).appendTo(n),
            this.bindControl(
              new r(o, this._linetool.properties().linecolor, !0, this.model(), 'Change Fib Spiral Line Color')
            ),
            this.bindControl(
              new a(
                i,
            ...
            this.bindControl(
              new l(t, this._linetool.properties().linewidth, !0, this.model(), 'Change Fib Spiral Line Width')
            )
          var p = $('<input type="checkbox">'),
            h = this.addLabeledRow(this._table, window.t('Counterclockwise'), p)
          $('<td>').append(p).prependTo(h),
            this.bindControl(
              new s(p, this._linetool.properties().counterclockwise, !0, this.model(), 'Change Counterclockwise')
            ),
            this.loadData()
        }),
        (p.prototype.widget = function () {
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          v.render().appendTo(T),
            ...
            this.bindControl(new s(v, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfork Line Style')),
            this.bindControl(new l(w, t.linewidth, parseInt, this.model(), 'Change Pitchfork Line Width'))
        }),
        (b.prototype.prepareLayout = function () {
          ;(this._table = $(document.createElement('table'))),
            this._table.addClass('property-page'),
          ...
          this.addOneColorPropertyWidget(this._table)
          var i = $('<table class="property-page property-page-unpadded" cellspacing="0" cellpadding="0">').css({
              width: '100%'
            }),
            o = $('<tr>').appendTo(i)
          ...
          var b = $("<input type='checkbox' class='visibility-switch'>")
          $('<td>').append(b).appendTo(a), this.createLabeledCell($.t('Background'), b).appendTo(a)
          var u = c()
          $('<td colspan="3">').append(u).appendTo(a),
            ...
            this.bindControl(
              new r(n, this._linetool.properties().showCoeffs, !0, this.model(), 'Change Fib Retracement Extend Lines')
            ),
            this.loadData()
        }),
        (b.prototype.widget = function () {
      ...
      inherit(d, o),
        (d.prototype.prepareLayout = function () {
          var e = this.createColorPicker(),
            ...
            b = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-bold"></span></span>'),
            u = $('<span class="_tv-button _tv-button-fontstyle"><span class="icon-fontstyle-italic"></span></span>')
          this.bindControl(new l(e, this._linetool.properties().color, !0, this.model(), 'Change Text Color')),
            this.bindControl(
              new r(i, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new r(o, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new a(n, this._linetool.properties().text, null, !0, this.model(), 'Change Text')),
            this.bindControl(
              new l(
                d,
                this._linetool.properties().backgroundColor,
            ...
            this.bindControl(
              new s(p, this._linetool.properties().fillBackground, !0, this.model(), 'Change Text Background Fill')
            ),
            this.bindControl(new s(h, this._linetool.properties().drawBorder, !0, this.model(), 'Change Text Border')),
            this.bindControl(
              new l(t, this._linetool.properties().borderColor, !0, this.model(), 'Change Text Border Color')
            ),
            this.bindControl(new s(c, this._linetool.properties().wordWrap, !0, this.model(), 'Change Text Wrap')),
            this.bindControl(new s(b, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new s(u, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic'))
          var C = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
            y = $('<table class="property-page" cellspacing="0" cellpadding="2">'),
            g = $('<table class="property-page" cellspacing="0" cellpadding="2">')
          ;(this._table = C.add(g).add(y)),
            $(document.createElement('tr'))
              ...
              .appendTo(C),
            $(document.createElement('tr'))
              .append($(document.createElement('td')).attr({ colspan: 5 }).append(n))
              .appendTo(C)
        ...
        (d.prototype.dialogPosition = function (e, t) {
          ...
          $.each(a.paneWidgets(), function (e, t) {
            if (t._state === n) return (i = $(t.canvasElement()).offset().top), !1
          }),
            e || (e = {})
          var r = e.left,
            l = e.top,
      ...
      inherit(s, o),
        (s.prototype.prepareLayout = function () {
          ...
          $('<td>').css({ width: '0' }).html($.t('Text')).appendTo(n),
            ...
            (n = this.addLabeledRow(this._table, $.t('Text Font'))).children().css({ whiteSpace: 'nowrap' }),
            $('<td>').append(i).appendTo(n).css({ width: '0' }),
            $('<td>').append(o).appendTo(n),
            this.bindControl(
              new r(i, this._linetool.properties().color, !0, this.model(), 'Change Arrow Mark Text Color')
            ),
            this.bindControl(
              new a(e, this._linetool.properties().text, null, !0, this.model(), 'Change Arrow Mark Text')
            ),
            this.bindControl(
              new l(o, this._linetool.properties().font, null, !0, this.model(), 'Change Arrow Mark Font')
            ),
            this.loadData(),
            setTimeout(function () {
              e.select(), e.focus()
      ...
      inherit(h, o),
        (h.prototype.prepareLayout = function () {
          ...
          $('<td>').append(n).prependTo(o),
            ...
            this.bindControl(
              new r(n, this._linetool.properties().showTime, !0, this.model(), 'Change Vert Line Time Visibility')
            ),
            this.bindControl(
              new d(i, this._linetool.properties().linecolor, !0, this.model(), 'Change Vert Line Color')
            ),
            this.bindControl(
              new l(t, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Vert Line Style')
            ),
            this.bindControl(
              new s(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Vert Line Width')
            ),
            this.loadData()
        }),
        (h.prototype.widget = function () {
        ...
        (c.prototype.prepareLayout = function () {
          if (
            ...
            $('<td>' + $.t('Bar #') + '</td>').appendTo(t), $('<td>').append(e).appendTo(t)
            var i = this._linetool.properties().points[0]
            this.bindBarIndex(i.bar, e, this.model(), 'Change ' + this._linetool + ' point bar index'), this.loadData()
          }
        }),
      ...
      inherit(s, o),
        (s.prototype.prepareLayout = function () {
          ...
          $('<td>').append(i).prependTo(n),
            $('<td>').append(o).appendTo(n),
            this.bindControl(
              new a(i, this._linetool.properties().fillBackground, !0, this.model(), 'Change Arc Filling')
            ),
            this.bindControl(new r(t, this._linetool.properties().color, !0, this.model(), 'Change Arc Line Color')),
            this.bindControl(
              new r(
                o,
                this._linetool.properties().backgroundColor,
            ...
            this.bindControl(
              new l(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Arc Border Width')
            ),
            this.loadData()
        }),
        (s.prototype.widget = function () {
    ...
    k7QS: function (e, t, i) {
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t) {
          ...
          d.appendTo(l),
            d.css('width', '70px'),
            this.bindControl(new a(d, e.coeff, !1, this.model(), 'Change Pitchfork Line Coeff'))
          var h = $("<td class='colorpicker-cell'>")
          h.appendTo(i)
          var c = p(h)
          return (
            this.bindControl(new r(n, e.visible, !0, this.model(), 'Change Fib Retracement Line Visibility')),
            this.bindControl(new s(c, e.color, !0, this.model(), 'Change Fib Retracement Line Color', 0)),
            i
          )
        }),
        (b.prototype.prepareLayout = function () {
          ...
          if (e) {
            ...
            $('<td>').append(o).appendTo(i),
              ...
              this.bindControl(new r(o, e.visible, !0, this.model(), 'Change Fib Retracement Line Visibility'))
            ...
            ;(g = this.createLineWidthEditor()).appendTo(b),
              this.bindControl(new l(g, e.linewidth, parseInt, this.model(), 'Change Fib Retracement Line Width'))
            var u = $('<td>').appendTo(i)
            ;(w = h()).render().appendTo(u),
              this.bindControl(new d(w, e.linestyle, parseInt, !0, this.model(), 'Change Fib Retracement Line Style'))
          }
          var C = this._linetool.properties().levelsStyle,
            y = $('<tr>').appendTo(t)
          $('<td>').appendTo(y), $('<td>' + $.t('Levels Line') + '</td>').appendTo(y), $('<td>').appendTo(y)
          var g
          b = $('<td>').appendTo(y)
          ;(g = this.createLineWidthEditor()).appendTo(b),
            this.bindControl(new l(g, C.linewidth, parseInt, this.model(), 'Change Fib Retracement Line Width'))
          var w
          u = $('<td>').appendTo(y)
          ;(w = h()).render().appendTo(u),
            this.bindControl(new d(w, C.linestyle, parseInt, !0, this.model(), 'Change Fib Retracement Line Style')),
          ...
          $('<td>').append(P).appendTo(R)
          var I = $("<table cellspacing='0' cellpadding='0'>").appendTo(this._div),
            W = $(
              "<select><option value='left'>" +
                $.t('left') +
                "</option><option value='center'>" +
          ...
          ;(y = $('<tr>'))
            ...
            .append(A),
            y.appendTo(I)
          var V = $("<table cellspacing='0' cellpadding='0'>").appendTo(this._div),
            O = ((y = $('<tr>').appendTo(V)), $("<input type='checkbox' class='visibility-switch'>"))
          $('<td>').append(O).appendTo(y), this.createLabeledCell($.t('Background'), O).appendTo(y)
          var z = c()
          if (($('<td>').append(z).appendTo(y), this._linetool.properties().fibLevelsBasedOnLogScale)) {
            y = $('<tr>').appendTo(V)
            ;(this._fibLevelsBasedOnLogScaleEditor = $("<input type='checkbox' class='visibility-switch'>")),
              ...
              $('<td colspan="3">').append(this._fibLevelsBasedOnLogScaleLabel).appendTo(y),
              this._linetool.priceScale().modeChanged().subscribe(this, this._onPriceScaleModeChanged),
              this._onPriceScaleModeChanged(void 0, this._linetool.priceScale().mode())
          }
          this.bindControl(
            new r(F, this._linetool.properties().showPrices, !0, this.model(), 'Change Gann Fan Prices Visibility')
          ),
            this.bindControl(
              new r(E, this._linetool.properties().showCoeffs, !0, this.model(), 'Change Gann Fan Levels Visibility')
            ),
            this.bindControl(
              new r(
                O,
            ...
            this._linetool.properties().reverse &&
              this.bindControl(
                new r(k, this._linetool.properties().reverse, !0, this.model(), 'Change Fib Retracement Reverse')
              ),
            this.bindControl(
              new d(
                W,
        ...
        (b.prototype.destroy = function () {
          o.prototype.destroy.call(this), this._linetool.priceScale().modeChanged().unsubscribeAll(this)
        }),
    ...
    kNI9: function (e, t, i) {
      ...
      inherit(d, o),
        (d.prototype.prepareLayout = function () {
          ...
          var h = $('<input type="checkbox" class="visibility-switch">'),
            c = this.createColorPicker(),
            b = ((p = this.createFontEditor()), this.addLabeledRow(this._table, 'Background', h))
          $('<td>').append(h).prependTo(b),
            $('<td>').append(c).appendTo(b),
            this.bindControl(
              new a(h, this._linetool.properties().fillBackground, !0, this.model(), 'Change Pattern Filling')
            ),
            this.bindControl(
              new r(t, this._linetool.properties().color, !0, this.model(), 'Change Pattern Line Color')
            ),
            this.bindControl(
              new r(i, this._linetool.properties().textcolor, !0, this.model(), 'Change Pattern Text Color')
            ),
            this.bindControl(
              new r(
                c,
            ...
            this.bindControl(
              new s(d, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new s(p, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new a(o, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new a(n, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic'))
          var u = $('<table class="property-page" cellspacing="0" cellpadding="2"><tr>')
            .append($(document.createElement('td')).attr({ width: 1 }).append(i))
            .append($(document.createElement('td')).attr({ width: 1 }).append(p))
            .append($(document.createElement('td')).attr({ width: 1 }).append(d))
            .append($(document.createElement('td')).css('vertical-align', 'top').attr({ width: 1 }).append(o))
      ...
      inherit(h, o),
        (h.prototype.prepareLayout = function () {
          ...
          $('<td>').append(v).appendTo(n),
            this.bindControl(new r(v, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color'))
    ...
    n3Kh: function (e, t, i) {
      ...
      i('PVgW'),
        ...
        (d.prototype.bindBarIndex = function (e, t, i, o) {
          var n = [l(e.value()), a(d.BarIndexPastLimit), r(d.BarIndexFutureLimit)]
        ...
        (d.prototype.prepareLayoutForTable = function (e) {
          for (var t = this._linetool.points(), i = t.length, o = 0; o < t.length; o++) {
            var n = t[o],
    ...
    nzyg: function (e, t, i) {
      ...
      inherit(h, o),
        (h.prototype.prepareLayout = function () {
          ...
          var n = $("<input type='checkbox' class='visibility-switch'>"),
            a = $('<tr>').appendTo(this._table)
          $('<td>').append(n).prependTo(a), this.createLabeledCell(2, window.t('Show Price'), n).appendTo(a)
          var h = $("<input type='checkbox' class='visibility-switch'>"),
            c = $('<tr>').appendTo(this._table)
          $('<td>').append(h).prependTo(c),
            this.createLabeledCell(2, window.t('Show Time'), h).appendTo(c),
            this.bindControl(
              new r(h, this._linetool.properties().showTime, !0, this.model(), 'Change Cross Line Time Visibility')
            ),
            this.bindControl(
              new r(n, this._linetool.properties().showPrice, !0, this.model(), 'Change Cross Line Price Visibility')
            ),
            this.bindControl(
              new d(i, this._linetool.properties().linecolor, !0, this.model(), 'Change Cross Line Color')
            ),
            this.bindControl(
              new l(t, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Cross Line Style')
            ),
            this.bindControl(
              new s(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Cross Line Width')
            ),
            this.loadData()
        }),
        (h.prototype.widget = function () {
        ...
        (c.prototype.prepareLayout = function () {
          if (
            ((this._table = $('<table class="property-page" cellspacing="0" cellpadding="2" width="100%">')),
            this._linetool.points()[0])
          ) {
            var e = $('<input type="text" class="ticker">'),
              t = $('<tr>').appendTo(this._table)
            $('<td>' + $.t('Bar #') + '</td>').appendTo(t), $('<td>').append(e).appendTo(t)
            var i = this._linetool.properties().points[0]
            this.bindBarIndex(i.bar, e, this.model(), 'Change ' + this._linetool + ' point bar index')
            var o = this.createPriceEditor(i.price)
            $('<td>' + $.t('Price') + '</td>').appendTo(t), $('<td>').append(o).appendTo(t), this.loadData()
          }
        }),
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          if ((w.appendTo(g), !e)) {
            ...
            var v = h()
            v.render().appendTo(T),
              this.bindControl(new r(v, t.linestyle, parseInt, !0, this.model(), 'Change Fib Circle Style'))
          }
          this.bindControl(new l(c, t.visible, !0, this.model(), 'Change Fib Circle Visibility')),
        ...
        (b.prototype.prepareLayout = function () {
          ...
          $('<td>').append(n).prependTo(o),
            this.bindControl(
              new l(i, this._linetool.properties().showCoeffs, !0, this.model(), 'Change Fib Circle Levels Visibility')
            ),
            (o = $('<tr>')).appendTo(this._table)
          var a = $("<input type='checkbox' class='visibility-switch'>")
          $('<td>').append(a).appendTo(o), this.createLabeledCell('Background', a).appendTo(o)
          var r = c()
    ...
    o6hY: function (e, t, i) {
      ...
      function B(e, t, i) {
        n.call(this, e, t), (this._study = i), (this._property = e), this.prepareLayout()
      }
      inherit(x, n),
        (x.prototype.prepareLayout = function () {
          ...
          for (var o = 0; o < e.plots.length; ++o)
            if (
              ...
              else if (this._study.isPlotArrowsPlot(o)) this._prepareLayoutForArrowsPlot(o, r)
              else if (this._study.isPlotCharsPlot(o)) this._prepareLayoutForCharsPlot(o, r)
              else if (this._study.isPlotShapesPlot(o)) this._prepareLayoutForShapesPlot(o, r)
              else if (this._study.isOHLCSeriesPlot(o)) {
                var l = { id: a, type: 'ohlc' }
                this._study.isOHLCBarsPlot(o)
                  ? this._prepareLayoutForBarsPlot(o, l)
                  : this._study.isOHLCCandlesPlot(o) && this._prepareLayoutForCandlesPlot(o, l)
            ...
            for (o = 0; o < h.childCount(); o++) {
              if (!(D = h[o]).isHidden || !D.isHidden.value()) {
                ;(O = $('<tr class="line"/>')).appendTo(this._table),
                  (j = $('<td/>')).appendTo(O),
                  (V = $("<input type='checkbox' class='visibility-switch'/>")).appendTo(j)
                var g = $.t(D.name.value(), { context: 'input' }),
                  w = this.createLabeledCell(g, V).appendTo(O).addClass('propertypage-name-label'),
                  T = $('<td/>')
                ...
                var B = y()
                B.render().appendTo(k)
                var P = $("<input class='property-page-bandwidth' type='text'/>")
                P.appendTo(k)
                ...
                F.addFormatter(i),
                  ...
                  this.bindControl(new d(B, D.linestyle, parseInt, !0, this.model(), E)),
          ...
          if (this._study.properties().areaBackground) {
            ;(D = this._study.properties().areaBackground), (I = $.t('Background')), (E = $.t('Change area background'))
            ;(O = this._prepareFilledAreaBackground(
              D.fillBackground,
              D.backgroundColor,
              D.transparency,
            ...
            for (o = 0; o < W.length; ++o) {
              ...
              if (!A.isHidden) {
                ...
                if (A.palette) {
                  ...
                  ;(j = $('<td/>')).appendTo(O),
                    (V = $("<input type='checkbox' class='visibility-switch'/>")).appendTo(j),
                    this.bindControl(new p(V, D.visible, !0, this.model(), E + ' visibility'))
                  var z = $.t(I, { context: 'study' })
                  this.createLabeledCell(z, V).appendTo(O).addClass('propertypage-name-label'), O.appendTo(this._table)
                  var M = this._findPlotPalette(o, A),
                    Y = M.palette,
                    q = M.paletteProps
                  this._prepareLayoutForPalette(0, A, Y, q, E)
                } else {
                  ;(O = this._prepareFilledAreaBackground(D.visible, D.color, D.transparency, I, E)).appendTo(
                    this._table
                  )
                }
              }
          ...
          1 === U.length &&
            ...
            1 === (w = this._table.find('.propertypage-plot-with-palette')).length
              ? w.css('display', 'none')
              : ((w = this._table.find('.propertypage-name-label')).css('padding-left', 0),
        ...
        (x.prototype._prepareOrdersSwitches = function () {
          var e = $('<table class="property-page study-strategy-properties" cellspacing="0" cellpadding="2">'),
            t = 'chart-orders-switch_' + Date.now().toString(36),
            i = $('<tr>').appendTo(e),
            o = $('<input id="' + t + '" type="checkbox">').appendTo($('<td>').appendTo(i))
          $('<label for="' + t + '">' + $.t('Trades on Chart') + '</label>').appendTo($('<td>').appendTo(i))
          var n = 'chart-orders-labels-switch_' + Date.now().toString(36),
            a = $('<tr>').appendTo(e),
            r = $('<input id="' + n + '" type="checkbox">').appendTo($('<td>').appendTo(a))
          $('<label for="' + n + '">' + $.t('Signal Labels') + '</label>').appendTo($('<td>').appendTo(a))
          var l = 'chart-orders-qty-switch_' + Date.now().toString(36),
            s = $('<tr>').appendTo(e),
            d = $('<input id="' + l + '" type="checkbox">').appendTo($('<td>').appendTo(s))
          $('<label for="' + l + '">' + $.t('Quantity') + '</label>').appendTo($('<td>').appendTo(s))
          var c = this._study.properties()
          return (
            this.bindControl(new p(o, c.strategy.orders.visible, !0, this.model(), 'Trades on chart visibility')),
            this.bindControl(new p(r, c.strategy.orders.showLabels, !0, this.model(), 'Signal labels visibility')),
            this.bindControl(new h(r, c.strategy.orders.visible, !0, this.model(), 'Signal labels visibility', !0)),
            this.bindControl(new p(d, c.strategy.orders.showQty, !0, this.model(), 'Quantity visibility')),
            this.bindControl(new h(d, c.strategy.orders.visible, !0, this.model(), 'Quantity visibility', !0)),
            e
          )
        }),
        (x.prototype._prepareLayoutForPlot = function (e, t) {
          ...
          if (a) {
            ;(h = $('<tr class="line"/>')).appendTo(this._table),
              ...
              (y = $("<input type='checkbox' class='visibility-switch plot-visibility-switch'/>")).appendTo(u),
              this.bindControl(new p(y, o.visible, !0, this.model(), l))
            var s = $.t(o.title.value(), { context: 'input' })
            this.createLabeledCell(s, y).appendTo(h).addClass('propertypage-name-label propertypage-plot-with-palette'),
            ...
            this.createLabeledCell(s, y).appendTo(h).addClass('propertypage-name-label')
            var g = $('<td/>')
            ...
            S.on('change', this._trackPriceLine.bind(this)).appendTo(L),
              ...
              this.bindControl(new p(y, o.visible, !0, this.model(), l)),
              this.bindControl(new c(w, o.color, !0, this.model(), l, o.transparency)),
              this.bindControl(new b(v, o.linewidth, !0, this.model(), l, this._study.metaInfo().isTVScript)),
              this.bindControl(new d(f, o.plottype, parseInt, !0, this.model(), l)),
              this.bindControl(new p(S, o.trackPrice, !0, this.model(), 'Change Price Line'))
          }
        }),
        (x.prototype._prepareLayoutForBarsPlot = function (e, t) {
          ...
          var h = $("<input type='checkbox' class='visibility-switch'/>")
          h.appendTo(d), this.bindControl(new p(h, o.visible, !0, this.model(), l))
          var b = o.title.value()
          if ((this.createLabeledCell(b, h).appendTo(s).addClass('propertypage-name-label'), a)) {
        ...
        (x.prototype._prepareLayoutForCandlesPlot = function (e, t) {
          ...
          l.appendTo(r), this.bindControl(new p(l, o.drawWick, !0, this.model(), n))
        ...
        (x.prototype._prepareLayoutForShapesPlot = function (e, t) {
          ...
          var h = $("<input type='checkbox' class='visibility-switch'/>")
          h.appendTo(s), this.bindControl(new p(h, o.visible, !0, this.model(), l))
          var b = $.t(this._study.properties().styles[i].title.value(), {
            context: 'input'
          })
          this.createLabeledCell(b, h).appendTo(_).addClass('propertypage-name-label')
          var u = $('<td/>')
          u.appendTo(_)
          var y = w()
          y.appendTo(u), this.bindControl(new d(y, o.plottype, null, !0, this.model(), l))
          var T = $('<td/>')
          T.appendTo(_)
          var v = g()
          if ((v.appendTo(T), this.bindControl(new d(v, o.location, null, !0, this.model(), l)), a))
            this._prepareLayoutForPalette(e, t, a, r, l)
          else {
            var _
            ;(_ = $('<tr class="line"/>')).appendTo(this._table), $('<td/>').appendTo(_), $('<td/>').appendTo(_)
            var m = $('<td/>')
            m.appendTo(_), m.addClass('colorpicker-cell')
            var f = C(m)
            this.bindControl(new c(f, o.color, !0, this.model(), l, o.transparency))
          }
        }),
        ...
        (x.prototype._prepareLayoutForPalette = function (e, t, i, o, n, a) {
          ...
          for (var y in i.colors) {
            ...
            var T = $('<td/>')
            T.appendTo(w), T.addClass('propertypage-name-label'), T.html($.t(g.name.value(), { context: 'input' }))
            var v = $('<td/>')
            v.appendTo(w), v.addClass('colorpicker-cell')
            var m = C(v)
            if (
              (this.bindControl(new c(m, g.color, !0, this.model(), n, s.transparency)),
              !h && this._study.isLinePlot(r))
            ) {
              var f = $('<td/>')
              f.appendTo(w)
              var L = this.createLineWidthEditor()
              L.appendTo(f), this.bindControl(new b(L, g.width, !0, this.model(), n, this._study.metaInfo().isTVScript))
              var S = $('<td>')
              if ((S.appendTo(w), 0 === u)) {
                var k = _()
                k.appendTo(S), this.bindControl(new d(k, s.plottype, parseInt, !0, this.model(), n))
                var x = $('<td>')
                x.appendTo(w)
                var B = $("<input type='checkbox'>")
                B.on('change', this._trackPriceLine.bind(this)).appendTo(x),
                  this.createLabeledCell('Price Line', B).appendTo(w),
                  this.bindControl(new p(B, s.trackPrice, !0, this.model(), 'Change Price Line'))
              }
            }
            u++
          }
        ...
        (x.prototype._trackPriceLine = function () {
          k('GUI', 'Add Price Line', this._study.properties().description.value())
        }),
        (x.prototype._prepareLayoutForArrowsPlot = function (e, t) {
          ...
          this.createLabeledCell(s, l).appendTo(a).addClass('propertypage-name-label')
          var d = $('<td/>')
          ...
          this.bindControl(new p(l, o.visible, !0, this.model(), n)),
            ...
            this.bindControl(new c(u, o.colordown, !0, this.model(), n, o.transparency))
        }),
        (x.prototype._findPlotPalette = function (e, t) {
          ...
          if (this._study.isBarColorerPlot(i) || this._study.isBgColorerPlot(i))
            (n = this._study.metaInfo().palettes[t.palette]), (a = this._study.properties().palettes[t.palette])
          else
            for (var l = 0; l < r.length; l++)
              if (r[l].target === o && (this._study.isSelfColorerPlot(l) || this._study.isOHLCColorerPlot(l))) {
        ...
        (x.prototype._prepareStudyPropertiesLayout = function () {
          ...
          if (
            ...
            $('<td>').append(t).appendTo(i),
            this.bindControl(new d(t, this._study.properties().precision, null, !0, this.model(), 'Change Precision')),
            ...
            ;(i = $('<tr>')).appendTo(e),
              ...
              $('<td>').append(t).appendTo(i),
              this.bindControl(new d(t, this._study.properties().minTick, null, !0, this.model(), 'Change MinTick'))
          }
        ...
        (x.prototype._prepareFilledAreaBackground = function (e, t, i, o, n) {
          ...
          r.appendTo(a)
          var l = $("<input type='checkbox' class='visibility-switch'/>")
          l.appendTo(r), this.createLabeledCell(o, l).appendTo(a).addClass('propertypage-name-label')
          var s = $('<td/>')
          s.appendTo(a), s.addClass('colorpicker-cell')
          var d = C(s)
          return (
        ...
        (x._createRow_horizlines = function (e, t) {
          ...
          $('<td>').append(n).appendTo(i),
            ...
            this.bindControl(new p(n, t.visible, !0, this.model(), 'Change ' + o + ' visibility')),
            this.bindControl(new c(a, t.color, !0, this.model(), 'Change ' + o + ' color')),
            this.bindControl(new d(l, t.style, parseInt, !0, this.model(), 'Change ' + o + ' style')),
            this.bindControl(new b(r, t.width, !0, this.model(), 'Change ' + o + ' width'))
        }),
        ...
        (x._createRow_hlines = function (e, t) {
          ...
          if (
            ...
            this.bindControl(new d(l, t.style, parseInt, !0, this.model(), 'Change ' + o + ' style')),
            this.bindControl(new b(r, t.width, !0, this.model(), 'Change ' + o + ' width')),
            this.bindControl(new p(s, t.showPrice, !0, this.model(), 'Change ' + o + ' show price')),
            t.enableText.value())
          ) {
            i = this.addRow(e)
            ...
            $('<td class="text-center">').append(h).appendTo(i),
              ...
              this.bindControl(new p(h, t.showText, !0, this.model(), 'Change ' + o + ' show text'))
            var u = TradingView.createTextPosEditor()
            $('<td>').append(u.render()).appendTo(i),
              this.bindControl(new d(u, t.textPos, parseInt, !0, this.model(), 'Change ' + o + ' text position'))
            var C = this.createFontSizeEditor()
            $('<td colspan="2">').append(C).appendTo(i),
              this.bindControl(new d(C, t.fontSize, parseInt, !0, this.model(), 'Change ' + o + ' font size'))
          }
        }),
        (x._createRow_hhists = function (e, t) {
          ...
          $('<td>').append(h).appendTo(s),
            ...
            this.bindControl(new p(h, t.visible, !0, this.model(), 'Change ' + i + ' Visibility'))
          s = this.addRow(e)
          var b = $('<input/>')
          b.attr('type', 'text'),
            b.addClass('ticker'),
          ...
          C.push(a(0)),
            C.push(r(100)),
            this.bindControl(new u(b, t.percentWidth, C, !1, this.model(), 'Change Percent Width'))
          s = this.addLabeledRow(e, 'Placement')
          var y = v()
          $('<td>').append(y).appendTo(s),
            this.bindControl(new d(y, t.direction, null, !0, this.model(), 'Change ' + i + ' Placement'))
          s = this.addRow(e)
          var g = $("<input type='checkbox'>")
          $('<td>').append(g).appendTo(s),
            this.createLabeledCell($.t('Show Values'), g).appendTo(s),
            this.bindControl(new p(g, t.showValues, !0, this.model(), 'Change ' + i + ' Show Values'))
          s = this.addRow(e)
          var w = this.createColorPicker()
          for (var _ in (this.createLabeledCell($.t('Text Color'), w).appendTo(s),
          $('<td>').append(w).appendTo(s),
          this.bindControl(new c(w, t.valuesColor, !0, this.model(), 'Change ' + i + ' Text Color')),
          t.colors))
            if (isNumber(parseInt(_, 10))) {
              ...
              ;(o[_] = t.titles[_].value()),
                ...
                this.bindControl(new c(n[_], t.colors[_], !0, this.model(), 'Change ' + o[_] + ' color'))
            }
        }),
        (x._createRow_backgrounds = function (e, t) {
          ...
          $('<td>').append(o).appendTo(i),
            ...
            $('<td>').append(a).appendTo(i),
            this.bindControl(new p(o, t.visible, !0, this.model(), 'Change ' + n + ' visibility')),
            this.bindControl(new c(a, t.color, !0, this.model(), 'Change ' + n + ' color', t.transparency))
        }),
        (x._createRow_polygons = function (e, t) {
          ...
          $('<td>').append(o).appendTo(i),
            $('<td>').append(n).appendTo(i),
            this.bindControl(new c(n, t.color, !0, this.model(), 'Change ' + o + ' color'))
        }),
        (x._createRow_trendchannels = function (e, t) {
          ...
          $('<td>').append(o).appendTo(i),
            $('<td>').append(n).appendTo(i),
            this.bindControl(new c(n, t.color, !0, this.model(), 'Change ' + o + ' color', t.transparency))
        }),
        (x._createRow_textmarks = function (e, t) {
          ...
          $('<td>').append(o).appendTo(i),
            ...
            this.bindControl(new c(n, t.color, !0, this.model(), 'Change ' + o + ' color', t.transparency)),
            this.bindControl(new c(a, t.fontColor, !0, this.model(), 'Change ' + o + ' text color', t.transparency)),
            this.bindControl(new d(l, t.fontSize, parseInt, !0, this.model(), 'Change ' + o + ' font size')),
            this.bindControl(new d(r, t.fontFamily, null, !0, this.model(), 'Change ' + o + ' font')),
            this.bindControl(new p(s, t.fontBold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new p(h, t.fontItalic, !0, this.model(), 'Change Text Font Italic'))
        }),
        (x._createRow_shapemarks = function (e, t) {
          ...
          r.attr('type', 'text'),
            ...
            $('<td>').append(r).appendTo(i),
            this.bindControl(new p(o, t.visible, !0, this.model(), 'Change ' + n + ' visibility')),
            this.bindControl(new c(a, t.color, !0, this.model(), 'Change ' + n + ' back color', t.transparency)),
            this.bindControl(new u(r, t.size, null, !1, this.model(), 'Change size'))
        }),
      ...
      inherit(p, o),
        (p.prototype.prepareLayout = function () {
          ...
          $("<td colspan='2'>").append(B).appendTo(n),
            ...
            this.bindControl(new a(c, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new l(p, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color')),
            this.bindControl(new r(b, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new r(u, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic')),
            this.bindControl(
              new r(x, this._linetool.properties().showPrices, !0, this.model(), 'Change Disjoint Channel Show Prices')
            ),
            this.bindControl(
              new r(
                _,
            ...
            this.bindControl(
              new l(o, this._linetool.properties().linecolor, !0, this.model(), 'Change Disjoint Channel Color')
            ),
            this.bindControl(
              new a(
                i,
            ...
            this.bindControl(
              new s(t, this._linetool.properties().linewidth, !0, this.model(), 'Change Disjoint Channel Width')
            ),
            this.bindControl(
              new a(
                L,
            ...
            this.bindControl(
              new r(y, this._linetool.properties().fillBackground, !0, this.model(), 'Change Disjoint Channel Filling')
            ),
            this.bindControl(
              new l(
                g,
      ...
      inherit(g, o),
        (g.prototype.prepareLayout = function () {
          ...
          var a = $('<tbody>').appendTo(this._table),
            r = ((n = this.addLabeledRow(a, $.t('Text'))), this.createColorPicker()),
            l = this.createFontSizeEditor(),
          ...
          $('<td colspan="3">').appendTo(n).append(g),
            ...
            this.bindControl(
              new h(l, this._linetool.properties().fontsize, parseInt, !0, this.model(), 'Change Text Font Size')
            ),
            this.bindControl(new h(s, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font')),
            this.bindControl(new d(r, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color')),
            this.bindControl(new p(c, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold')),
            this.bindControl(new p(C, this._linetool.properties().italic, !0, this.model(), 'Change Text Font Italic')),
            this.bindControl(
              new d(o, this._linetool.properties().linecolor, !0, this.model(), 'Change Trend Angle Color')
            ),
            this.bindControl(
              new h(i, this._linetool.properties().linestyle, parseInt, !0, this.model(), 'Change Trend Angle Style')
            ),
            this.bindControl(
              new b(t, this._linetool.properties().linewidth, !0, this.model(), 'Change Trend Angle Width')
            ),
            this.bindControl(
              new p(v, this._linetool.properties().extendRight, !0, this.model(), 'Change Trend Angle Extending Right')
            ),
            this.bindControl(
              new p(_, this._linetool.properties().extendLeft, !0, this.model(), 'Change Trend Angle Extending Left')
            ),
            this.bindControl(
              new p(
                L,
        ...
        (w.prototype.prepareLayout = function () {
          ...
          if (e && t) {
            ...
            var n = [s(t.price.value()), r(-360), l(360)],
              a = new c(o, this._linetool.properties().angle, n, !1, this.model(), 'Change angle')
    ...
    qrDX: function (e, t, i) {
      ...
      inherit(d, o),
        (d.prototype.prepareLayout = function () {
          ...
          $('<td>').prependTo(n), $('<td>').append(t).appendTo(n), $('<td>').append(e).appendTo(n)
          n = this.addLabeledRow(this._table, 'Background', i)
          ...
          $('<td>').prependTo(n),
            ...
            this.bindControl(new l(t, this._linetool.properties().linecolor, !0, this.model(), 'Change Brush Color')),
            this.bindControl(
              new a(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Brush Line Width')
            ),
            this.bindControl(
              new r(i, this._linetool.properties().fillBackground, !0, this.model(), 'Change Brush Filling')
            ),
            this.bindControl(
              new l(
                o,
            ...
            this.bindControl(
              new s(p, this._linetool.properties().leftEnd, parseInt, !0, this.model(), 'Change Trend Line Left End')
            ),
            this.bindControl(
              new s(h, this._linetool.properties().rightEnd, parseInt, !0, this.model(), 'Change Trend Line Right End')
            ),
            this.loadData()
        }),
        (d.prototype.widget = function () {
      ...
      inherit(a, o),
        (a.prototype.prepareLayout = function () {
          ...
          ;(this._div = $('<div>').append(this._table)),
            this.bindControl(new n(e, o.color, !0, this.model(), 'Change Icon Color')),
            this.loadData()
        }),
      ...
      inherit(b, o),
        (b.prototype.addLevelEditor = function (e, t, i) {
          ...
          if ((w.appendTo(g), !e)) {
            ...
            v.render().appendTo(T),
              this.bindControl(
                new r(v, t.linestyle, parseInt, !0, this.model(), 'Change Fib Speed Resistance Arcs Style')
              )
          }
          this.bindControl(new l(c, t.visible, !0, this.model(), 'Change Fib Speed Resistance Arcs Visibility')),
        ...
        (b.prototype.prepareLayout = function () {
          ...
          $('<td>').append(n).prependTo(o),
            ...
            (o = $('<tr>')).appendTo(this._table)
          var a = $("<input type='checkbox' class='visibility-switch'>")
          $('<td>').append(a).appendTo(o), $('<td>' + $.t('Background') + '</td>').appendTo(o)
          var r = c()
          $('<td colspan="3">').append(r).appendTo(o),
            this.bindControl(
              new l(
      ...
      inherit(s, o),
        (s.prototype.prepareLayout = function () {
          ...
          $('<td>').append(i).prependTo(n),
            $('<td>').append(o).appendTo(n),
            this.bindControl(
              new a(i, this._linetool.properties().fillBackground, !0, this.model(), 'Change Ellipse Filling')
            ),
            this.bindControl(
              new r(t, this._linetool.properties().color, !0, this.model(), 'Change Ellipse Line Color')
            ),
            this.bindControl(
              new r(
                o,
            ...
            this.bindControl(
              new l(e, this._linetool.properties().linewidth, !0, this.model(), 'Change Ellipse Border Width')
            ),
            this.loadData()
        }),
        (s.prototype.widget = function () {
      ...
      inherit(d, o),
        (d.prototype.prepareLayout = function () {
          var e = $('<table class="property-page" cellspacing="0" cellpadding="0">')
            ...
            t = $('<table class="property-page" cellspacing="0" cellpadding="0">')
          this._table = e.add(t)
          ...
          $('<td>').appendTo(b).append(p),
            $('<td>'),
            this.bindControl(new l(i, this._linetool.properties().text, null, !0, this.model(), 'Change Balloon Text')),
            this.bindControl(new r(o, this._linetool.properties().color, !0, this.model(), 'Change Baloon Text Color')),
            this.bindControl(
              new a(
                n,
            ...
            this.bindControl(
              new r(p, this._linetool.properties().borderColor, !0, this.model(), 'Change Balloon Border Color')
            ),
            this.loadData(),
            setTimeout(function () {
              i.select(), i.focus()
      ...
      inherit(n, o),
        (n.prototype.prepareControl = function (e, t, i) {
          if ('source' === e.id) {
            ...
            return n.appendTo(t), { valueEditor: n, valueSetter: null, propertyChangedHook: null }
          }
    ...
    y9kM: function (e, t, i) {
      ...
      inherit(p, o),
        ...
        (p.prototype.prepareLayout = function () {
          ...
          this._prepareSeriesStyleLayout(e, t, i, a), (this._table = e.add(t).add(i).add(o).add(n))
          var d = $('<input type="checkbox">'),
            p = this.addLabeledRow(o, 'Price Line', d)
          $('<td>').append(d).prependTo(p),
            this.bindControl(new r(d, a.showPriceLine, !0, this.model(), 'Change Price Price Line'))
          var h = this.createSeriesMinTickEditor(),
            c = $('<tr>')
          c.appendTo(n),
            $('<td>' + $.t('Override Min Tick') + '</td>').appendTo(c),
            $('<td>').append(h).appendTo(c),
            this.bindControl(new l(h, a.minTick, null, !0, this.model(), 'Change MinTick')),
      ...
      inherit(d, o),
        (d.prototype.prepareLayout = function () {
          ...
          this.bindControl(new r(n, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color')),
            ...
            this.bindControl(
              new r(u, this._linetool.properties().backgroundColor, !0, this.model(), 'Change Text Background')
            ),
            this.bindControl(
              new l(C, this._linetool.properties().fillBackground, !0, this.model(), 'Change Text Background Fill')
            ),
