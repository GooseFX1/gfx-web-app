  ...
  ['lt-property-pages-with-definitions'],
  {
      ...
      class x extends l.a {
        ...
        _stylePropertyDefinitions() {
          ...
          'extendLines' in t && ((x.extendRight = t.extendLines), ($.extendRightTitle = g)),
            'extendLinesLeft' in t && ((x.extendLeft = t.extendLinesLeft), ($.extendLeftTitle = _)),
          ...
          for (let o = 1; o <= P; o++) {
            const e = t['level' + o].childs(),
              n = Object(s.h)(
                {
                  checked: Object(s.b)(this._undoModel, e.visible, `Change ${i} Level ${o} Line Visibility`),
                  color: Object(s.v)(this._undoModel, e.color, null, `Change ${i} Level ${o} Line Color`),
                  level: Object(s.b)(this._undoModel, e.coeff, `Change ${i} Level ${o} Coeff`)
                },
                { id: `${l}LineLevel${o}` }
              )
            S.push(n)
          ...
          if ((e.push(W), 'fibLevelsBasedOnLogScale' in t && null !== this._disabledBasedOnLog)) {
            const o = Object(s.c)(
              {
                disabled: Object(s.a)(
                  this._undoModel,
        ...
        _stylePropertyDefinitions() {
          ...
          for (let o = 1; o <= C; o++) {
            const e = t['hlevel' + o].childs(),
              l = Object(n.h)(
                {
                  checked: Object(n.b)(this._undoModel, e.visible, `Change ${i} Level ${o} Line Visibility`),
                  color: Object(n.v)(this._undoModel, e.color, null, `Change ${i} Level ${o} Line Color`),
                  level: Object(n.b)(this._undoModel, e.coeff, `Change ${i} Level ${o} Coeff`)
                },
                { id: `${s}HLineLevel${o}` }
              )
            j.push(l)
          ...
          const T = t.grid.childs(),
            V = Object(n.i)(
              {
                checked: Object(n.b)(this._undoModel, T.visible, `Change ${i} Grid Visibility`),
                color: Object(n.v)(this._undoModel, T.color, null, `Change ${i} Grid Line Color`),
                width: Object(n.b)(this._undoModel, T.linewidth, `Change ${i} Grid Line Width`),
                style: Object(n.b)(this._undoModel, T.linestyle, `Change ${i} Grid Line Style`)
              },
      ...
      class j extends s.a {
        _stylePropertyDefinitions() {
          ...
          const V = t.fans.childs(),
            B = Object(n.e)(
              {
                checked: Object(n.b)(this._undoModel, V.visible, `Change ${i} Fans Visibility`),
                color: Object(n.v)(this._undoModel, V.color, null, `Change ${i} Fans Line Color`)
              },
      ...
      class _ extends s.a {
        _stylePropertyDefinitions() {
          const e = [],
            ...
            i = this._source.name(),
            s = Object(r.c)(i),
            _ = Object(o.a)(this._undoModel, { lineColor: t.linecolor, lineWidth: t.linewidth }, i, 'Line', { line: c })
    ...
    CA9d: function (e, t, i) {
      ...
      const r = window.t('Price'),
        c = window.t('Bar#')
      function d(e, t, i) {
        return { property: Object(o.b)(e, t.price, `Change ${r} Y coordinate`), info: { typeY: 1, stepY: i } }
      }
      function a(e, t) {
        return {
          property: Object(o.b)(e, t.bar, `Change ${c} X coordinate`),
          info: { typeX: 0, minX: new s.a(-5e4), maxX: new s.a(15e3), stepX: new s.a(1) }
        }
      }
      function u(e, t, i, n, s, r) {
        ...
        return Object(o.f)(
          ...
          Object.assign(Object.assign({ id: Object(l.c)(`${r}Coordinates${s}`), title: s }, c.info), u.info)
        )
      }
    },
    Cn8r: function (e, t, i) {
          ...
          return Object(s.a)(
            (function (e, t) {
              ...
              if (c.enabled('seconds_resolution')) {
                const o = Object(n.n)(
                  {
                    checked: Object(n.b)(e, t.seconds, 'Change Line Tool Visibility On Seconds'),
                    from: Object(n.b)(e, t.secondsFrom, 'Change Line Tool Seconds From'),
                    to: Object(n.b)(e, t.secondsTo, 'Change Line Tool Seconds To')
                  },
                  { id: 'IntervalsVisibilitiesSecond', title: a, min: new r.a(g[0]), max: new r.a(g[1]) }
                )
                i.push(o)
              }
              const o = Object(n.n)(
                  {
                    checked: Object(n.b)(e, t.minutes, 'Change Line Tool Visibility On Minutes'),
                    from: Object(n.b)(e, t.minutesFrom, 'Change Line Tool Minutes From'),
                    to: Object(n.b)(e, t.minutesTo, 'Change Line Tool Minutes To')
                  },
                  { id: 'IntervalsVisibilitiesMinutes', title: u, min: new r.a(_[0]), max: new r.a(_[1]) }
                ),
                s = Object(n.n)(
                  {
                  ...
                  { id: 'IntervalsVisibilitiesHours', title: h, min: new r.a(j[0]), max: new r.a(j[1]) }
                ),
                l = Object(n.n)(
                  {
                  ...
                  { id: 'IntervalsVisibilitiesDays', title: b, min: new r.a(C[0]), max: new r.a(C[1]) }
                )
              i.push(o, s, l)
              const y = Object(n.n)(
                  {
                    checked: Object(n.b)(e, t.weeks, 'Change Line Tool Visibility On Weeks'),
                    from: Object(n.b)(e, t.weeksFrom, 'Change Line Tool Weeks From'),
                    to: Object(n.b)(e, t.weeksTo, 'Change Line Tool Weeks To')
                  },
                  { id: 'IntervalsVisibilitiesWeeks', title: w, min: new r.a(O[0]), max: new r.a(O[1]) }
                ),
                L = Object(n.n)(
                  {
                    checked: Object(n.b)(e, t.months, 'Change Line Tool Visibility On Months'),
                    from: Object(n.b)(e, t.monthsFrom, 'Change Line Tool Months From'),
                    to: Object(n.b)(e, t.monthsTo, 'Change Line Tool Months To')
                  },
                  { id: 'IntervalsVisibilitiesMonths', title: p, min: new r.a(f[0]), max: new r.a(f[1]) }
                )
              return i.push(y, L), i
            })(this._undoModel, e),
            'visibility',
              ...
              s &&
                i.push(
                  Object(y.c)(
                    ...
                    e,
                    o,
                    window.t('#{0} (price, bar)', { context: 'linetool point' }).format(n + 1),
                    this._source.name()
                  )
                )
            }),
        ...
        _stylePropertyDefinitions() {
          ...
          for (let o = 0; o <= g; o++) {
            const t = i['level' + o].childs(),
              n = Object(l.h)(
                {
                  checked: Object(l.b)(this._undoModel, t.visible, `Change ${s} Level ${o + 1} Line Visibility`),
                  color: Object(l.v)(this._undoModel, t.color, null, `Change ${s} Level ${o + 1} Line Color`),
                  width: Object(l.b)(this._undoModel, t.linewidth, `Change ${s} Level ${o + 1} Line Width`),
                  style: Object(l.b)(this._undoModel, t.linestyle, `Change ${s} Level ${o + 1} Line Style`),
                  level: Object(l.b)(this._undoModel, t.coeff, `Change ${s} Level ${o + 1} Line Coeff`)
                },
                { id: `${b}LineLevel${o + 1}` }
              )
            e.push(n)
        ...
        _stylePropertyDefinitions() {
              ...
              r = Object(n.h)(
                {
                  checked: Object(n.b)(this._undoModel, e.visible, `Change ${i} Level ${o} Line Visibility`),
                  color: Object(n.v)(this._undoModel, e.color, null, `Change ${i} Level ${o} Line Color`),
                  width: Object(n.b)(this._undoModel, e.width, `Change ${i} Level ${o} Line Width`)
                },
          ...
          for (let o = 0; o < v; o++) {
            const e = t.fanlines.childs()[o].childs(),
              l = Object(n.h)(
                {
                  checked: Object(n.b)(this._undoModel, e.visible, `Change ${i} Fan ${o} Line Visibility`),
                  color: Object(n.v)(this._undoModel, e.color, null, `Change ${i} Fan ${o} Line Color`),
                  width: Object(n.b)(this._undoModel, e.width, `Change ${i} Fan ${o} Line Width`)
                },
                { id: `${s}FanLineLevel${o}`, title: `${e.x.value()}x${e.y.value()}` }
              )
            L.push(l)
          }
          ...
          for (let o = 0; o < x; o++) {
            const e = t.arcs.childs()[o].childs(),
              l = Object(n.h)(
                {
                  checked: Object(n.b)(this._undoModel, e.visible, `Change ${i} Arcs ${o} Line Visibility`),
                  color: Object(n.v)(this._undoModel, e.color, null, `Change ${i} Arcs ${o} Line Color`),
                  width: Object(n.b)(this._undoModel, e.width, `Change ${i} Arcs ${o} Line Width`)
                },
                { id: `${s}ArcsLineLevel${o}`, title: `${e.x.value()}x${e.y.value()}` }
              )
            k.push(l)
          }
        ...
        _coordinatesPropertyDefinitions() {
          ...
          return [
            Object(r.f)(
              ...
              Object.assign(Object.assign({ id: Object(n.c)(`${t}Coordinates${u}`), title: u }, i.info), o.info)
            )
          ]
        }
        _stylePropertyDefinitions() {
