        ...
        ;(v.prototype.eos = function () {
                    ...
                    for (var b, k, E, C, I, T, U = new v(t); !U.eos(); ) {
                      ...
                      if (
                        ...
                        '=' === k
                          ...
                          : '{' === k
                          ? ((E = U.scanUntil(a)), U.scan(f), U.scanUntil(s), (k = '&'))
                          : (E = U.scanUntil(s)),
                        !U.scan(s))
                      )
                        throw new Error('Unclosed tag at ' + U.pos)
                      if (((I = [k, E, b, U.pos]), g.push(I), '#' === k || '^' === k)) c.push(I)
                      else if ('/' === k) {
                        if (!(T = c.pop())) throw new Error('Unopened section "' + E + '" at ' + b)
                        if (T[1] !== E) throw new Error('Unclosed section "' + T[1] + '" at ' + b)
                      } else 'name' === k || '{' === k || '&' === k ? (m = !0) : '=' === k && x(E)
                    }
                    if ((T = c.pop())) throw new Error('Unclosed section "' + T[1] + '" at ' + U.pos)
                    return (function (e) {
          ...
          (y.prototype.renderSection = function (e, t, i, o) {
            var s = this,
              ...
              u = t.lookup(e[1])
            if (u) {
              if (n(u)) for (var c = 0, p = u.length; c < p; ++c) a += this.renderTokens(e[4], t.push(u[c]), i, o)
