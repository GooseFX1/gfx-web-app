  ...
  ['header-toolbar'],
  {
    ...
    Iivm: function (e, t, a) {
      ...
      const n = i.forwardRef((e, t) => {
        const { icon: a = '' } = e,
          n = Object(s.a)(e, ['icon'])
        return i.createElement('span', Object.assign({}, n, { ref: t, dangerouslySetInnerHTML: { __html: a } }))
      })
      a.d(t, 'a', function () {
        return n
      })
    ...
    KMbc: function (e, t, a) {
      ...
      function f(e) {
        ...
        return s.createElement(
          'div',
          {
            className: o(a, g.group, { [g.noMinimalWidth]: r, [g.noLeftDecoration]: i, [g.noRightDecoration]: n }),
            onClick: l
          },
          t
        )
      ...
      var _ = a('tU7i'),
        C = a('Opoj')
      function E(e) {
        return s.createElement(_.b, Object.assign({}, e, { forceInteractive: !0, icon: C }))
      }
      a('YFKU')
      var M = a('Iivm'),
        w = a('a+Yp'),
      ...
      class N extends s.PureComponent {
            ...
            (this._processCustoms = (e) => {
              ...
              return e.map((e) =>
                s.createElement(
                  ...
                  s.createElement(i.Custom, Object.assign({}, e, { isFake: t }))
                )
              )
            }),
        ...
        render() {
          ...
          return s.createElement(
            ...
            s.createElement(
              m,
              { onMeasure: this._handleMeasureAvailableSpace, whitelist: ['width'], shouldMeasure: !v },
              s.createElement(
                F.a,
                {
                ...
                s.createElement(
                  ...
                  s.createElement(
                    S,
                    { onWidthChange: this._handleInnerResize, shouldMeasure: v },
                    s.createElement(
                      p.a,
                      ...
                      !r &&
                        s.Children.toArray([
                          e.SymbolSearch &&
                            s.createElement(
                              f,
                              { key: 'symbol', className: 2 === g && L.symbolSearch },
                          ...
                          e.DateRange && s.createElement(f, { key: 'range' }, s.createElement(e.DateRange, null)),
                          e.Intervals &&
                            1 === g &&
                            s.createElement(
                              f,
                          ...
                          1 === g &&
                            ...
                            s.createElement(
                              f,
                              { key: 'alert-referral' },
                              s.createElement(e.AlertReferral, { className: L.button, displayMode: a })
                            ),
                          e.Replay &&
                            1 === g &&
                            s.createElement(
                          ...
                          e.UndoRedo &&
                            ...
                            s.createElement(
                              f,
                              { key: 'undo-redo' },
                              s.createElement(e.UndoRedo, { id: v ? void 0 : x.UndoRedo })
                            ),
                          e.ScalePercentage &&
                            s.createElement(f, { key: 'percentage' }, s.createElement(e.ScalePercentage, null)),
                          e.ScaleLogarithm &&
                            s.createElement(f, { key: 'logarithm' }, s.createElement(e.ScaleLogarithm, null)),
                          ..._
                        ]),
                      1 === g
                        ? (function (e) {
                            const t = e.findIndex(
                              (e) =>
                                s.isValidElement(e) && !!e.key && -1 !== e.key.toString().indexOf('view-only-badge')
                            )
                            return (
                              [t]
                                .filter((e) => e >= 0)
                            ...
                            s.Children.toArray([
                              r && s.createElement(f, { key: 'view-only-badge' }, s.createElement(k, null)),
                              s.createElement(f, { key: 'gap', className: o(L.fill, v && L.collapse) }),
                              !r &&
                                e.Layout &&
                                s.createElement(
                                  f,
                                  { key: 'layout' },
                                  s.createElement(e.Layout, { id: v ? void 0 : x.Layouts })
                                ),
                              ...
                              e.SaveLoadReferral &&
                                s.createElement(
                                  ...
                                  s.createElement(e.SaveLoadReferral, { isReadOnly: r, displayMode: a })
                                ),
                              t.showLaunchInPopupButton &&
                                e.OpenPopup &&
                                s.createElement(f, { key: 'popup' }, s.createElement(e.OpenPopup, null)),
                              !r &&
                                e.Properties &&
                                s.createElement(
                                  f,
                              ...
                              !r &&
                                ...
                                s.createElement(
                                  ...
                                  s.createElement(e.Fullscreen, { id: v ? void 0 : x.Fullscreen })
                                ),
                              e.Screenshot &&
                                s.createElement(
                                  f,
                              ...
                              !r &&
                                ...
                                s.createElement(
                                  f,
                                  { key: 'publish', className: L.mobilePublish },
                                  s.createElement(e.Publish, { id: v ? void 0 : x.PublishMobile })
                                ),
                              ...C
                            ])
                          )
                        : [
                            s.createElement(f, { key: 'gap', className: o(L.fill, 2 === g && L.minimalPriority) }),
                            s.createElement(
                              f,
                              { key: 'symbol-search-close' },
                              s.createElement(E, { className: o(L.iconButton, L.symbolSearchClose) })
                            )
                          ]
                    )
                  )
            ...
            e.Publish && !r && !v && s.createElement(e.Publish, { id: x.PublishDesktop, className: L.desktopPublish })
          )
        }
        _onLoginStateChange() {
          0
      ...
      class J {
        ...
        getDefaultIntervals() {
          return null === this._chartApiInstance
            ? []
            : this._chartApiInstance.defaultResolutions().map(D.normalizeIntervalString)
        }
        getCustomIntervals() {
        ...
        add(e, t, a) {
          ...
          return this._isIntervalDefault(i) || n.includes(i)
            ? null
            : (this._customIntervalsService.set(Object(D.sortResolutions)([...n, i])), i)
        }
        remove(e) {
      ...
      class oe {
        ...
        _saveFavs() {
          ...
          this._settings.setJSON('studyMarket.favorites', e),
            U.TVXWindowEvents.emit('StudyFavoritesChanged', JSON.stringify({ favorites: e }))
        }
        _stateToSave() {
      ...
      function ce(e) {
        return Object(ae.isPineIdString)(e) ? { type: 'pine', pineId: e } : { type: 'java', studyId: e }
      }
      const de = {
      ...
      j.b
      var ue = a('54XG')
      const ve = { Area: 3, Bars: 0, Candles: 1, 'Heiken Ashi': 8, 'Hollow Candles': 9, Line: 2 },
        me = ['1', '30', '60']
      function pe(e = []) {
      ...
      class Se extends s.PureComponent {
        constructor(e) {
          ...
          ;(this._showScrollbarWhen = Object(n.ensureDefined)(e.allowedModes).slice(-1)),
          ...
          ;(this._favoriteIntervalsService = l || new X(U.TVXWindowEvents, G, _)),
            (this._intervalsMenuViewStateService = new he(U.TVXWindowEvents, G)),
            ...
            (this._setDisplayMode = Object(d.default)(this._setDisplayMode, 100)),
        ...
        render() {
          const e = this.props,
            ...
            m = Object.assign(Object.assign({}, v), { isFake: !0, showScrollbarWhen: ye }),
          ...
          return s.createElement(
            ...
            s.createElement(
              ...
              s.createElement(
                'div',
                { className: o(fe.toolbar, { [fe.isHidden]: !d }), onClick: this.props.onClick },
                s.createElement(
                  'div',
                  ...
                  p.map((e) =>
                    s.createElement(
                      N,
                      Object.assign({ key: e, displayMode: e, onWidthChange: this._panelWidthChangeHandlers[e] }, m)
                    )
                  )
                )
              )
      ...
      class _e {
        constructor(e, t) {
          ;(this._component = null),
            ...
            (this._container = e),
            i.render(s.createElement(Se, Object.assign({}, t, { ref: this._handleRef })), this._container)
        }
        destroy() {
      ...
      const l = o,
        c = i.forwardRef((e, t) => {
          const {
            ...
            E =
              ...
              ('string' == typeof a
                ...
                : i.cloneElement(a, { className: n(g.icon, a.props.className) }))
          return i.createElement(
            ...
            p && m && i.createElement('div', { className: n('js-button-text', g.text) }, m),
            E,
            !p && m && i.createElement('div', { className: n('js-button-text', g.text) }, m)
          )
        })
