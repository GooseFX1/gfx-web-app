            ...
            o(e, [
                    ...
                    a &&
                      ...
                      a.dataSources().forEach(function (i) {
                        if (i._metaInfo && 'Compare@tv-basicstudies' === i._metaInfo.id) {
                          ...
                          ;(o === t || (e._symbolAlias[o] && e._symbolAlias[o] === t)) && a.removeSource(i)
                        }
                      }))
                  }
                }
                        ...
                        this._predefines.forEach(function (e) {
                          ...
                          a.forEach(function (e) {
                            if (e._metaInfo && 'Compare@tv-basicstudies' === e._metaInfo.id) {
                              ...
                              ;(a === i || (t._symbolAlias[a] && t._symbolAlias[a] === i)) &&
                                (n.attr('checked', !0), t.selectedSymbols.push(a))
                            }
                          })
                        })
                    }
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var o = $('<div class="tv-compare-tab__predefines js-compare-tab-predefines"></div>')
                  this._predefines.forEach(function (e) {
                    var s = e.symbol,
                      n = e.title,
                      r = $(
                    ...
                    r.find('.js-predefine-checkbox').change({ symbol: s }, i), r.appendTo(o)
                  }),
                    o.appendTo(this.$tab)
                }
              },
            ...
            void 0 === i && (i = {}),
              ...
              Modernizr.mobiletouch ||
                ...
                (this._elArrowRight = this._findOrCreateElement(
                  ...
                  this._elTabs,
                  'append',
                  '<div class="' + (this._options.rArrowClass || '') + ' i-slided">' + _ + '</div>'
                )),
          ...
          return (
              ...
              this._elArrowLeft &&
                ...
                this._elArrowRight &&
                  (a - e > 1
                    ...
                    : (e >= a || this._elScrollWrap.scrollWidth <= i) && l(this._elArrowRight, s.Right))
            }),
            ...
            (t.prototype.setActivePage = function (t, e, i) {
              if (-1 !== t && (t !== this.index() || i)) {
                var a = this.index()
                o(this.getTabsArray(), this._options.activeTabClass, this._options.inactiveTabClass),
                  o(this.getPagesArray(), this._options.activePageClass, this._options.inactivePageClass),
              ...
              if (!this._options.noSlider) {
                ...
                if (
                  ...
                  if (d) {
                    ...
                    ;(l += parseInt(p.getPropertyValue('padding-left')) + d.offsetLeft), (c -= c - this._getElWidth(d))
                  }
            ...
            (t.prototype.deselect = function (t) {
              ...
              this._options.activeTabClass && e && e.classList.remove(this._options.activeTabClass)
              var i = this.getElActivePage()
              return (
                this._options.activePageClass && i && i.classList.remove(this._options.activePageClass),
            ...
            (t.prototype._findOrCreateElement = function (t, e, i, a) {
              ...
              if (!o) {
                ...
                if (((s.innerHTML = a || '<div class="' + t + '"></div>'), (o = s.firstElementChild), 'append' === i))
                  e.appendChild(o)
                else {
                  if ('wrapInner' !== i) throw new Error('Unknown insertMethod')
                  for (var n = Array.prototype.slice.call(e.childNodes), r = 0; r < n.length; r++) o.appendChild(n[r])
                  e.appendChild(o)
                }
              }
              return o
                      ...
                      Object(u.isRtl)() && i.reverse(),
                        ...
                        o().then(function () {
                          $.Velocity.animate(t._elScrollWrap, 'scroll', {
                            ...
                            offset: Math.floor(a - r - t._getElWidth(t._elArrowLeft)),
                            queue: !1
                          })
                        })
                    },
                ...
                this._elArrowRight &&
                  this._bindOneEvent({
                    ...
                    listener: function (e) {
                      var i = t.getTabsArray(),
                        s = 0,
                        r = Object(u.isRtl)() ? 0 : t._elScrollWrap.scrollLeft + t._getElWidth(t._elScrollWrap)
                      Object(u.isRtl)() && i.reverse(),
                        i.forEach(function (t) {
                          if (0 === s) {
                            var e = t.offsetLeft + t.offsetWidth
                        ...
                        o().then(function () {
                          $.Velocity.animate(t._elScrollWrap, 'scroll', {
                            ...
                            duration: n.dur / 2,
                            easing: 'easeInOutCubic',
                            offset: Math.ceil(s - r + t._getElWidth(Object(a.ensureDefined)(t._elArrowRight))),
                            queue: !1
                          })
                        })
                    },
            ...
            (t.prototype._isTabDisabled = function (t) {
              return (
                ...
                (this._options.tabDisabledClass && t.classList.contains(this._options.tabDisabledClass)) ||
      ...
      e.AddCompareDialog = (function () {
        function t(e) {
          !(function (t, e) {
            ...
            (this._dialog = null),
            (this._compareTab = new o.CompareTab(this._chartWidgetCollection, this)),
            (this._addSymbolTab = new s.AddSymbolTab(this._chartWidgetCollection, this))
        }
        return (
          a(t, [
            {
              ...
              value: function () {
                ...
                var i = (0, n.createTabbedDialog)({
                  ...
                  isClickOutFn: function (e) {
                    if (t._compareTab.isClickOnTab(e) || t._addSymbolTab.isClickOnTab(e)) return !1
                  }
                })
                return (
                  l && l.close(),
                  ...
                  this._dialog.on('afterClose', function () {
                    ;(0, r.trackEvent)('GUI', 'Compare', t._compareTab.selectedSymbols.sort().join(', '))
                  }),
                  this._dialog.open(),
                  (l = this._dialog),
                  this._dialog
