          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              var m = i.levelsStyle.childs(),
                ...
                S = { line: h }
              'extendLines' in i && ((x.extendRight = i.extendLines), (S.extendRightTitle = w)),
                'extendLinesLeft' in i && ((x.extendLeft = i.extendLinesLeft), (S.extendLeftTitle = g)),
                'extendRight' in i && ((x.extendRight = i.extendRight), (S.extendRightTitle = b)),
                'extendLeft' in i && ((x.extendLeft = i.extendLeft), (S.extendLeftTitle = p))
              var T = Object(o.a)(this._undoModel, x, n, 'LevelsStyleLine', S)
              e.push(T)
              for (var P = [], B = this._source.levelsCount(), V = 1; V <= B; V++) {
                  ...
                  R = Object(r.g)(
                    {
                      ...
                      color: Object(r.u)(this._undoModel, D.color, null, 'Change ' + n + ' Level ' + V + ' Line Color'),
                      level: Object(r.b)(this._undoModel, D.coeff, 'Change ' + n + ' Level ' + V + ' Coeff')
                    },
                    { id: l + 'LineLevel' + V }
                  )
                P.push(R)
              ...
              if ('reverse' in G) {
                var H = Object(r.c)(
                  {
                    checked: Object(r.b)(this._undoModel, G.reverse, 'Change ' + n + ' Reverse')
                  },
              ...
              if ((e.push(z), 'fibLevelsBasedOnLogScale' in i && null !== this._disabledBasedOnLog)) {
                var U = Object(r.c)(
                  {
                    disabled: Object(r.a)(
                      this._undoModel,
          ...
          return (
            ...
            (t.prototype._stylePropertyDefinitions = function () {
              ...
              var R = i.fans.childs(),
                A = Object(o.e)(
                  {
                    checked: Object(o.b)(this._undoModel, R.visible, 'Change ' + n + ' Fans Visibility'),
                    color: Object(o.u)(this._undoModel, R.color, null, 'Change ' + n + ' Fans Line Color')
                  },
                  ...
                  _ = Object(r.g)(
                    {
                      ...
                      color: Object(r.u)(this._undoModel, f.color, null, 'Change ' + n + ' Level ' + g + ' Line Color'),
                      width: Object(r.b)(this._undoModel, f.linewidth, 'Change ' + n + ' Level ' + g + ' Line Width'),
                      level: Object(r.b)(this._undoModel, f.coeff, 'Change ' + n + ' Level ' + g + ' Coeff')
                    },
                    { id: l + 'LineLevel' + g }
                  )
                e.push(_)
                  ...
                  f = Object(r.g)(
                    {
                      ...
                      color: Object(r.u)(this._undoModel, g.color, null, 'Change ' + n + ' Level ' + w + ' Line Color'),
                      width: Object(r.b)(this._undoModel, g.linewidth, 'Change ' + n + ' Level ' + w + ' Line Width'),
                      level: Object(r.b)(this._undoModel, g.coeff, 'Change ' + n + ' Level ' + w + ' Coeff')
                    },
                    { id: l + 'LineLevel' + w }
                  )
                e.push(f)
                  ...
                  f = Object(l.g)(
                    {
                      ...
                      level: Object(l.b)(this._undoModel, g.coeff, 'Change ' + n + ' Level ' + (w + 1) + ' Line Coeff')
                    },
                    { id: r + 'LineLevel' + (w + 1) }
                  )
                e.push(f)
          ...
          (t.prototype._stylePropertyDefinitions = function () {
            ...
            for (C = 0; C < k; C++) {
              var m = i.fanlines.childs()[C].childs(),
                x = Object(r.g)(
                  {
                    checked: Object(r.b)(this._undoModel, m.visible, 'Change ' + n + ' Fan ' + C + ' Line Visibility'),
                    color: Object(r.u)(this._undoModel, m.color, null, 'Change ' + n + ' Fan ' + C + ' Line Color'),
                    width: Object(r.b)(this._undoModel, m.width, 'Change ' + n + ' Fan ' + C + ' Line Width')
                  },
                  {
                    id: l + 'FanLineLevel' + C,
            ...
            for (C = 0; C < P; C++) {
              var B = i.arcs.childs()[C].childs(),
                V = Object(r.g)(
                  {
                    checked: Object(r.b)(this._undoModel, B.visible, 'Change ' + n + ' Arcs ' + C + ' Line Visibility'),
                    color: Object(r.u)(this._undoModel, B.color, null, 'Change ' + n + ' Arcs ' + C + ' Line Color'),
                    width: Object(r.b)(this._undoModel, B.width, 'Change ' + n + ' Arcs ' + C + ' Line Width')
                  },
                  {
            ...
            var A = i.arcsBackground.childs(),
              F = Object(r.q)(
                {
                  checked: Object(r.b)(this._undoModel, A.fillBackground, 'Change ' + n + ' Background Visibility'),
                  transparency: Object(r.b)(this._undoModel, A.transparency, 'Change ' + n + ' Background Transparency')
                },
                ...
                E = Object(r.i)(
                  {
                    value: Object(r.b)(this._undoModel, H.scaleRatio, 'Change Top Margin', [
                      Object(u.c)(7),
                      function (e) {
                        return null !== e ? parseFloat(G.getScaleRatioFormatter().format('' + e)) : null
                      }
                    ])
                  },
                  {
        ...
        h = (function (e) {
          ...
          return (
            ...
            (t.prototype._coordinatesPropertyDefinitions = function () {
              var e = this._source.points(),
                t = [],
                i = this._source.properties().childs().points.childs()[0].childs(),
                  ...
                  j = Object(r.g)(
                    {
                      ...
                      color: Object(r.u)(this._undoModel, _.color, null, 'Change ' + n + ' Level ' + f + ' Line Color'),
                      width: Object(r.b)(this._undoModel, _.linewidth, 'Change ' + n + ' Level ' + f + ' Line Width'),
                      style: Object(r.b)(this._undoModel, _.linestyle, 'Change ' + n + ' Level ' + f + ' Line Style'),
                      level: Object(r.b)(this._undoModel, _.coeff, 'Change ' + n + ' Level ' + f + ' Coeff')
                    },
                    { id: l + 'LineLevel' + f }
                  )
                e.push(j)
