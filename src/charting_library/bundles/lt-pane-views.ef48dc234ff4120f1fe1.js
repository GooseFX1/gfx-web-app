  ...
  ['lt-pane-views'],
  {
      ...
      inherit(c, n),
        (c.prototype._updateImpl = function () {
          if (
            ...
            for (var p = this._source.properties(), u = 1; u <= this._source.getCache().levelsCount(); u++) {
              var _ = p['level' + u]
              if (_.visible.value()) {
                var f = _.coeff.value(),
                  v = _.color.value(),
        ...
        (c.prototype._updateRenderer = function () {
          if (!((S = this._points).length < 2)) {
            ...
            if ((this._baseTrendRenderer.setData(n), e.append(this._baseTrendRenderer), S.length < 3))
            ...
            for (var _ = this._model._fibWedgeLabelsCache, f = _.canvas(), v = this._levels.length - 1; v >= 0; v--) {
              ...
              var w = new h()
              if ((w.setData(y), w.setHitTest(new o(o.MOVEPOINT, null, g.index)), e.append(w), t.showCoeffs.value())) {
                var m = this._cacheState.preparedCells.cells[this._levels[v].index - 1]
                if (!m) continue
                var x = {
                    left: m.left,
        ...
        (d.prototype._updateImpl = function () {
          ...
          if (
            ...
            'right' === o
              ...
              : 'center' === o && (l.x = (l.x + this._model.timeScale().width()) / 2)
            var d = {
              points: [l],
              text: i.text.value(),
        ...
        (p.prototype._updateImpl = function () {
          if (
            ...
            var i = this._source.points()[0],
              ...
              _ = !1
            ;(B = this._source.properties()).reverse && B.reverse.value() && (_ = B.reverse.value()),
              (this._levels = [])
            var f,
              v,
              g = _ ? i.price : p.price,
            ...
            if (m) (f = e.priceToCoordinate(g, t) - e.priceToCoordinate(y, t)), (v = e.priceToCoordinate(u.price, t))
            for (
          ...
          if (!(this._points.length < 2)) {
            ...
            if ((B = this._source.properties()).trendline.visible.value()) {
              ...
              this._trendLineRendererPoints12.setData(M), k.append(this._trendLineRendererPoints12)
            }
            if (this._points.length < 3) return this.addAnchors(k), void (this._renderer = k)
            u = this._points[2]
            if (B.trendline.visible.value()) {
              ...
              this._trendLineRendererPoints23.setData(M), k.append(this._trendLineRendererPoints23)
            }
            ...
            if (A)
              for (S = 1; S < this._levels.length; S++) {
                var N = this._levels[S - 1],
                  W = ((i = new r(z, this._levels[S].y)), (p = new r(V, N.y)), {})
                ;(W.points = [i, p]),
            ...
            for (S = 0; S < this._levels.length; S++) {
              ;(i = new r(I, this._levels[S].y)),
                ...
                (M = {
                  points: [new r(j, this._levels[S].y), new r(q, this._levels[S].y)],
                  width: this._model.timeScale().width(),
                  height: this._source.priceScale().height(),
              ...
              if (
                ...
                var Z,
                  X = this._cacheState.preparedCells.cells[this._levels[S].index - 1]
                if (!X) continue
                switch (B.horzLabelsAlign.value()) {
                  case 'left':
                    ...
                    break
                  case 'center':
                    ;((Z = i.add(p).scaled(0.5)).x += X.width / 2), (Z.x = Math.round(Z.x))
                    break
                  case 'right':
                    B.extendLines.value()
                      ? (Z = new r(V - 4, this._levels[S].y))
                      : (((Z = new r(V + 4, this._levels[S].y)).x += X.width), (Z.x = Math.round(Z.x)))
                }
                var J = {
                    left: X.left,
                ...
                'middle' === Q && (U.top -= U.height / 2), 'bottom' === Q && (U.top -= U.height)
          ...
          if ((e.fillText(s, S + d + u + 2 * p + I, B), this._data.status)) {
            ...
            switch (((e.font = w(this._targetFontSize1, this._font, 'bold')), this._data.status)) {
              case f.AlertStatus.Success:
                ;(O = $.t('SUCCESS')),
                  (A = _.generateColor(this._data.successBackground, this._data.transparency)),
                  (D = this._data.successTextColor),
                  (z = this._data.successIcon)
                break
              case f.AlertStatus.Failure:
                ;(O = $.t('FAILURE')),
                  (A = _.generateColor(this._data.failureBackground, this._data.transparency)),
            ...
            ;(e.fillStyle = A),
              'up' === this._data.direction
                ? (y(e, R.x - 1, R.y - V - 2, this._targetWidth + 2, V, 5),
                  ...
                  e.drawImage(z, R.x + H - z.width - 4, R.y - V - 2 + Math.abs(V - z.height) / 2))
                : (y(e, R.x - 1, R.y + this._targetHeight + 2, this._targetWidth + 2, V, 5),
                  e.fill(),
                  (e.fillStyle = D),
                  e.fillText(O, R.x + H + N, R.y + this._targetHeight + 5),
                  e.drawImage(z, R.x + H - z.width - 4, R.y + this._targetHeight + 10 - Math.abs(V - z.height) / 2)),
              e.restore()
          } else e.restore()
        }),
          ...
          return (
            ...
            (t.prototype.hitTest = function (e) {
              if (null === this._data || (void 0 !== this._data.mouseTouchable && !this._data.mouseTouchable))
                return null
              for (var t = o.CheckMobile.any() ? 24 : 3, i = 1; i < this._points.length; i++) {
    ...
    C2CE: function (e, t, i) {
      ...
      var r = i('aB9a').LineSourcePaneView,
        ...
        a = i('Zy3/').CompositeRenderer
      function s(e, t) {
        r.call(this, e, t), (this._polygonRenderer = new n()), (this._renderer = null)
      }
      inherit(s, r),
        ...
        (s.prototype._updateImpl = function () {
          ...
          var t = new a()
          t.append(this._polygonRenderer), this.addAnchors(t), (this._renderer = t)
        }),
    ...
    CR3a: function (e, t, i) {
      ...
      inherit(d, r),
        (d.prototype._getColor = function () {
          return l.generateColor(this._data.backcolor, this._data.transparency, !0)
        }),
        inherit(c, n),
        (c.prototype._updateImpl = function () {
          n.prototype._updateImpl.call(this),
          ...
          function u(i, r, n) {
            ...
            switch (t.horzLabelsAlign.value()) {
              case 'left':
                ...
                break
              case 'center':
                ;((a = i.add(r).scaled(0.5)).x += n.width / 2), (a.x = Math.round(a.x))
                break
              case 'right':
            ...
            'middle' === d && (h.top -= h.height / 2), 'bottom' === d && (h.top -= h.height)
          ...
          for (var _ = this._source.levelsCount(), f = 1; f < _; f++) {
            if ((C = t['level' + f]).visible.value()) {
              ...
              var P = new d()
              if ((P.setData(T), e.append(P), t.showCoeffs.value() || t.showPrices.value()))
          ...
          if (null != L && (C = t['level' + L]).visible.value()) {
            ...
            this._lastLevelTrendRenderer.setData(a),
              ...
              (t.showCoeffs.value() || t.showPrices.value()) && u(m, x, this._cacheState.preparedCells.cells[L - 1])
          }
          this.addAnchors(e), (this._renderer = e)
        }),
        (c.prototype.renderer = function (e, t) {
    ...
    'Dz+H': function (e, t, i) {
      ...
      ;(m.prototype.update = function (e) {
        ...
        (m.prototype.drawOn = function (e) {
          var t = new n(Math.round(this._data.point.x), Math.round(this._data.point.y)).add(this._translate)
          e.drawImage(this._sourceCanvas, t.x, t.y, this._data.width, this._data.height)
        }),
        (m.prototype.hasPoint = function (e) {
          var t = this._data.point.add(this._translate),
            i = new n(this._data.point.x - this._translate.x, this._data.point.y)
          return s(e, a(t, i))
        }),
        inherit(x, w),
        ...
        (x.prototype.drawTooltipOn = function (e) {
          ...
          d < 10 ? (d = n.y + 13) : (f = 'bottom'),
            h < 10
              ? (h += Math.abs(h - 10))
              : h + s + 10 > this._data.vpWidth && (h -= h + s + 10 - this._data.vpWidth),
            (e.fillStyle = p.generateColor(this._data.backgroundColor, this._data.backgroundTransparency)),
            (e.strokeStyle = this._data.borderColor),
            (e.lineWidth = 1),
            e.beginPath(),
            e.moveTo(h, d),
            c || 'top' !== f || (e.lineTo(v - 7, d), e.lineTo(v, d - 7), e.lineTo(v + 7, d)),
            e.lineTo(h + s, d),
            e.lineTo(h + s, d + o),
            c || 'bottom' !== f || (e.lineTo(v + 7, d + o), e.lineTo(v, d + o + 7), e.lineTo(v - 7, d + o)),
            e.lineTo(h, d + o),
            e.closePath(),
            e.fill(),
            e.stroke(),
          ...
          for (
            ...
            e.fillText(r[m].replace(/^\s+/, ''), y, w), (w += this._data.fontSize + a)
          e.restore()
        }),
        (x.prototype.hitTest = function (e) {
          return null !== this._data && this._source.hasPoint(e) ? new d(d.MOVEPOINT) : null
        }),
        inherit(b, o),
        ...
        (b.prototype._updateImpl = function () {
          ...
          var e = this._source.isFixed() ? this._source.fixedPoints() : this._points
          if (!(e.length < 1)) {
            var t = new c(),
          ...
          if (!(this._points.length < 2)) {
            ...
            if (this._points.length >= 5) {
              var R,
                ...
                T = !1,
                P = !1
              this._intersect1 ? (R = this._intersect1) : ((R = this._points[2]), (T = !0)),
                this._intersect2 ? (S = this._intersect2) : ((S = this._points[4]), (P = !0)),
        ...
        (p.prototype._updateImpl = function () {
          if (
            ...
            var i = Math.abs(t.x - e.x),
              a = Math.abs(t.y - e.y)
            this._levels = []
            for (var h = this._source.properties(), p = this._source.levelsCount(), u = 1; u <= p; u++) {
              var _ = h['level' + u]
              if (_.visible.value()) {
                var f = _.coeff.value(),
                  v = _.color.value(),
                  g = []
                g.push(new r(this._center.x - 0.5 * i * f, this._center.y - 0.5 * a * f)),
                  g.push(new r(this._center.x + 0.5 * i * f, this._center.y + 0.5 * a * f))
            ...
            if (!(this._points.length < 2)) {
              ...
              for (u = 0; u < this._levels.length; u++) {
                ...
                if ((w.append(new d(T, P)), h.showCoeffs.value())) {
                  var L = this._cacheState.preparedCells.cells[this._levels[u].index - 1]
                  if (!L) continue
                  var C = {
                      left: L.left,
              ...
              if (h.trendline.visible.value()) {
                ...
                this._trendLineRenderer.setData(M), w.append(this._trendLineRenderer)
              }
          ...
          return (
            ...
            (t.prototype._updateImpl = function () {
              if ((e.prototype._updateImpl.call(this), (this._renderer = null), !(this._points.length < 2))) {
                ...
                ;(R.data = 3), r.append(this.createLineAnchor({ points: [s, l, b, R] })), (this._renderer = r)
              }
            }),
            t
          )
      ...
      inherit(_, n),
        ...
        (_.prototype._updateImpl = function () {
          ...
          if (t && !t.isEmpty() && !i.isEmpty()) {
            ...
            for (_ = p(e.color.value()), g = 0; g < this._points.length - M; g++, k = -k)
              if (!(g < L)) {
        ...
        (c.prototype._updateImpl = function () {
          ...
          if (!(this._points.length < 2)) {
            ...
            if (
              ...
              this._trendLineRendererPoints12.setData(x), g.append(this._trendLineRendererPoints12)
            }
              ...
              for (
                ...
                if (a >= u.x) {
                  var _ = h[p + 1],
                    ...
                    g = (a - u.x) / f,
                    y = u.y + v * g
                  return l.length() <= y + c ? new d.HitTestResult(d.HitTestResult.MOVEPOINT) : null
                }
              }
              return l.length() < 3 ? new d.HitTestResult(d.HitTestResult.MOVEPOINT) : null
            }),
            (t.prototype._drawImpl = function (e) {
      ...
      var f = (function (e) {
        function t(t, i) {
          ...
          return (
            ...
            (r._ellipseRenderer = new _.EllipseRendererSimple(r._ellipseRendererData)),
            r
          )
        }
        return (
    ...
    R7Bt: function (e, t, i) {
      ...
      var r = i('aO4+').Point,
        ...
        c = i('d1Pk').fibLevelCoordinate
      function p(e, t) {
        a.call(this, e, t), (this._rendererCache = {}), (this._trendLineRenderer = new s()), (this._renderer = null)
      }
      inherit(p, a),
        (p.prototype._updateImpl = function () {
          if (
              ...
              if (null != t) {
                ...
                if (!(this._points.length < 2)) {
                  ...
                  for (R = 0; R < this._levels.length; R++) {
                    ;(i = new r(k, this._levels[R].y)), (p = new r(M, this._levels[R].y))
                    var j,
                      q = {
                        points: [new r(N, this._levels[R].y), new r(W, this._levels[R].y)],
                        width: this._model.timeScale().width(),
                        height: this._source.priceScale().height(),
                    ...
                    if (
                      ...
                      var Y,
                        G = this._cacheState.preparedCells.cells[this._levels[R].index - 1]
                      if (!G) continue
                      switch (C.horzLabelsAlign.value()) {
                        case 'left':
                          ...
                          break
                        case 'center':
                          ;((Y = i.add(p).scaled(0.5)).x += G.width / 2), (Y.x = Math.round(Y.x))
                          break
                        case 'right':
                          C.extendLines.value()
                            ? (Y = new r(D - 4, this._levels[R].y))
                            : (((Y = new r(D + 4, this._levels[R].y)).x += G.width), (Y.x = Math.round(Y.x)))
                      }
                      var Z = {
                          left: G.left,
                      ...
                      'middle' === J && (X.top -= X.height / 2), 'bottom' === J && (X.top -= X.height)
                  ...
                  if (C.trendline.visible.value()) {
                    ...
                    this._trendLineRenderer.setData(q), B.append(this._trendLineRenderer)
                  }
        ...
        (d.prototype._updateImpl = function () {
          ...
          if (!(this._points.length < 2)) {
            ...
            if (this._retrace1) {
              ...
              ;(y = new n()).setData(v), c.append(y)
              var g = u(this._points[1].add(this._points[3]).scaled(0.5), this._numericFormatter.format(this._retrace1))
          ...
          if (!(this._points.length < 2)) {
            ...
            for (_ = 0; _ < this._levels.length; _++) {
              if (void 0 !== this._levels[_].text) {
                ...
                switch (((B = 'left' === B ? 'right' : 'right' === B ? 'left' : 'center'), p.vertLabelsAlign.value())) {
                  case 'top':
        ...
        (g.prototype._updateImpl = function () {
          if (
            ...
            ;((O = {}).points = [d, _]),
              ...
              (O.extendright = !1),
              (O.leftend = u.Normal),
              (O.rightend = Math.abs(i.x - a.x) >= 25 * O.linewidth ? u.Arrow : u.Normal),
            ...
            ;((O = {}).points = [d, _]),
              ...
              (O.extendright = !1),
              (O.leftend = u.Normal),
              (O.rightend = Math.abs(d.y - _.y) >= 25 * O.linewidth ? u.Arrow : u.Normal),
            ...
            B &&
              ...
              ((this._pipFormatter = new p(B.pricescale, B.minmov, B.type, B.minmove2)), (this._lastSymbolInfo = B))
            var k,
              M =
              ...
              I = f(M) + '\n' + $.t('{0} bars').format(S) + L,
              O = {}
            if (w > y) ((k = a.clone()).y -= 2 * t.fontsize.value()), (k.x = 0.5 * (i.x + a.x)), (O.points = [k])
            else ((k = a.clone()).x = 0.5 * (i.x + a.x)), (k.y += 0.7 * t.fontsize.value()), (O.points = [k])
            var A = { x: 0, y: 10 }
            ;(O.text = I),
            ...
            this._textRenderer.setPoints([z]), e.append(this._textRenderer), this.addAnchors(e), (this._renderer = e)
          }
        }),
        ...
        (_.prototype._updateImpl = function () {
          if (
            ...
            ;((C = {}).points = [w, m]),
              ...
              (C.extendright = !1),
              (C.leftend = p.Normal),
              (C.rightend = Math.abs(w.y - m.y) >= 15 * C.linewidth ? p.Arrow : p.Normal),
            ...
            var P,
              ...
              C = {}
            if (b > x) ((P = d.clone()).y -= 2 * t.fontsize.value()), (P.x = 0.5 * (l.x + d.x)), (C.points = [P])
            else ((P = d.clone()).x = 0.5 * (l.x + d.x)), (P.y += 0.7 * t.fontsize.value()), (C.points = [P])
            var B = { x: 0, y: 10 }
            ;(C.text = L),
              (C.color = t.textcolor.value()),
              (C.height = v._source.priceScale().height()),
            ...
            this._labelRenderer.setPoints([M]), e.append(this._labelRenderer), this.addAnchors(e), (this._renderer = e)
          }
        }),
        ...
        (m.prototype._updateImpl = function () {
          ...
          if (((this._label = null), !(this._source.points().length < 2))) {
            ...
            if (this._source.properties().showPriceRange.value() && this._source.priceScale()) {
              ...
              o = this._source.ownerSource().formatter().format(x) + ' (' + new h().format(100 * b) + ') '
              ...
              R &&
                ...
                (o += this._pipFormatter ? ', ' + this._pipFormatter.format(x) : ''),
                m.push('priceRange')
            }
            ...
            if (this._secondPoint && this._points.length > 0) {
              ...
              if (
                ...
                var k = this._source.properties().statsPosition.value(),
                  M = this._source.getPointByPosition(k, P.points[0], this._middlePoint, P.points[1]),
              ...
              this._angleLabelRenderer.setData(H), T.append(this._angleLabelRenderer)
            }
            0,
              this._secondPoint &&
        ...
        return (
          ...
          (e.prototype._drawPoints = function (e, t, i, r, n) {
            ...
            for (var c = (l % 2) / 2, _ = 0, f = i; _ < f.length; _++) {
              var v = f[_]
              if (!(Object(d.isInteger)(v.data) && this._data.linePointBeingEdited === v.data))
                if (
                  (r(e, new u(Math.round(v.x * t) + c, Math.round(v.y * t) + c, v.data, v.square), h / 2, o),
                  v.subtract(a).length() <= s + 2)
                ) {
                  var g = Math.max(1, Math.floor(this._data.selectedStrokeWidth * t)),
                    y = Math.round(s * t * 2)
                  y % 2 != l % 2 && (y += 1),
                    n(e, new u(Math.round(v.x * t) + c, Math.round(v.y * t) + c, v.data, v.square), y / 2, g)
                }
            }
          }),
          e
      ...
      inherit(u, p),
        ...
        (_.prototype._updateImpl = function () {
          if (
            ...
            this._levels = []
            for (var s = this._source.properties(), d = this._source.levelsCount(), p = 1; p <= d; p++) {
              var _ = s['level' + p]
              if (_.visible.value()) {
                var f = _.coeff.value(),
                  v = _.color.value(),
            ...
            if (!(this._floatPoints.length < 2)) {
              var m = new h(),
                x = ((e = this._floatPoints[0]), (s = this._source.properties()).fillBackground.value()),
              ...
              for (p = 0; p < this._levels.length; p++) {
                ...
                if ((m.append(new u(P, L)), s.showCoeffs.value())) {
                  var C = this._cacheState.preparedCells.cells[this._levels[p].index - 1]
                  if (!C) continue
                  var B = {
                      left: C.left,
              ...
              if (s.trendline.visible.value()) {
                ...
                this._trendLineRenderer.setData(I), m.append(this._trendLineRenderer)
              }
              this.addAnchors(m), (this._renderer = m)
            }
          }
          ...
          if (
            ...
            if (this._pattern && 2 === this._source.points().length) {
              ...
              if (f === p.Bars || f === p.OpenClose) {
                for (
                  var b = new d(), R = f === p.Bars ? ['high', 'low'] : ['open', 'close'], S = R[0], T = R[1], P = 0;
                ...
                ;((M = {}).barSpacing = w),
                  ...
                  (M.histogramBase = 0),
                  (M.lineIndex = 0),
                  (M.lineColor = c.generateColor(this._source.properties().color.value(), 10)),
            ...
            for (
              ...
              if (f.visible.value()) {
                ...
                var S = {
                  ...
                  T = new a()
                T.setData(S), T.setHitTest(new o(o.MOVEPOINT, null, _)), t.append(T)
              }
            }
            this.addAnchors(t), (this._renderer = t)
          }
            ...
            for (
              ...
              if (v.visible.value()) {
                ...
                var x = {
                  ...
                  b = new a()
                b.setData(x), b.setHitTest(new o(o.MOVEPOINT, null, f)), t.append(b)
                var R,
                  S = {
                    points: [w, m],
                    width: this._model.timeScale().width(),
                ...
                ;(R = new a()).setData(S), R.setHitTest(new o(o.MOVEPOINT, null, f)), t.append(R)
              }
            }
            this.addAnchors(t), (this._renderer = t)
          }
            ...
            if (this._medianPoint && this._modifiedBase) {
              ...
              for (var v = 0; v <= 8; v++) {
                ...
                if (g.visible.value()) {
                  ...
                  ;(S = new a()).setData(T), S.setHitTest(new o(o.MOVEPOINT, null, v)), e.append(S)
                }
              }
              this.addAnchors(e), (this._renderer = e)
    ...
    dKqZ: function (e, t, i) {
      ...
      inherit(g, f),
        ...
        (g.prototype.hitTest = function (e) {
          ...
          var m,
            x = 1 - Math.sqrt(3) / 2
          if (((w = o(1, (u * x) / d)), (e = h(w, e)), (f = h(w, f)), e.y * f.y < 0)) return null
          m = e.y < 0 ? new r(0.5 * u, (u * Math.sqrt(3)) / 2) : new r(0.5 * u, (-u * Math.sqrt(3)) / 2)
          ...
          if ((d.prototype._updateImpl.call(this), (this._renderer = null), 0 !== this._points.length)) {
            ...
            if (((p.data = 0), i.push(p), 1 !== e.points.length)) {
              ...
              if (((f.data = 1), 2 !== e.points.length)) {
                ...
                t.append(this.createLineAnchor({ points: i, pointsCursorType: k }))
        ...
        (c.prototype._updateImpl = function () {
          if (
            ...
            if (((this._hfans = []), (this._vfans = []), C.fans.visible.value()))
              for (u = 1; u <= 7; u++) {
                ;(x = Math.round(w + C['hlevel' + u].coeff.value() * y)), (v = c + C['vlevel' + u].coeff.value() * h)
            ...
            for (u = 0; u < this._hlevels.length; u++) {
              ...
              var A = {
                points: [(e = new r(S, this._hlevels[u].y)), (t = new r(P, this._hlevels[u].y))],
                width: this._model.timeScale().width(),
                height: this._source.priceScale().height(),
              ...
              if (((H = new o()).setData(A), R.append(H), C.showLeftLabels.value())) {
                var D = {
                  points: [e],
            ...
            for (u = 0; u < this._vlevels.length; u++) {
              ;(e = new r(this._vlevels[u].x, T)), (t = new r(this._vlevels[u].x, L))
              if (u > 0 && M) {
                O = this._vlevels[u - 1]
                var V,
                  E = new r(O.x, T)
              ...
              if (((H = new o()).setData(A), R.append(H), C.showTopLabels.value())) {
                var N = {
                  points: [e],
            ...
            var F = this
            j(R, this._hfans, !0), j(R, this._vfans, !1), this.addAnchors(R), (this._renderer = R)
          }
          function j(e, t, i) {
            var n = new r(S, T),
              a = new r(P, T),
          ...
          if (
            ...
            for (
              ...
              if (f.visible.value()) {
                ...
                ;(m = new a()).setData(w), m.setHitTest(new s(s.MOVEPOINT, null, u)), e.append(m)
                var m,
                  x = {
                ...
                ;(m = new a()).setData(x), m.setHitTest(new s(s.MOVEPOINT, null, u)), e.append(m)
              }
            }
            this.addAnchors(e), (this._renderer = e)
          }
      ...
      inherit(p, a),
        (p.prototype._updateImpl = function () {
          if (
            ...
            p.append(this.createLineAnchor({ points: x, pointsCursorType: b })), (this._renderer = p)
          }
        }),
        (p.prototype.renderer = function (e, t) {
          return this._invalidated && this._updateImpl(), this._renderer
    ...
    'obU/': function (e, t, i) {
      ...
      inherit(g, v),
        ...
        (g.prototype.hitTest = function (e) {
          ...
          ;(w = s(-y)), (e = h(w, e)), (m = h(w, m)), (w = o(1, f / (2 * d))), (e = h(w, e)), (m = h(w, m))
          var x = e.length()
              ...
              if (!(o.length < 2)) {
                ...
                if (
                  (!(l.index < i.firstBar() && h.index < i.firstBar()) ||
                    d.extendLeft.value() ||
                    d.extendRight.value()) &&
                  (n.prototype._updateImpl.call(this), !(this._points.length < 2))
                ) {
                  ...
                  var S =
                    ...
                    T = (this.isHoveredSource() || this.isSelectedSource()) && d.showMiddlePoint.value()
                  if (S && this._label && 2 === this._points.length) {
                    var P = d.statsPosition.value(),
                      L = this._source.getPointByPosition(P, this._points[0], this._middlePoint, this._points[1]),
                      C = {
                        left: 0,
                  ...
                  if (
                    ...
                    I = 'left' === z ? O.clone() : 'right' === z ? A.clone() : new r((l.x + h.x) / 2, (l.y + h.y) / 2)
                    ...
                    this._labelRenderer.setData(E), x.append(this._labelRenderer)
                  }
                  this._renderer = x
                }
              }
          ...
          if (this._labelDataInvalidated) {
            ...
            if (c.showPriceRange.value() && this._source.priceScale()) {
              ...
              v &&
                ...
                ((this._pipFormatter = new d(v.pricescale, v.minmov, v.type, v.minmove2)), (this._lastSymbolInfo = v)),
            ...
            if (g || m || x) {
              if (((t = ''), g && ((a = l.index - o.index), (t += $.t('{0} bars').format(y(a)))), m)) {
              ...
              if (x) {
                t && (t += ', '), void 0 === n && (n = l.price - o.price), void 0 === a && (a = l.index - o.index)
                var P = Math.round(1e5 * Math.sqrt(n * n + a * a)) / 1e5
                t += $.t('distance: {0}').format(y(this._numericFormatter.format(P)))
              }
              t && p.push('barsRange')
            }
            if (c.showAngle.value()) {
              ...
              if (
                ...
                var k = B.subtract(C)
                k.length() > 0 && ((k = k.normalized()), (L = Math.acos(k.x)), k.y > 0 && (L = -L))
              }
              'number' != typeof L ||
                TradingView.isNaN(L) ||
              ...
              if (
                ...
                if (
                  ...
                  ;((C = {}).points = [b, R]),
                    ...
                    (C.backcolor = c.stopBackground.value()),
                    (C.fillBackground = !0)
                  var S = 100 - 100 * (1 - (T = 0.01 * c.stopBackgroundTransparency.value()) * T * T)
                  ;(C.transparency = S), this._stopBgRenderer.setData(C), l.append(this._stopBgRenderer)
                }
                ...
                if (
                  ...
                  ;((C = {}).points = [b, R]),
                    ...
                    (C.fillBackground = !0)
                  var T,
                    P = 100 - 100 * (1 - (T = 0.01 * c.profitBackgroundTransparency.value()) * T * T)
                  ;(C.transparency = P), this._targetBgRenderer.setData(C), l.append(this._targetBgRenderer)
                }
                ...
                if (
                  (this._points[1] &&
                    void 0 !== this._pl &&
                    (N = this._source.ownerSource().formatter().format(this._pl)),
                  c.compact.value())
                )
                  (H += N ? N + ' ~ ' : ''), (H += c.qty.value() + '\n'), (H += W)
                else {
                  var F = this._isClosed ? this.i18nCache.closed : this.i18nCache.open
                ...
                this._pl < 0 ? (j = c.stopBackground.value()) : this._pl > 0 && (j = c.profitBackground.value()),
                ...
                q &&
                  ...
                  ((this._pipFormatter = new p(q.pricescale, q.minmov, q.type, q.minmove2)), (this._lastSymbolInfo = q))
                ...
                ;(H = c.compact.value()
                  ...
                  B(this._stopLabelRenderer, E, H, c.stopBackground.value(), k < M ? 'bottom' : 'top', 0)
                ...
                ;(H = c.compact.value()
                  ...
                  B(this._profitLabelRenderer, E, H, c.profitBackground.value(), k < M ? 'top' : 'bottom', 0)
          ...
          if (
            ...
            if (null !== this._model.timeScale().visibleBarsStrictRange()) {
              ...
              if ((t = this._source.properties()).fillBackground.value())
                for (p = 1; p < this._levels.length; p++) {
                  var w = this._levels[p - 1],
                    m = ((e = new r(this._levels[p].x, 0)), new r(w.x, this._source.priceScale().height())),
                    x = {}
                  ;(x.points = [e, m]),
              ...
              for (p = 0; p < this._levels.length; p++) {
                ...
                if (((R = new a()).setData(b), R.setHitTest(S), y.append(R), void 0 !== this._levels[p].text)) {
                  var T,
          ...
          if (
            ...
            if (!(this._floatPoints.length < 2)) {
              ...
              for (f = 0; f < this._vlevels.length; f++) {
                ;(e = new r(this._vlevels[f].x, L)), (t = new r(this._vlevels[f].x, B))
                if (i.grid.visible.value()) {
                  O = {
                    points: [e, t],
                    width: this._model.timeScale().width(),
