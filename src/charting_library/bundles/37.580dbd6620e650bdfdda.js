  ...
  [37],
  {
        ...
        var l = {
          ...
          showNotice: function (t, o, e) {
            ...
            var i = (e = e || {}).doNotCloseOnBgClick || !1,
              ...
              s = e.width || '400px',
              d = {}
            ;(d.noClose = e.noClose || null), (d.addClass = e.modalDialogClass || null), l.createModalDialog(t, d)
          ...
          showCustomDialog: function (t) {
            ...
            return (
              ...
              l.modalDialog.find('._tv-dialog').css('width', t.width || '400px'),
              l.modalDialog
          ...
          createModalDialog: function (t, o) {
            ;(o = o || {}),
              ...
              l._addMessageCloseButton(l.modalDialog.find('._tv-dialog-message')),
              o.noShadowBox && l.modalDialog.addClass('transparent'),
              o.addClass && l.modalDialog.addClass(o.addClass),
              o.width && l.modalDialog.find('._tv-dialog').css({ width: o.width }),
              o.content && l.modalDialog.find('._tv-dialog-content').html(o.content)
          ...
          createDialog: function (t, o) {
            if (l.isOpen(t)) return (c = l.get(t)).find('._tv-dialog-content').html(''), c.data('new', !1), c
            ...
            var u = {
              start: function (t, o) {
                for (var e = o.helper.css('z-index'), a = 0, i = null, n = 0; n < l.dialogs.length; n++) {
          ...
          positionDialog: function (t, o, e) {
            ...
            if (((o = o || e.position), t)) {
              var i,
                ...
                u = $(d).height()
              if (o && o.top && o.left)
                (n = e.forcePosition ? o.left : Math.max(2, Math.min(g - r - 4, o.left)) + 'px'),
                  (i = e.forcePosition ? o.top : Math.max(2, Math.min(u - c - 4, o.top)) + 'px')
              else if (o && o.considerScroll) {
                var p = $(s)
                ;(n = Math.round((g - r) / 2 + p.scrollLeft()) + 'px'),
                  (i = Math.round((u - c) / 2 + p.scrollTop()) + 'px')
              } else (n = Math.round((g - r) / 2) + 'px'), (i = Math.round((u - c) / 2) + 'px')
              e.fadeIn
          ...
          applyHandlers: function (t, o) {
            var e = !t || t === this.modalDialog,
              ...
              i = (t = t || l.modalDialog.find('._tv-dialog')).prop('ownerDocument')
            o.beforeDestroy && t.on('destroy', o.beforeDestroy),
              t.find('._tv-dialog-title ._tv-dialog-title-close, .js-dialog-close').on('click', function (t) {
                o.closeHandler && 'function' == typeof o.closeHandler ? o.closeHandler(t) : a()
              }),
              o.doNotCloseOnBgClick ||
                setTimeout(function () {
                  $(i).on('mousedown.closeDialog', function (e) {
                    ...
                    n.is(t) ||
                      (o.doNotCloseOnBgClickIfShadowbox && n.is('._tv-dialog-shadowbox, .tv-dialog__modal-wrap')) ||
                      n.is(
            ...
            Modernizr.mobiletouch || o.notFocusFirst || n.focus(),
              ...
              o.doNotCloseOnEsc ||
                $(i).bind('keyup.hideDialog', function (o) {
                  if (27 === o.keyCode) return t ? l.destroy(t.data('title')) : l.destroy(), !1
                }),
              o.processEnterButton &&
                $(i).bind('keyup.confirmAndCloseDialog', function (t) {
                  13 === t.keyCode &&
                    'textarea' !== t.target.tagName.toLowerCase() &&
                    (o.processEnterButton.click(), $(i).unbind('keyup.confirmAndCloseDialog'))
                })
          },
          ...
          showMessage: function (t, o, e) {
            o || (o = $('._tv-dialog'))
            var a = (e = e || {}).isError ? '_tv-dialog-error' : '_tv-dialog-message',
              i = o.find('.' + a),
              n = i.find('.message')
            e.html ? n.html('string' == typeof e.html ? e.html : t) : n.text(t),
              n.css('width', o.width()).toggleClass('selectable', Boolean(e.selectable)),
              i
              ...
              e.withClose ||
                (e.hideWithoutAnimation
                  ? i.on('touchstartoutside mousedownoutside keydownoutside', function t() {
                      i.hide(), i.off('touchstartoutside mousedownoutside keydownoutside', t)
                    })
                  : i.on('touchstartoutside mousedownoutside keydownoutside', function t() {
                      i.animate(
                        {
                        ...
                        i.off('touchstartoutside mousedownoutside keydownoutside', t)
                    }))
          },
          isOpen: function (t) {
            for (var o = 0; o < l.dialogs.length; o++) if (l.dialogs[o].title === t) return !0
            return !1
          },
          get: function (t) {
            for (var o = 0; o < l.dialogs.length; o++) if (l.dialogs[o].title === t) return l.dialogs[o].dialog
          },
    ...
    PVgW: function (t, o, e) {
      ...
      function n(t) {
        return (
          (t = Math.abs(t)),
          !Object(a.isInteger)(t) && t > 1 && (t = parseFloat(t.toString().replace(/^.+\./, '0.'))),
          0 < t && t < 1
            ? Math.pow(
                10,
                (function (t) {
      ...
      function s(t, o) {
        ...
        var e = t.data('TVTicker'),
          i = e && e.step,
          s = 0
        ;(s = e.parser ? e.parser(t.val()) : Object(a.isInteger)(i) ? parseInt(t.val(), 10) : parseFloat(t.val())),
          isNaN(s) && (s = 0)
        var l = n(i),
          ...
          this.each(function () {
            ...
            if (
              ...
              var n = $('<div class="tv-ticker">').appendTo(e.parent()),
                s = $('<div class="tv-ticker__btn tv-ticker__btn--up">').html(i).appendTo(n),
                r = $('<div class="tv-ticker__btn tv-ticker__btn--down">').html(i).appendTo(n)
