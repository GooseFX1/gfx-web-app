  ...
  [27],
  {
    '3G1X': function (e, t, n) {
      ...
      var r,
        ...
        f = n('k+zC'),
        h = n('Hk3L')
      ;((r = {}).FontSizeMedium = Object(l.ensureDefined)(h['font-size-medium'])),
      ...
      function b(e) {
        return (e = Object(f.a)(e)), s.a.createElement(m, Object(o.__assign)({}, e))
      }
    },
    '6ix9': function (e, t, n) {
      e.exports = {
    ...
    H172: function (e, t, n) {
          ...
          i.a.createElement(
            ...
            i.a.createElement(
              ...
              (function () {
                ...
                if (!e) return i.a.createElement('div', { className: c()(y.placeholder, w && y.hiddenArrow) }, v)
                var n = e.selectedContent || e.content
                if ('string' == typeof n)
                  return i.a.createElement('div', { className: c()(y.selected, w && y.hiddenArrow) }, n)
                return i.a.createElement('div', { className: c()(y.selected, w && y.hiddenArrow) }, i.a.cloneElement(n))
              })(),
              !w && i.a.createElement(g, { isDropped: W }),
              (I || W) && i.a.createElement('span', { className: c()(y.shadow, q) })
            ),
            i.a.createElement(
              u.a,
              {
                ...
                isOpened: W,
                position: function () {
                  var e = Object(a.ensureNotNull)(P.current).getBoundingClientRect()
      ...
      function C(e) {
        return (e = Object(w.a)(e)), i.a.createElement(E, Object(r.__assign)({}, e))
      }
      n.d(t, 'a', function () {
        return C
      })
        ...
        (d.Cell = function (e) {
          ...
          return o.createElement(p.Consumer, null, function (s) {
            return o.createElement(
              ...
              o.createElement('div', { className: i(l.inner, e.className) }, e.children)
            )
          })
        }),
      ...
      var r = n('mrSG'),
        ...
        f = (function (e) {
          ...
          return (
            ...
            (t.prototype.render = function () {
              var e
              this.props.error ? (e = d.error) : this.props.warning && (e = d.warning)
              var t = this.props,
                n = t.borderStyle,
                r = void 0 === n ? 'thick' : n,
                i = t.fontSizeStyle,
                ...
                p = s(d.innerInput, 'large' === c && d.largeFont, Object(l.isRtl)() && !u.isChrome && d.innerInputFix)
              return o.createElement(
                'div',
                { className: a },
                o.createElement(
                  ...
                  o.createElement(
                    'div',
                    {
                      className: s(d.inputContainer, Object(l.isRtl)() && !u.isChrome && d.inputContainerFix)
                    },
            ...
            (t.prototype._addPassiveListenerOnWheel = function (e) {
              Object(a.ensureNotNull)(this._container).addEventListener('wheel', e, { passive: !1 })
            }),
            (t.prototype._removePassiveListenerOnWheel = function (e) {
              Object(a.ensureNotNull)(this._container).removeEventListener('wheel', e)
            }),
            t
          )
        })(o.PureComponent),
          ...
          Object(r.__assign)({}, c, {
            ...
            onKeyDown: function (t) {
              ...
              ;(r.includes(t.keyCode) || n.includes(t.keyCode)) &&
                (t.preventDefault(), e.onValueByStepChange(r.includes(t.keyCode) ? -1 : 1))
      ...
      !(function (o) {
        ...
        function p(e, t, n, r) {
          var o,
            ...
            l = !e.c[0]
          if (void 0 !== n) {
            if (n !== ~~n || n < (3 == t) || n > 1e6) throw Error(3 == t ? c + 'precision' : a)
            for (
              n = r - (e = new s(e)).e, e.c.length > ++r && d(e, n, s.RM), 2 == t && (r = e.e + n + 1);
              e.c.length < r;
        ...
        ;(l.abs = function () {
          ...
          (l.div = function (e) {
            ...
            do {
              ...
              ;(O[y++] = p ? u : ++u), b[0] && p ? (b[g] = r[m] || 0) : (b = [r[m]])
            } while ((m++ < v || void 0 !== b[0]) && i--)
            return O[0] || 1 == y || (O.shift(), w.e--), y > E && d(w, s, n.RM, void 0 !== b[0]), w
          }),
          (l.eq = function (e) {
            return !this.cmp(e)
          }),
          ...
          (l.minus = l.sub =
            function (e) {
              ...
              var l = i.c.slice(),
                ...
                d = e.c,
                p = e.e
              if (!l[0] || !d[0]) return d[0] ? ((e.s = -a), e) : new s(l[0] ? i : 0)
              if ((c = u - p)) {
                for ((o = c < 0) ? ((c = -c), (r = l)) : ((p = u), (r = d)), r.reverse(), a = c; a--; ) r.push(0)
                r.reverse()
              } else
                for (n = ((o = l.length < d.length) ? l : d).length, c = a = 0; a < n; a++)
                  if (l[a] != d[a]) {
                    o = l[a] < d[a]
                    break
                  }
              if ((o && ((r = l), (l = d), (d = r), (e.s = -e.s)), (a = (n = d.length) - (t = l.length)) > 0))
                for (; a--; ) l[t++] = 0
              for (a = t; n > c; ) {
                if (l[--n] < d[n]) {
                  for (t = n; t && !l[--t]; ) l[t] = 9
          ...
          (l.plus = l.add =
            function (e) {
              ...
              if (((c = c.slice()), (o = s - a))) {
                for (o > 0 ? ((a = s), (t = l)) : ((o = -o), (t = c)), t.reverse(); o--; ) t.push(0)
                t.reverse()
              }
              for (c.length - l.length < 0 && ((t = l), (l = c), (c = t)), o = l.length, i = 0; o; c[o] %= 10)
          ...
          (l.sqrt = function () {
            ...
            0 === (i = Math.sqrt(r + '')) || i === 1 / 0
              ? (((t = r.c.join('')).length + c) & 1 || (t += '0'),
                (c = (((c + 1) / 2) | 0) - (c < 0 || 1 & c)),
                (e = new o(
                  ((i = Math.sqrt(t)) == 1 / 0 ? '1e' : (i = i.toExponential()).slice(0, i.indexOf('e') + 1)) + c
                )))
              : (e = new o(i)),
              (c = e.e + (o.DP += 4))
            do {
          ...
          (l.times = l.mul =
            function (e) {
              ...
              for (a = c; a--; ) {
                for (c = 0, l = s + a; l > a; )
                  (c = t[l] + i[a] * o[l - a - 1] + c), (t[l--] = c % 10), (c = (c / 10) | 0)
                t[l] = (t[l] + c) % 10
              }
