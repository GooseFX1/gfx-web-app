...
const DEVNET_PROGRAMID = '9zE4EQ5tJbEeMYwtS2w8KrSHTtTW4UPqwfbBSEkUrNCA'
...
export default function useReferrals(): IReferrals {
  ...
  useEffect(() => {
    if (connection && publicKey) {
      const client = new Client(connection, publicKey, DEVNET_PROGRAMID)
...
export async function create(
  ...
  const client = new Client(connection, wallet, DEVNET_PROGRAMID)
